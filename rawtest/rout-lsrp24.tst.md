...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |---------|---------|------|---------|---------|-------|----------|
     | serial1 | 4.4.4.1 | r1   | serial1 | 9.9.9.1 | true  | 00:00:27 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface   | router  | name | peerif  | peer    | ready | uptime   |
     |---------|---------|------|---------|---------|-------|----------|
     | serial1 | 6.6.6.1 | r1   | serial1 | 9999::1 | true  | 00:00:27 |
     |_________|_________|______|_________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 4   | 14  | 49510c26 | 00:59:37 |
     | 4.4.4.2 | r2   | 1   | 4   | 14  | b8c7b5af | 00:59:37 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 4   | 14  | 49510c26 | 00:59:34 |
     | 6.6.6.2 | r2   | 1   | 4   | 14  | b8c7b5af | 00:59:34 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     |------|-------------|--------|-----------|---------|----------|
     | L EX | 2.2.2.1/32  | 70/10  | serial2   | 9.9.8.1 | 00:00:22 |
     | C    | 2.2.2.2/32  | 0/0    | loopback0 | null    | 00:00:33 |
     | L EX | 2.2.2.11/32 | 70/10  | serial2   | 9.9.8.1 | 00:00:22 |
    ...
    r2#show ipv6 route v1
     ...
     | typ  | prefix       | metric | iface     | hop     | time     |
     |------|--------------|--------|-----------|---------|----------|
     | L EX | 4321::1/128  | 70/10  | serial2   | 9998::1 | 00:00:26 |
     | C    | 4321::2/128  | 0/0    | loopback0 | null    | 00:00:33 |
     | L EX | 4321::11/128 | 70/10  | serial2   | 9998::1 | 00:00:26 |
