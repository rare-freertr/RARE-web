...
=== "Verification"
    ...
    r1#show bridge 1
     ...
     |----------------|------------------|----------|----|----|------|-----|-----|------|
     | 0001.1352.362f | bvi              | 00:00:17 | 14 | 15 | 0    | 888 | 918 | 0    |
     | 0025.1000.270e | vpls 2.2.2.2 1:1 | 00:00:17 | 13 | 14 | 0    | 858 | 888 | 0    |
    ...
    r1#show bridge 2
     ...
     | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
     |----------------|------------------|----------|----|----|------|-----|------|------|
     | 0016.0940.6849 | vpls 4321::2 1:1 | 00:00:17 | 15 | 15 | 0    | 998 | 1006 | 0    |
     | 0018.4051.0c12 | bvi              | 00:00:17 | 14 | 19 | 0    | 932 | 1326 | 0    |
    ...
    r1#show bridge 3
     ...
     | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
     |----------------|------------------|----------|----|----|------|-----|------|------|
     | 0012.0d1c.376f | bvi              | 00:00:17 | 14 | 19 | 0    | 932 | 1326 | 0    |
     | 0014.4200.4935 | vpls 2.2.2.2 1:2 | 00:00:17 | 15 | 15 | 0    | 998 | 1006 | 0    |
     |________________|__________________|__________|____|____|______|_____|______|______|
    r1#
    r1#
    ```
    ...
    r1#show bridge 4
     ...
     | addr           | iface            | time     | tx | rx | drop | tx  | rx  | drop |
     |----------------|------------------|----------|----|----|------|-----|-----|------|
     | 0038.500c.7a22 | vpls 4321::2 1:2 | 00:00:17 | 14 | 15 | 0    | 924 | 954 | 0    |
     | 0063.4927.5736 | bvi              | 00:00:17 | 15 | 15 | 0    | 954 | 954 | 0    |
     |________________|__________________|__________|____|____|______|_____|_____|______|
    r1#
    r1#
    ```
