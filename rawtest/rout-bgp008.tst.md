...
=== "Verification"
    ...
    r1#show ipv4 bgp 1 sum
     ...
     |----------|----|-------|-------|------|----------|
     | 1.1.1.2  | 1  | true  | 2     | 5    | 00:00:19 |
     | 1.1.1.3  | 1  | true  | 2     | 5    | 00:00:18 |
     | 1.1.1.4  | 1  | true  | 2     | 5    | 00:00:18 |
    ...
    r1#show ipv6 bgp 1 sum
     ...
     | neighbor  | as | ready | learn | sent | uptime   |
     |-----------|----|-------|-------|------|----------|
     | 1234:1::2 | 1  | true  | 2     | 5    | 00:00:18 |
     | 1234:1::3 | 1  | true  | 2     | 5    | 00:00:18 |
     | 1234:1::4 | 1  | true  | 2     | 5    | 00:00:18 |
    ...
    r1#show ipv4 bgp 1 group
     ...
     |----------|----|-------|----------|
     | 1.1.1.2  | 1  | 0     | 00:00:19 |
     | 1.1.1.3  | 1  | 0     | 00:00:18 |
     | 1.1.1.4  | 1  | 0     | 00:00:19 |
    ...
    r1#show ipv6 bgp 1 group
     ...
     | neighbor  | as | group | uptime   |
     |-----------|----|-------|----------|
     | 1234:1::2 | 1  | 0     | 00:00:18 |
     | 1234:1::3 | 1  | 0     | 00:00:19 |
     | 1234:1::4 | 1  | 0     | 00:00:18 |
    ...
    r1#show ipv4 bgp 1 best
     ...
     | version         | 6        |                     |
     | full run        | 4        | times               |
     | full last       | 00:00:18 | 2021-12-30 23:22:50 |
     | full time       | 1        | ms                  |
     | incr run        | 1        | times               |
     | incr last       | 00:00:17 | 2021-12-30 23:22:51 |
     | incr time       | 0        | ms                  |
     | changes all     | 4        |                     |
     | changes now     | 0        |                     |
     | static peers    | 3        |                     |
    ...
    r1#show ipv6 bgp 1 best
     ...
     | version         | 6        |                     |
     | full run        | 3        | times               |
     | full last       | 00:00:18 | 2021-12-30 23:22:49 |
     | full time       | 1        | ms                  |
     | incr run        | 2        | times               |
     | incr last       | 00:00:16 | 2021-12-30 23:22:51 |
     | incr time       | 1        | ms                  |
     | changes all     | 4        |                     |
     | changes now     | 0        |                     |
     | static peers    | 3        |                     |
    ...
    r1#show ipv4 route v1
     ...
     | B   | 2.2.2.3/32 | 200/0  | ethernet1 | 1.1.1.3 | 00:00:18 |
    ...
    r1#show ipv6 route v1
     ...
     | B   | 4321::3/128   | 200/0  | ethernet1 | 1234:1::3 | 00:00:18 |
