...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |---------|---------|------|---------|---------|-------|----------|
     | serial1 | 4.4.4.1 | r1   | serial1 | 9.9.9.1 | true  | 00:00:07 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface   | router  | name | peerif  | peer    | ready | uptime   |
     |---------|---------|------|---------|---------|-------|----------|
     | serial1 | 6.6.6.1 | r1   | serial1 | 9999::1 | true  | 00:00:07 |
     |_________|_________|______|_________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 2   | 8   | bf1864f4 | 00:59:54 |
     | 4.4.4.2 | r2   | 1   | 2   | 8   | f141cf47 | 00:59:54 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 2   | 8   | 58f0e2a5 | 00:59:57 |
     | 6.6.6.2 | r2   | 1   | 2   | 8   | f141cf47 | 00:59:57 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | LOC  | 9999::2/128 | 0/1    | serial1   | null    | 00:00:09 |
