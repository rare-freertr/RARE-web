...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | true  | 00:00:25 |
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.1.6 | true  | 00:00:25 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface     | router  | name | peerif    | peer      | ready | uptime   |
     |-----------|---------|------|-----------|-----------|-------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | true  | 00:00:30 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1234:2::2 | true  | 00:00:30 |
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 3   | 7   | a0e2bfb9 | 00:59:53 |
     | 4.4.4.2 | r2   | 2   | 3   | 7   | 5c38b927 | 00:59:39 |
     | 4.4.4.3 | r3   | 1   | 3   | 5   | 7b7cad5a | 00:59:39 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 3   | 7   | a0e2bfb9 | 00:59:53 |
     | 6.6.6.2 | r2   | 2   | 3   | 7   | 5c38b927 | 00:59:35 |
     | 6.6.6.3 | r3   | 1   | 3   | 5   | 7b7cad5a | 00:59:35 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L EX | 2.2.2.1/32   | 70/20  | ethernet1 | 1.1.1.1 | 00:00:06 |
     | C    | 2.2.2.2/32   | 0/0    | loopback1 | null    | 00:00:31 |
     | L EX | 2.2.2.3/32   | 70/30  | ethernet2 | 1.1.1.6 | 00:00:21 |
     | L EX | 2.2.2.222/32 | 70/20  | ethernet1 | 1.1.1.1 | 00:00:06 |
    ...
    r2#show ipv6 route v1
     ...
     | L EX | 4321::1/128   | 70/20  | ethernet1 | 1234:1::1 | 00:00:06 |
     | C    | 4321::2/128   | 0/0    | loopback1 | null      | 00:00:31 |
     | L EX | 4321::3/128   | 70/30  | ethernet2 | 1234:2::2 | 00:00:25 |
     | L EX | 4321::222/128 | 70/20  | ethernet1 | 1234:1::1 | 00:00:06 |
