...
=== "Configuration"
    ...
    **r1:**
    ...
    router bgp4 1
     ...
     afi-evpn 101 bmac 004e.6029.0221
    ...
    router bgp6 1
     ...
     afi-evpn 101 bmac 0078.4611.4c70
     afi-evpn 101 encapsulation vxlan
     afi-evpn 101 update-source loopback0
     exit
    !
    ...
    **r2:**
    ...
    router bgp4 1
     ...
     afi-evpn 101 bridge-group 1
     afi-evpn 101 bmac 0058.0b36.2967
     afi-evpn 101 encapsulation vxlan
     afi-evpn 101 update-source loopback0
     exit
    !
    router bgp6 1
     ...
     afi-evpn 101 bridge-group 2
     afi-evpn 101 bmac 0038.6725.1303
     afi-evpn 101 encapsulation vxlan
     afi-evpn 101 update-source loopback0
     exit
    !
...
=== "Verification"
    ...
    r1#show ipv4 bgp 1 evpn dat
     ...
     |--------------------------|---------|------------|--------|
     | 200::57:1967:5848#:: 1:1 | 2.2.2.2 | 20/100/0/0 | 2      |
     | 200::5a:666b:7610#:: 1:1 | 2.2.2.1 | 0/0/0/0    |        |
    ...
    r1#show ipv6 bgp 1 evpn dat
     ...
     | prefix                   | hop     | metric     | aspath |
     |--------------------------|---------|------------|--------|
     | 200::18:3976:3f11#:: 1:2 | 4321::2 | 20/100/0/0 | 2      |
     | 200::43:3416:e2b#:: 1:2  | 4321::1 | 0/0/0/0    |        |
    ...
    r1#show bridge 1
     ...
     |----------------|------------------|----------|----|----|------|------|------|------|
     | 0057.1967.5848 | vxlan to 2.2.2.2 | 00:00:16 | 29 | 30 | 0    | 1922 | 1960 | 0    |
     | 005a.666b.7610 | bvi              | 00:00:16 | 29 | 34 | 0    | 1886 | 2280 | 0    |
    ...
    r1#show bridge 2
     ...
     | addr           | iface            | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|------------------|----------|----|----|------|------|------|------|
     | 0018.3976.3f11 | vxlan to 4321::2 | 00:00:16 | 29 | 30 | 0    | 1922 | 1960 | 0    |
     | 0043.3416.0e2b | bvi              | 00:00:16 | 29 | 34 | 0    | 1886 | 2280 | 0    |
     |________________|__________________|__________|____|____|______|______|______|______|
    r1#
    r1#
    ```
