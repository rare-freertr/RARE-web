...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.1.6 | 1       | 2        | 00:00:10 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 1       | 2        | 00:00:11 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1234:2::2 | 1       | 2        | 00:00:10 |
