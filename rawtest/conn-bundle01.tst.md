...
=== "Verification"
    ...
    r1#show inter bun1 full
    bundle1 is up (since 00:00:04, 3 changes)
     description:
     type is bundle, hwaddr=0044.2553.4122, mtu=1500, bw=100mbps, vrf=v1
     ip4 address=1.1.1.1/24, netmask=255.255.255.0, ifcid=546134848
     ip6 address=1234::1/16, netmask=ffff::, ifcid=230780693
    ...
    r1#show ipv4 arp bun1
     ...
     |----------------|---------|----------|--------|
     | 0000.0000.2222 | 1.1.1.2 | 00:00:04 | false  |
    ...
    r1#show ipv6 neigh bun1
     ...
     |----------------|------------------------|----------|--------|--------|
     | 0000.0000.2222 | 1234::2                | 00:00:04 | false  | false  |
     | 0000.0000.2222 | fe80::200:ff:fe00:2222 | 00:00:04 | false  | true   |
