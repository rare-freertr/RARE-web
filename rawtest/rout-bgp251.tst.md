...
=== "Verification"
    ...
    r1#show ipv4 route v1
     ...
     | LOC | 1.1.1.1/32 | 0/1    | ethernet1 | null    | 00:00:12 |
    ...
    r1#show ipv6 route v1
     ...
     | LOC | 1234:1::1/128 | 0/1    | ethernet1 | null      | 00:00:12 |
    ...
    r1#show ipv4 route v2
     ...
     | typ | prefix     | metric | iface     | hop     | time     |
     |-----|------------|--------|-----------|---------|----------|
     | C   | 9.9.2.1/32 | 0/0    | loopback2 | null    | 00:00:12 |
    ...
    r1#show ipv6 route v2
     ...
     | typ | prefix      | metric | iface     | hop     | time     |
     |-----|-------------|--------|-----------|---------|----------|
     | C   | 9992::1/128 | 0/0    | loopback2 | null    | 00:00:12 |
    ...
    r1#show ipv6 route v4
     ...
     | B   | 9994::2/128 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:08 |
     |_____|_____________|________|___________|_________|__________|
    r1#
    r1#
    ```
