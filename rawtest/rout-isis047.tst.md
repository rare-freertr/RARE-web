...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | serial1   | 0000.0000.0000 | 2     | 4444.0000.1111 | 9.9.9.1    | ::            | up    | 00:00:01 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | serial2   | 0000.0000.0000 | 2     | 6666.0000.1111 | 9999::1    | ::            | up    | 00:00:01 |
     |___________|________________|_______|________________|____________|_______________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000007 | apo   | 32  | 00:19:49 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.1111.00-00 | 00000008 | apo   | 58  | 00:19:56 |
     | 6666.0000.2222.00-00 | 00000008 | apo   | 58  | 00:19:57 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | typ  | prefix      | metric | iface     | hop     | time     |
     |------|-------------|--------|-----------|---------|----------|
     | I EX | 4321::1/128 | 115/10 | serial2   | 9999::1 | 00:00:02 |
     | C    | 4321::2/128 | 0/0    | loopback0 | null    | 00:00:13 |
     | C    | 9999::/16   | 0/0    | serial2   | null    | 00:00:10 |
     | MSH  | 9999::1/128 | 0/3    | serial2   | 9999::1 | never    |
     | LOC  | 9999::2/128 | 0/1    | serial2   | null    | 00:00:10 |
