...
=== "Verification"
    ...
    dialer1 is up (since 00:00:01, 3 changes)
     ...
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=478814063
     ip6 address=2222::2/64, netmask=ffff:ffff:ffff:ffff::, ifcid=490894927
     received 10 packets (720 bytes) dropped 3 packets (230 bytes)
     ...
     | ethtyp | 86dd  | ip6     | 8  | 5  | 0    | 560 | 360 | 0    |
