...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | lwapp to 1.1.1.1 | true | false | 28 | 28 | 0    | 1868 | 2204 | 0    |     |
     |__________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                              | packet         | byte               |
     | addr           | iface            | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|------------------|----------|----|----|------|------|------|------|
     | 0020.4b65.750c | lwapp to 1.1.1.1 | 00:00:05 | 25 | 28 | 0    | 1614 | 1868 | 0    |
     | 0061.1373.625f | bvi              | 00:00:05 | 24 | 28 | 0    | 1584 | 1868 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0061.1373.625f, mtu=1400, bw=4000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=8500007
     ip6 address=4321::2/16, netmask=ffff::, ifcid=419709235
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 0020.4b65.750c | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|--------------------------|----------|--------|--------|
     | 0020.4b65.750c | 4321::1                  | 00:00:04 | false  | false  |
     | 0020.4b65.750c | fe80::220:4bff:fe65:750c | 00:00:04 | false  | true   |
