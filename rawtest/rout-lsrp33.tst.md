...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 2   | 10  | b8f557ab | 00:59:56 |
     | 4.4.4.2 | r2   | 2   | 3   | 13  | dc37d88d | 00:59:56 |
     | 4.4.4.3 | r3   | 1   | 2   | 9   | b5f044c1 | 00:59:55 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 2   | 10  | bf1864f4 | 00:59:56 |
     | 6.6.6.2 | r2   | 2   | 3   | 14  | cc222f26 | 00:59:58 |
     | 6.6.6.3 | r3   | 1   | 2   | 8   | eb663b5b | 00:59:58 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L   | 2.2.2.3/32 | 70/10  | ethernet2 | 1.1.2.3 | 00:00:04 |
    ...
    r2#show ipv6 route v1
     ...
     | L   | 4321::1/128 | 70/10  | ethernet1 | 1234::1 | 00:00:03 |
     | C   | 4321::2/128 | 0/0    | loopback1 | null    | 00:00:13 |
     | L   | 4321::3/128 | 70/10  | ethernet2 | 1235::3 | 00:00:01 |
    ...
    r2#show ipv4 segrou v1
     ...
     |------------|-------|--------|---------|
     | 2.2.2.1/32 | 1     | 950037 | 950037  |
     | 2.2.2.3/32 | 3     | 65534  | 65534   |
    ...
    r2#show ipv6 segrou v1
     ...
     | prefix      | index | base   | oldbase |
     |-------------|-------|--------|---------|
     | 4321::1/128 | 1     | 591406 | 591406  |
     | 4321::3/128 | 3     | 903073 | 903073  |
