...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | dlsw to 1.1.1.1 | true | false | 28 | 27 | 0    | 1868 | 2118 | 0    |     |
     |_________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                             | packet         | byte               |
     | addr           | iface           | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|-----------------|----------|----|----|------|------|------|------|
     | 000c.0468.0336 | dlsw to 1.1.1.1 | 00:00:04 | 25 | 27 | 0    | 1614 | 1794 | 0    |
     | 0042.5741.6864 | bvi             | 00:00:04 | 24 | 28 | 0    | 1584 | 1868 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0042.5741.6864, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=610200217
     ip6 address=4321::2/16, netmask=ffff::, ifcid=802892611
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 000c.0468.0336 | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|------------------------|----------|--------|--------|
     | 000c.0468.0336 | 4321::1                | 00:00:04 | false  | false  |
     | 000c.0468.0336 | fe80::20c:4ff:fe68:336 | 00:00:05 | false  | true   |
