...
=== "Verification"
    ...
    r2#show ipv6 isis 1 nei
     ...
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | tunnel1   | 0000.0000.0000 | 2     | 4444.0000.1111 | 1234::1    | 1.1.1.1       | up    | 00:00:04 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000011 | apo   | 101 | 00:19:54 |
     | 4444.0000.2222.00-00 | 00000011 | apo   | 101 | 00:19:55 |
    ...
    r2#show ipv4 route v1
     ...
     |-----|------------|--------|-----------|---------|----------|
     | C   | 1.1.1.0/24 | 0/0    | tunnel1   | null    | 00:00:05 |
     | LOC | 1.1.1.2/32 | 0/1    | tunnel1   | null    | 00:00:05 |
     | I   | 2.2.2.1/32 | 115/10 | tunnel1   | 1.1.1.1 | 00:00:02 |
     | C   | 2.2.2.2/32 | 0/0    | loopback1 | null    | 00:00:06 |
     | C   | 9.9.9.0/30 | 0/0    | ethernet1 | null    | 00:00:06 |
     | LOC | 9.9.9.2/32 | 0/1    | ethernet1 | null    | 00:00:06 |
    ...
    r2#show ipv6 route v1
     ...
     | typ  | prefix      | metric | iface     | hop     | time     |
     |------|-------------|--------|-----------|---------|----------|
     | C    | 1234::/16   | 0/0    | tunnel1   | null    | 00:00:05 |
     | LOC  | 1234::2/128 | 0/1    | tunnel1   | null    | 00:00:05 |
     | I EX | 4321::1/128 | 115/10 | tunnel1   | 1234::1 | 00:00:02 |
     | C    | 4321::2/128 | 0/0    | loopback1 | null    | 00:00:06 |
     | C    | 9999::/16   | 0/0    | ethernet1 | null    | 00:00:06 |
     | LOC  | 9999::2/128 | 0/1    | ethernet1 | null    | 00:00:06 |
