# Example: isis inter level ingress filtering with routepolicy
...
=== "Configuration"
    ...
    **r2:**
    ...
    router isis4 1
     ...
     traffeng-id ::
     is-type both
     level2 route-policy-from p4
     level1 route-policy-from p4
     redistribute connected
     exit
    !
    router isis6 1
     ...
     traffeng-id ::
     is-type both
     level2 route-policy-from p6
     level1 route-policy-from p6
     redistribute connected
     exit
    !
    interface loopback1
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000009 | apo   | 57  | 00:19:41 |
     | 4444.0000.2222.00-00 | 0000000c | apo   | 79  | 00:19:51 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | 6666.0000.2222.00-00 | 0000000d | apo   | 120 | 00:19:52 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
