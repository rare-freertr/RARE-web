...
*  `tna-install-latest`
   ...
   This will install the latest release available from [RARE-NIX repository](https://bitbucket.software.geant.org/projects/RARE/repos/rare-nix/browse) `<release-number>` branch
