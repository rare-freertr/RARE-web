...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 4.4.4.1 | null | null      | 1.1.1.1 | false | 00:00:05 |
     | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.2.1 | true  | 00:00:05 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface     | router  | name | peerif    | peer    | ready | uptime   |
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 6.6.6.1 | null | null      | 1234::1 | false | 00:00:05 |
     | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1235::1 | true  | 00:00:05 |
     |___________|_________|______|___________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 3   | 10  | c81f5462 | 00:59:57 |
     | 4.4.4.2 | r2   | 1   | 3   | 10  | 2328ef61 | 00:59:57 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 3   | 10  | b2f83345 | 00:59:59 |
     | 6.6.6.2 | r2   | 1   | 3   | 11  | 7f749bc2 | 00:59:59 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L EX | 2.2.2.1/32 | 70/2   | ethernet2 | 1.1.2.1 | 00:00:02 |
    ...
    r2#show ipv6 route v1
     ...
     | L EX | 4321::1/128 | 70/6   | ethernet2 | 1235::1 | 00:00:00 |
