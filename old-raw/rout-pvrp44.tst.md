# Example: pvrp dynamic inband metric
...
=== "Configuration"
    ...
    **r2:**
    ...
    interface ethernet1
     ...
     router pvrp4 1 enable
     router pvrp4 1 dynamic-metric inband
     router pvrp4 1 metric-in 2
     router pvrp6 1 enable
     router pvrp6 1 dynamic-metric inband
...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | null | null      | 1.1.1.1 | 0       | 0        | 00:00:06 |
     | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.2.1 | 2       | 2        | 00:00:05 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | ethernet2 | 6.6.6.1 | null | null      | 1235::1 | 0       | 0        | 00:00:06 |
     |___________|_________|______|___________|_________|_________|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     |------|------------|--------|-----------|---------|----------|
     | C    | 1.1.1.0/24 | 1/0    | ethernet1 | null    | 00:00:00 |
     | C    | 1.1.2.0/24 | 1/0    | ethernet2 | null    | 00:00:00 |
     | null | 2.2.2.1/32 | 80/200 | ethernet2 | 1.1.2.1 | 00:00:00 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | C    | 1235::/16   | 1/0    | ethernet2 | null    | 00:00:01 |
    ...
    r2#show ipv4 route v1
     ...
     | C    | 1.1.2.0/24 | 0/0    | ethernet2 | null    | 00:00:11 |
     | LOC  | 1.1.2.2/32 | 0/1    | ethernet2 | null    | 00:00:11 |
     | P EX | 2.2.2.1/32 | 80/200 | ethernet2 | 1.1.2.1 | 00:00:01 |
    ...
    r2#show ipv6 route v1
     ...
     | C    | 1235::/16   | 0/0    | ethernet2 | null    | 00:00:11 |
     | LOC  | 1235::2/128 | 0/1    | ethernet2 | null    | 00:00:11 |
     | P EX | 4321::1/128 | 80/2   | ethernet1 | 1234::1 | 00:00:01 |
