...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | true  | 00:00:15 |
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.2.3 | true  | 00:00:15 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface     | router  | name | peerif    | peer    | ready | uptime   |
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::1 | true  | 00:00:15 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1235::3 | true  | 00:00:20 |
     |___________|_________|______|___________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 3   | 9   | b33a5972 | 00:59:46 |
     | 4.4.4.2 | r2   | 2   | 3   | 12  | 5c38b927 | 00:59:49 |
     | 4.4.4.3 | r3   | 1   | 3   | 8   | ccea845f | 00:59:49 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 3   | 9   | a17e7c7c | 00:59:48 |
     | 6.6.6.2 | r2   | 2   | 3   | 12  | 0ebb7815 | 00:59:48 |
     | 6.6.6.3 | r3   | 1   | 3   | 9   | c2f77457 | 00:59:42 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L EX | 2.2.2.1/32 | 70/10  | ethernet1 | 1.1.1.1 | 00:00:14 |
    ...
    r2#show ipv6 route v1
     ...
     | C    | 1235::/16      | 0/0    | ethernet2 | null    | 00:00:21 |
     | LOC  | 1235::2/128    | 0/1    | ethernet2 | null    | 00:00:21 |
     | L EX | 4321::1/128    | 70/10  | ethernet1 | 1234::1 | 00:00:12 |
     | C    | 4321::2/128    | 0/0    | loopback1 | null    | 00:00:22 |
     | L EX | 4321::3/128    | 70/10  | ethernet2 | 1235::3 | 00:00:18 |
     | L EX | 4321::1110/124 | 70/10  | ethernet2 | 1235::3 | 00:00:18 |
    ...
    r2#show ipv4 bier v1
     ...
     |------------|-------|--------|---------|-------|
     | 2.2.2.1/32 | 1     | 735737 | 735737  | 3-256 |
     | 2.2.2.3/32 | 3     | 457450 | 457450  | 3-256 |
     | 3.3.3.0/30 | 3     | 457450 | 457450  | 3-256 |
    ...
    r2#show ipv6 bier v1
     ...
     | prefix         | index | base   | oldbase | size  |
     |----------------|-------|--------|---------|-------|
     | 4321::1/128    | 1     | 652520 | 652520  | 3-256 |
     | 4321::3/128    | 3     | 884413 | 884413  | 3-256 |
     | 4321::1110/124 | 3     | 884413 | 884413  | 3-256 |
