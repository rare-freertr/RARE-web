...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 2   | 3   | 58f0e2a5 | 00:59:56 |
     | 4.4.4.2 | r2   | 1   | 2   | 6   | 542fdff7 | 00:59:56 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 2   | 3   | bf1864f4 | 00:59:58 |
    ...
    r2#show ipv4 route v1
     ...
     |-----|------------|--------|-----------|---------|----------|
     | L   | 0.0.0.0/0  | 70/10  | ethernet1 | 1.1.1.1 | 00:00:03 |
    ...
    r2#show ipv6 route v1
     ...
     | typ | prefix        | metric | iface     | hop       | time     |
     |-----|---------------|--------|-----------|-----------|----------|
     | L   | ::/0          | 70/10  | ethernet1 | 1234:1::1 | 00:00:02 |
