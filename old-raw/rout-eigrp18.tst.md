...
=== "Verification"
    ...
    r2#show ipv4 eigrp 1 rou
     ...
     |------|------------|--------|-----------|---------|----------|
     | null | 2.2.2.1/32 | 90/10  | serial1   | 9.9.9.1 | 00:00:04 |
     | C    | 2.2.2.2/32 | 0/0    | loopback0 | null    | 00:00:05 |
     | C    | 9.9.9.0/24 | 0/0    | serial1   | null    | 00:00:05 |
    ...
    r2#show ipv6 eigrp 1 rou
     ...
     | typ  | prefix      | metric | iface     | hop     | time     |
     |------|-------------|--------|-----------|---------|----------|
     | null | 4321::1/128 | 90/10  | serial1   | 9999::1 | 00:00:04 |
     | C    | 4321::2/128 | 0/0    | loopback0 | null    | 00:00:05 |
     | C    | 9999::/16   | 0/0    | serial1   | null    | 00:00:05 |
    ...
    r2#show ipv4 route v1
     ...
     | typ | prefix     | metric | iface     | hop     | time     |
     |-----|------------|--------|-----------|---------|----------|
     | D   | 2.2.2.1/32 | 90/10  | serial1   | 9.9.9.1 | 00:00:04 |
     | C   | 2.2.2.2/32 | 0/0    | loopback0 | null    | 00:00:09 |
     | C   | 9.9.9.0/24 | 0/0    | serial1   | null    | 00:00:05 |
     | MSH | 9.9.9.1/32 | 0/3    | serial1   | 9.9.9.1 | never    |
     | LOC | 9.9.9.2/32 | 0/1    | serial1   | null    | 00:00:05 |
    ...
    r2#show ipv6 route v1
     ...
     | LOC | 9999::2/128 | 0/1    | serial1   | null    | 00:00:05 |
