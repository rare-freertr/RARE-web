...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     |----------------|-------------------|--------|----------|----|----|------|------|------|------|
     | 006d.0a00.1f60 | erspan to 1.1.1.1 | false  | 00:00:04 | 29 | 31 | 0    | 1878 | 2018 | 0    |
     | 007e.535c.0632 | bvi               | false  | 00:00:04 | 30 | 33 | 0    | 1988 | 2206 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=007e.535c.0632, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=918317270
     ip6 address=4321::2/16, netmask=ffff::, ifcid=1046566645
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 006d.0a00.1f60 | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 006d.0a00.1f60 | 4321::1 | 00:00:04 | false  | false  |
