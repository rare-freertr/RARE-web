# Example: p4lang: gre routing over hairpin vlan
...
=== "Configuration"
    ...
    **r1:**
    ...
    int sdn1
     ...
     ipv4 proxy-local
     exit
    ipv4 route v3 9.9.9.1 255.255.255.255 9.9.9.1 int hair12.111
    ipv4 route v3 9.9.9.2 255.255.255.255 9.9.9.2 int sdn1
    int tun1
     tun vrf v2
     tun source hair11.111
    ...
    server p4lang p4
     ...
     export-port hair11.111 222
     export-port hair12.111 223
