...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     |----------------|------------------|--------|----------|----|----|------|------|------|------|
     | 0023.2238.1729 | bvi              | false  | 00:00:05 | 30 | 33 | 0    | 1988 | 2206 | 0    |
     | 0042.5a55.244b | lwapp to 1.1.1.1 | false  | 00:00:05 | 29 | 31 | 0    | 1878 | 2018 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0023.2238.1729, mtu=1400, bw=4000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=774621359
     ip6 address=4321::2/16, netmask=ffff::, ifcid=790952508
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 0042.5a55.244b | 2.2.2.1 | 00:00:05 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 0042.5a55.244b | 4321::1 | 00:00:05 | false  | false  |
