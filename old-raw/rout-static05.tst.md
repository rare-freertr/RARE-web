...
=== "Verification"
    ...
    r2#show tracker
     ...
     | t2   | normal | bfd  | 1234:2::1 | up    | 1       | 00:00:03 |
    ...
    r2#show ipv4 bfd v1 nei
     ...
     |-----------|---------|-------|----------|---------|
     | ethernet2 | 1.1.2.1 | up    | 00:00:05 | tracker |
    ...
    r2#show ipv6 bfd v1 nei
     ...
     | interface | address   | state | uptime   | clients |
     |-----------|-----------|-------|----------|---------|
     | ethernet2 | 1234:2::1 | up    | 00:00:05 | tracker |
    ...
    r2#show ipv4 route v1
     ...
     |-----|--------------|--------|-----------|---------|----------|
     | S   | 0.0.0.0/0    | 11/0   | ethernet2 | 1.1.2.1 | 00:00:03 |
     | C   | 1.1.1.0/30   | 0/0    | ethernet1 | null    | 00:00:06 |
     | LOC | 1.1.1.2/32   | 0/1    | ethernet1 | null    | 00:00:06 |
     | C   | 1.1.2.0/30   | 0/0    | ethernet2 | null    | 00:00:06 |
     | LOC | 1.1.2.2/32   | 0/1    | ethernet2 | null    | 00:00:06 |
     | C   | 2.2.2.201/32 | 0/0    | loopback0 | null    | 00:00:06 |
    ...
    r2#show ipv6 route v1
     ...
     | typ | prefix        | metric | iface     | hop       | time     |
     |-----|---------------|--------|-----------|-----------|----------|
     | S   | ::/0          | 11/0   | ethernet2 | 1234:2::1 | 00:00:04 |
