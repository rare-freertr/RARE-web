# Example: pvrp ingress route filtering with routemap
...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 3       | 3        | 00:00:05 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 3       | 3        | 00:00:11 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | null | 2.2.2.11/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
     | C    | 2.2.2.12/32 | 2/0    | loopback1 | null    | 00:00:11 |
     | null | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
     | C    | 2.2.2.22/32 | 2/0    | loopback2 | null    | 00:00:11 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | C    | 4321::2/128  | 2/0    | loopback0 | null      | 00:00:11 |
     | null | 4321::11/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:08 |
     | C    | 4321::12/128 | 2/0    | loopback1 | null      | 00:00:11 |
     | null | 4321::21/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:08 |
     | C    | 4321::22/128 | 2/0    | loopback2 | null      | 00:00:11 |
    ...
    r2#show ipv4 route v1
     ...
     | P EX | 2.2.2.11/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:02 |
     | C    | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:11 |
     | P EX | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:02 |
     | C    | 2.2.2.22/32 | 0/0    | loopback2 | null    | 00:00:11 |
     |______|_____________|________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | P EX | 4321::1/128   | 80/10  | ethernet1 | 1234:1::1 | 00:00:09 |
     | C    | 4321::2/128   | 0/0    | loopback0 | null      | 00:00:12 |
     | P EX | 4321::11/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:09 |
     | C    | 4321::12/128  | 0/0    | loopback1 | null      | 00:00:12 |
     | P EX | 4321::21/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:08 |
     | C    | 4321::22/128  | 0/0    | loopback2 | null      | 00:00:12 |
