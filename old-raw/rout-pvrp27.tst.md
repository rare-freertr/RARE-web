...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     |------|------------|--------|-----------|---------|----------|
     | null | 2.2.2.1/32 | 80/10  | serial1   | 9.9.9.1 | 00:00:06 |
     | C    | 2.2.2.2/32 | 2/0    | loopback0 | null    | 00:00:09 |
     | C    | 9.9.9.0/24 | 1/0    | serial1   | null    | 00:00:06 |
    ...
    r2#show ipv4 route v1
     ...
     | typ  | prefix     | metric | iface     | hop     | time     |
     |------|------------|--------|-----------|---------|----------|
     | P EX | 2.2.2.1/32 | 80/10  | serial1   | 9.9.9.1 | 00:00:06 |
    ...
    r2#show ipv6 route v1
     ...
     | typ  | prefix      | metric | iface     | hop     | time     |
     |------|-------------|--------|-----------|---------|----------|
     | P EX | 4321::1/128 | 80/10  | serial1   | 9999::1 | 00:00:03 |
