...
=== "Verification"
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface     | router  | name | peerif    | peer    | ready | uptime   |
     |-----------|---------|------|-----------|---------|-------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::1 | true  | 00:00:14 |
     |___________|_________|______|___________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 3   | 9   | c81f5462 | 00:59:51 |
     | 6.6.6.2 | r2   | 1   | 3   | 10  | 5bd02654 | 00:59:51 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | C    | 9.9.9.0/24 | 0/0    | template1 | null    | 00:00:15 |
     | LOC  | 9.9.9.9/32 | 0/1    | template1 | null    | 00:00:15 |
    ...
    r2#show ipv6 route v1
     ...
     | C    | 9999::/16   | 0/0    | template1 | null    | 00:00:15 |
     | LOC  | 9999::9/128 | 0/1    | template1 | null    | 00:00:15 |
