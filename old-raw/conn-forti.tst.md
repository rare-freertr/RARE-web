...
=== "Verification"
    ...
    dialer1 is up (since 00:00:00, 3 changes)
     ...
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=317080208
     ip6 address=2222::2/64, netmask=ffff:ffff:ffff:ffff::, ifcid=1064382346
     received 13 packets (968 bytes) dropped 0 packets (0 bytes)
     transmitted 13 packets (890 bytes) promisc=false macsec=false
     |~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
     |       | packet         | byte             |
     | time  | tx | rx | drop | tx  | rx  | drop |
     |-------|----|----|------|-----|-----|------|
     | 1sec  | 8  | 8  | 0    | 560 | 608 | 0    |
     | 1min  | 0  | 0  | 0    | 0   | 0   | 0    |
     | 1hour | 0  | 0  | 0    | 0   | 0   | 0    |
     ...
     | ethtyp | 0800  | ip4     | 5  | 5  | 0    | 330 | 360 | 0    |
     | ethtyp | 86dd  | ip6     | 8  | 8  | 0    | 560 | 608 | 0    |
