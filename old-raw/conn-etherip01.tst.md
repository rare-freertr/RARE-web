...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     |----------------|--------------------|--------|----------|----|----|------|------|------|------|
     | 0012.2119.7e47 | bvi                | false  | 00:00:05 | 30 | 33 | 0    | 1988 | 2206 | 0    |
     | 002e.2276.453b | etherip to 1.1.1.1 | false  | 00:00:05 | 29 | 31 | 0    | 1878 | 2018 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0012.2119.7e47, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=494090370
     ip6 address=4321::2/16, netmask=ffff::, ifcid=81282558
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 002e.2276.453b | 2.2.2.1 | 00:00:05 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 002e.2276.453b | 4321::1 | 00:00:05 | false  | false  |
