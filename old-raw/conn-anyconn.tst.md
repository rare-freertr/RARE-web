...
=== "Verification"
    ...
    r2#show inter dia1 full
    dialer1 is up (since 00:00:03, 3 changes)
     description:
     type is dialer, hwaddr=none, mtu=1504, bw=8000kbps, vrf=v1
     ip4 address=2.2.2.222/24, netmask=255.255.255.0, ifcid=282440076
     ip6 address=2222::84/64, netmask=ffff:ffff:ffff:ffff::, ifcid=451816113
     received 23 packets (1734 bytes) dropped 0 packets (0 bytes)
     transmitted 26 packets (1780 bytes) promisc=false macsec=false
     |~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |       | packet         | byte               |
     | time  | tx | rx | drop | tx   | rx   | drop |
     |-------|----|----|------|------|------|------|
     | 1sec  | 18 | 18 | 0    | 1220 | 1364 | 0    |
     | 1min  | 0  | 0  | 0    | 0    | 0    | 0    |
     | 1hour | 0  | 0  | 0    | 0    | 0    | 0    |
     ...
     | ethtyp | 0800  | ip4     | 10 | 10 | 0    | 660  | 740 | 0    |
     | ethtyp | 86dd  | ip6     | 16 | 13 | 0    | 1120 | 994 | 0    |
