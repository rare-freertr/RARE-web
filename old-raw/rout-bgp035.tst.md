...
=== "Verification"
    ...
    r1#show ipv6 route v1
     ...
     | LOC | 1234:1::1/128 | 0/1    | ethernet1 | null      | 00:00:14 |
    ...
    r1#show ipv4 route v2
     ...
     | typ | prefix     | metric | iface     | hop     | time     |
     |-----|------------|--------|-----------|---------|----------|
     | C   | 9.9.2.1/32 | 0/0    | loopback2 | null    | 00:00:15 |
     | B   | 9.9.2.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:11 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv6 route v2
     ...
     | typ | prefix      | metric | iface     | hop     | time     |
     |-----|-------------|--------|-----------|---------|----------|
     | C   | 9992::1/128 | 0/0    | loopback2 | null    | 00:00:15 |
     | B   | 9992::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:11 |
    ...
    r1#show ipv4 route v3
     ...
     | typ | prefix     | metric | iface     | hop     | time     |
     |-----|------------|--------|-----------|---------|----------|
     | C   | 9.9.3.1/32 | 0/0    | loopback3 | null    | 00:00:15 |
     | B   | 9.9.3.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:12 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv6 route v3
     ...
     | B   | 9993::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:12 |
     |_____|_____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv4 route v4
     ...
     | B   | 9.9.4.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:12 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv6 route v4
     ...
     | B   | 9994::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:12 |
     |_____|_____________|________|___________|_________|__________|
    r1#
    r1#
    ```
