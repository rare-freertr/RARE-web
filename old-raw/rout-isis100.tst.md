...
=== "Verification"
    ...
    r2#show ipv6 isis 1 nei
     ...
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1234::1    | 1.1.1.1       | up    | 00:00:07 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000003 | apo   | 25  | 00:19:51 |
     | 6666.0000.2222.00-00 | 0000000d | apo   | 80  | 00:19:52 |
    ...
    r2#show ipv4 route v1
     ...
     | C   | 2.2.2.111/32 | 0/0    | loopback11 | null | 00:00:09 |
     |_____|______________|________|____________|______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | typ | prefix        | metric | iface      | hop  | time     |
     |-----|---------------|--------|------------|------|----------|
     | C   | 1234::/16     | 0/0    | ethernet1  | null | 00:00:08 |
     | LOC | 1234::2/128   | 0/1    | ethernet1  | null | 00:00:08 |
     | C   | 4321::111/128 | 0/0    | loopback11 | null | 00:00:09 |
     |_____|_______________|________|____________|______|__________|
    r2#
    r2#
    ```
