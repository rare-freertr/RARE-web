...
=== "Verification"
    ...
    r2#show ipv4 ospf 1 nei
     ...
     |-----------|------|---------|----------|-------|----------|
     | serial1   | 0    | 9.9.9.1 | 4.4.4.1  | full  | 00:00:04 |
    ...
    r2#show ipv6 ospf 1 nei
     ...
     | interface | area | address | routerid | state | uptime   |
     |-----------|------|---------|----------|-------|----------|
     | serial1   | 0    | 9999::1 | 6.6.6.1  | full  | 00:00:04 |
     |___________|______|_________|__________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 ospf 1 dat 0
     ...
     | 4.4.4.1  | 0.0.0.0 | 80000002 | asExternal  | 16  | 01:00:14 |
     | 4.4.4.1  | 2.2.2.1 | 80000001 | asExternal  | 16  | 00:00:14 |
     | 4.4.4.2  | 2.2.2.2 | 80000001 | asExternal  | 16  | 00:00:15 |
     | 4.4.4.1  | 9.9.9.0 | 80000003 | asExternal  | 16  | 00:00:10 |
     | 4.4.4.2  | 9.9.9.0 | 80000001 | asExternal  | 16  | 00:00:11 |
    ...
    r2#show ipv6 ospf 1 dat 0
     ...
     | routerid | lsaid      | sequence | type       | len | time     |
     |----------|------------|----------|------------|-----|----------|
     | 6.6.6.1  | 856028343  | 80000001 | link       | 24  | 00:00:11 |
     | 6.6.6.2  | 1010838248 | 80000001 | link       | 24  | 00:00:11 |
     | 6.6.6.1  | 0          | 80000003 | router     | 20  | 00:00:02 |
     | 6.6.6.2  | 0          | 80000003 | router     | 20  | 00:00:02 |
     | 6.6.6.1  | 856028343  | 80000001 | prefix     | 20  | 00:00:11 |
     | 6.6.6.2  | 1010838248 | 80000001 | prefix     | 20  | 00:00:11 |
     | 6.6.6.1  | 0          | 80000004 | asExternal | 28  | 00:00:15 |
     | 6.6.6.2  | 0          | 80000003 | asExternal | 28  | 00:00:15 |
     | 6.6.6.1  | 1          | 80000004 | asExternal | 16  | 00:00:11 |
     | 6.6.6.2  | 1          | 80000004 | asExternal | 16  | 00:00:11 |
    ...
    r2#show ipv4 route v1
     ...
     |------|------------|--------|-----------|---------|----------|
     | O E2 | 2.2.2.1/32 | 110/0  | serial1   | 9.9.9.1 | 00:00:05 |
