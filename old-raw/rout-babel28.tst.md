# Example: babel address unsuppression
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface loopback1
     ...
     router babel4 1 enable
     router babel4 1 unsuppress-prefix
     router babel6 1 enable
     router babel6 1 unsuppress-prefix
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 route v1
     ...
     | A   | 2.2.2.11/32 | 130/100 | ethernet1 | 1.1.1.1 | 00:00:06 |
     | C   | 2.2.2.12/32 | 0/0     | loopback1 | null    | 00:00:26 |
     | C   | 2.2.2.22/32 | 0/0     | loopback2 | null    | 00:00:26 |
     |_____|_____________|_________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | C   | 4321::22/128  | 0/0     | loopback2 | null      | 00:00:26 |
