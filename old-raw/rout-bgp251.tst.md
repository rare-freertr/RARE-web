...
=== "Verification"
    ...
    r1#show ipv4 route v1
     ...
     | S   | 2.2.2.2/32 | 1/0    | ethernet1 | 1.1.1.2 | 00:00:01 |
    ...
    r1#show ipv4 route v2
     ...
     | B   | 9.9.2.2/32 | 20/0   | null@v1:6 | 4321::2 | 00:00:11 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv4 route v3
     ...
     | B   | 9.9.3.2/32 | 20/0   | null@v1:6 | 4321::2 | 00:00:11 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv6 route v3
     ...
     | B   | 9993::2/128 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:12 |
     |_____|_____________|________|___________|_________|__________|
    r1#
    r1#
    ```
    ...
    r1#show ipv4 route v4
     ...
     | B   | 9.9.4.2/32 | 20/0   | null@v1:6 | 4321::2 | 00:00:11 |
     |_____|____________|________|___________|_________|__________|
    r1#
    r1#
    ```
