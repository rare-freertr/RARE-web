...
=== "Configuration"
    ...
    **r1:**
    ...
    router bgp4 1
     ...
     afi-evpn 101 bmac 0061.4f48.1065
     afi-evpn 101 encapsulation pbb
     afi-evpn 101 update-source loopback0
     afi-evpn 102 bridge-group 3
     afi-evpn 102 bmac 0044.017c.6253
    ...
    router bgp6 1
     ...
     afi-evpn 101 bmac 0067.0d3d.3e2a
     afi-evpn 101 encapsulation pbb
     afi-evpn 101 update-source loopback0
     afi-evpn 102 bridge-group 4
     afi-evpn 102 bmac 005a.242e.1b69
     afi-evpn 102 encapsulation pbb
     afi-evpn 102 update-source loopback0
     exit
    !
    ...
    **r2:**
    ...
    router bgp4 1
     ...
     afi-evpn 101 bridge-group 1
     afi-evpn 101 bmac 007a.3c6a.0d50
     afi-evpn 101 encapsulation pbb
     afi-evpn 101 update-source loopback0
     afi-evpn 102 bridge-group 3
     afi-evpn 102 bmac 0032.5d02.7455
     afi-evpn 102 encapsulation pbb
     afi-evpn 102 update-source loopback0
     exit
    !
    router bgp6 1
     ...
     afi-evpn 101 bridge-group 2
     afi-evpn 101 bmac 006b.2773.052a
     afi-evpn 101 encapsulation pbb
     afi-evpn 101 update-source loopback0
     afi-evpn 102 bridge-group 4
     afi-evpn 102 bmac 002d.7304.2845
     afi-evpn 102 encapsulation pbb
     afi-evpn 102 update-source loopback0
     exit
    !
...
=== "Verification"
    ...
    r1#show ipv4 bgp 1 evpn dat
     ...
     |--------------------------|---------|------------|--------|
     | 200::61:4f48:1065#:: 1:1 | 2.2.2.1 | 0/0/0/0    |        |
     | 200::7a:3c6a:d50#:: 1:1  | 2.2.2.2 | 20/100/0/0 | 2      |
     | 300:0:65::#2.2.2.2 1:1   | 2.2.2.2 | 20/100/0/0 | 2      |
     | 300:0:65::#2.2.2.1 1:1   | 2.2.2.1 | 0/0/0/0    |        |
     | 200::32:5d02:7455#:: 1:3 | 2.2.2.2 | 20/100/0/0 | 2      |
     | 200::44:17c:6253#:: 1:3  | 2.2.2.1 | 0/0/0/0    |        |
    ...
    r1#show ipv6 bgp 1 evpn dat
     ...
     | prefix                   | hop     | metric     | aspath |
     |--------------------------|---------|------------|--------|
     | 200::67:d3d:3e2a#:: 1:2  | 4321::1 | 0/0/0/0    |        |
     | 200::6b:2773:52a#:: 1:2  | 4321::2 | 20/100/0/0 | 2      |
     | 300:0:65::#4321::2 1:2   | 4321::2 | 20/100/0/0 | 2      |
     | 300:0:65::#4321::1 1:2   | 4321::1 | 0/0/0/0    |        |
     | 200::2d:7304:2845#:: 1:4 | 4321::2 | 20/100/0/0 | 2      |
     | 200::5a:242e:1b69#:: 1:4 | 4321::1 | 0/0/0/0    |        |
    ...
    r1#show bridge 1
     ...
     | evpn 2.2.2.2 101 | true | false | 15 | 15 | 0    | 954 | 954 | 0    |     |
     |__________________|______|_______|____|____|______|_____|_____|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
     |                                            | packet             | byte             |  |
     | addr           | iface            | static | time     | tx | rx | drop | tx  | rx  | drop |
     |----------------|------------------|--------|----------|----|----|------|-----|-----|------|
     | 0054.4576.1102 | evpn 2.2.2.2 101 | false  | 00:00:17 | 14 | 15 | 0    | 924 | 954 | 0    |
     | 007b.5b6b.506a | bvi              | false  | 00:00:17 | 15 | 15 | 0    | 954 | 954 | 0    |
    ...
    r1#show bridge 2
     ...
     | addr           | iface            | static | time     | tx | rx | drop | tx  | rx   | drop |
     |----------------|------------------|--------|----------|----|----|------|-----|------|------|
     | 001f.6177.795a | bvi              | false  | 00:00:17 | 14 | 19 | 0    | 932 | 1326 | 0    |
     | 0076.0200.5f0b | evpn 4321::2 101 | false  | 00:00:17 | 15 | 15 | 0    | 998 | 1006 | 0    |
    ...
    r1#show bridge 3
     ...
     | addr           | iface            | static | time     | tx | rx | drop | tx  | rx   | drop |
     |----------------|------------------|--------|----------|----|----|------|-----|------|------|
     | 001a.2516.0201 | bvi              | false  | 00:00:17 | 14 | 19 | 0    | 932 | 1326 | 0    |
     | 005f.423b.1606 | evpn 2.2.2.2 102 | false  | 00:00:17 | 15 | 15 | 0    | 998 | 1006 | 0    |
     |________________|__________________|________|__________|____|____|______|_____|______|______|
    r1#
    r1#
    ```
    ...
    r1#show bridge 4
     ...
     | addr           | iface            | static | time     | tx | rx | drop | tx  | rx  | drop |
     |----------------|------------------|--------|----------|----|----|------|-----|-----|------|
     | 0005.4d51.505a | evpn 4321::2 102 | false  | 00:00:17 | 14 | 15 | 0    | 924 | 954 | 0    |
     | 004a.5e2a.5b4b | bvi              | false  | 00:00:17 | 15 | 15 | 0    | 954 | 954 | 0    |
     |________________|__________________|________|__________|____|____|______|_____|_____|______|
    r1#
    r1#
    ```
