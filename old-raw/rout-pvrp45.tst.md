...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.2.1 | 2       | 3        | 00:00:04 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer    | learned | adverted | uptime   |
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::1 | 2       | 2        | 00:00:04 |
     | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1235::1 | 2       | 3        | 00:00:04 |
     |___________|_________|______|___________|_________|_________|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | C    | 2.2.2.2/32 | 2/0    | loopback1 | null    | 00:00:09 |
    ...
    r2#show ipv6 route v1
     ...
     | P EX | 4321::1/128 | 80/1   | ethernet1 | 1234::1 | 00:00:01 |
