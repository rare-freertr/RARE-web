...
=== "Verification"
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer    | learned | adverted | uptime   |
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | null | null      | 1234::1 | 0       | 0        | 00:00:05 |
     | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1235::1 | 2       | 2        | 00:00:05 |
     |___________|_________|______|___________|_________|_________|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | null | 2.2.2.1/32 | 80/1   | ethernet2 | 1.1.2.1 | 00:00:01 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | null | 4321::1/128 | 80/1   | ethernet2 | 1235::1 | 00:00:01 |
    ...
    r2#show ipv4 route v1
     ...
     | P EX | 2.2.2.1/32 | 80/1   | ethernet2 | 1.1.2.1 | 00:00:01 |
    ...
    r2#show ipv6 route v1
     ...
     | P EX | 4321::1/128 | 80/1   | ethernet2 | 1235::1 | 00:00:01 |
