# Example: rip egress route filtering with routemap
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface ethernet1
     ...
     router rip4 1 route-map-out p4
     router rip6 1 enable
     router rip6 1 route-map-out p6
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 rip 1 dat
     ...
     |-----|-------------|--------|-----------|---------|----------|
     | R   | 1.1.1.0/30  | 1/0    | ethernet1 | null    | 00:00:38 |
     | R   | 2.2.2.1/32  | 120/1  | ethernet1 | 1.1.1.1 | 00:00:07 |
     | R   | 2.2.2.21/32 | 120/1  | ethernet1 | 1.1.1.1 | 00:00:07 |
    ...
    r2#show ipv6 rip 1 dat
     ...
     | typ | prefix       | metric | iface     | hop       | time     |
     |-----|--------------|--------|-----------|-----------|----------|
     | R   | 1234:1::/32  | 1/0    | ethernet1 | null      | 00:00:38 |
     | R   | 4321::1/128  | 120/1  | ethernet1 | 1234:1::1 | 00:00:07 |
     | R   | 4321::21/128 | 120/1  | ethernet1 | 1234:1::1 | 00:00:07 |
    ...
    r2#show ipv4 route v1
     ...
     | R   | 2.2.2.1/32  | 120/1  | ethernet1 | 1.1.1.1 | 00:00:08 |
     | C   | 2.2.2.2/32  | 0/0    | loopback0 | null    | 00:00:39 |
     | C   | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:38 |
     | R   | 2.2.2.21/32 | 120/1  | ethernet1 | 1.1.1.1 | 00:00:08 |
     | C   | 2.2.2.22/32 | 0/0    | loopback2 | null    | 00:00:38 |
     |_____|_____________|________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | R   | 4321::1/128   | 120/1  | ethernet1 | 1234:1::1 | 00:00:08 |
     | C   | 4321::2/128   | 0/0    | loopback0 | null      | 00:00:39 |
     | C   | 4321::12/128  | 0/0    | loopback1 | null      | 00:00:39 |
     | R   | 4321::21/128  | 120/1  | ethernet1 | 1234:1::1 | 00:00:08 |
     | C   | 4321::22/128  | 0/0    | loopback2 | null      | 00:00:39 |
