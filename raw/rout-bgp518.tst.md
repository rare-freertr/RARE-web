# Example: bgp multiple labels

## **Topology diagram**

![topology](/img/rout-bgp518.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 multiple-labels unicast
...
router bgp6 1
 ...
 neighbor 1234:1::2 multiple-labels unicast
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 multiple-labels unicast
 ...
 neighbor 1.1.1.6 multiple-labels unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 multiple-labels unicast
 ...
 neighbor 1234:2::2 multiple-labels unicast
 redistribute connected
 exit
!
!
...
buggy
!
logging file debug ../binTmp/zzz80r4-log.run
!
vrf definition tester
 exit
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 multiple-labels unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 multiple-labels unicast
 redistribute connected
 exit
!
!
