# Example: ospf point2point connection

## **Topology diagram**

![topology](/img/rout-ospf01.tst.png)
...
r2#show ipv6 ospf 1 nei
 ...
 | interface | address | routerid | uptime   |
 |-----------|---------|----------|----------|
 | ethernet1 | 1234::1 | 6.6.6.1  | 00:00:01 |
 |___________|_________|__________|__________|
r2#
r2#
```
...
r2#show ipv4 ospf 1 dat 0
 ...
 | 4.4.4.2  | 0.0.0.0 | 80000002 | asExternal | 16  | 01:00:02 |
...
r2#show ipv6 route v1
 ...
 | O   | 4321::1/128 | 110/0  | ethernet1 | 1234::1 | 00:00:02 |
