...
=== "Verification"
    ...
    r2#show ipv4 olsr 1 dat
     ...
     |-----|-------------|--------|-----------|---------|----------|
     | N   | 1.1.1.0/30  | 1/0    | ethernet1 | null    | 00:00:31 |
    ...
    r2#show ipv6 olsr 1 dat
     ...
     | typ | prefix       | metric | iface     | hop       | time     |
     |-----|--------------|--------|-----------|-----------|----------|
     | N   | 1234:1::/32  | 1/0    | ethernet1 | null      | 00:00:31 |
    ...
    r2#show ipv4 route v1
     ...
     | N   | 2.2.2.21/32 | 140/1  | ethernet1 | 1.1.1.1 | 00:00:02 |
     | C   | 2.2.2.22/32 | 0/0    | loopback2 | null    | 00:00:32 |
     |_____|_____________|________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | N   | 4321::21/128  | 140/1  | ethernet1 | 1234:1::1 | 00:00:02 |
