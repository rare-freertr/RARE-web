# Example: bgp change in bandwidth with soft-reconfig
...
=== "Configuration"
    ...
    **r2:**
    ...
    route-map rm1
     ...
     sequence 10 match bandwidth 4000-6000
     !
    ...
    **r3:**
    ...
    route-map rm1
     ...
     sequence 10 set bandwidth set 1000
     !
     exit
    !
    bridge 1
    ...
    **r4:**
    ...
    route-map rm1
     sequence 10 action deny
     sequence 10 match bandwidth 2000-4000
     !
     sequence 20 action permit
     !
     exit
