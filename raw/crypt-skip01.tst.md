...
r1#show inter tun1 full
tunnel1 is up (since 00:00:01, 1 changes)
 description:
 type is skip, hwaddr=001e.3847.7d21, mtu=1466, bw=2000kbps, vrf=v1
 ip4 address=2.2.2.1/24, netmask=255.255.255.0, ifcid=10012
 ip6 address=4321::1/16, netmask=ffff::, ifcid=10012
 received 23 packets (2374 bytes) dropped 0 packets (0 bytes)
 transmitted 23 packets (2334 bytes) promisc=false macsec=false
 |~~~~~~~|~~~~~~|~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~~~~|~~~~~~|
 | time  | send | receive | drop | send | receive | drop |
 |-------|------|---------|------|------|---------|------|
 | 1sec  | 2334 | 2374    | 0    | 23   | 23      | 0    |
 | 1min  | 0    | 0       | 0    | 0    | 0       | 0    |
 | 1hour | 0    | 0       | 0    | 0    | 0       | 0    |
 ...
 |--------|-------|---------|----|----|------|------|------|------|
 | ethtyp | 0800  | ip4     | 10 | 10 | 0    | 940  | 980  | 0    |
