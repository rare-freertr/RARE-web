...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | etherip to 1.1.1.1 | true | false | 33 | 31 | 0    | 2206 | 2390 | 0    |     |
     |____________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                                | packet         | byte               |
     | addr           | iface              | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|--------------------|----------|----|----|------|------|------|------|
     | 001f.7773.050e | etherip to 1.1.1.1 | 00:00:06 | 29 | 31 | 0    | 1878 | 2018 | 0    |
     | 0044.715b.7142 | bvi                | 00:00:06 | 30 | 33 | 0    | 1988 | 2206 | 0    |
    ...
    bvi1 is up (since 00:00:06, 3 changes)
     description:
     type is bridged, hwaddr=0044.715b.7142, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=893473472
     ip6 address=4321::2/16, netmask=ffff::, ifcid=160017226
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 001f.7773.050e | 2.2.2.1 | 00:00:06 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 001f.7773.050e | 4321::1 | 00:00:06 | false  | false  |
