...
r1#show ipv4 route v1
 ...
 | LOC | 1.1.1.1/32 | 0/1    | ethernet1 | null    | 00:00:22 |
 | C   | 2.2.2.1/32 | 0/0    | loopback0 | null    | 00:00:22 |
 | S   | 2.2.2.2/32 | 1/0    | ethernet1 | 1.1.1.2 | 00:00:22 |
 | C   | 3.3.3.0/30 | 0/0    | bvi1      | null    | 00:00:22 |
 | LOC | 3.3.3.1/32 | 0/1    | bvi1      | null    | 00:00:22 |
 | C   | 4.4.4.0/30 | 0/0    | bvi4      | null    | 00:00:22 |
 | LOC | 4.4.4.1/32 | 0/1    | bvi4      | null    | 00:00:22 |
...
r1#show bridge 1
 ...
 |------------------|---------|----------|------|------|------|
 | bvi              | true    | true     | 0    | 0    | 0    |
 | vpls 2.2.2.2 1:1 | true    | false    | 1346 | 1526 | 0    |
 |__________________|_________|__________|______|______|______|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 | address        | interface        | time     | tx   | rx   | drop |
 |----------------|------------------|----------|------|------|------|
 | 0030.1c04.3b08 | vpls 2.2.2.2 1:1 | 00:00:02 | 1316 | 1346 | 0    |
 | 0060.1d69.6400 | bvi              | 00:00:02 | 1346 | 1796 | 0    |
...
r1#show bridge 2
 ...
 | address        | interface        | time     | tx   | rx   | drop |
 |----------------|------------------|----------|------|------|------|
 | 0036.4a14.2112 | bvi              | 00:00:02 | 1556 | 1998 | 0    |
 | 005a.1d14.5f4c | vpls 4321::2 1:1 | 00:00:02 | 1670 | 1630 | 0    |
 |________________|__________________|__________|______|______|______|
r1#
r1#
```
...
r1#show bridge 3
 ...
 | address        | interface        | time     | tx   | rx   | drop |
 |----------------|------------------|----------|------|------|------|
 | 0025.7e51.3659 | vpls 2.2.2.2 1:2 | 00:00:02 | 1670 | 1630 | 0    |
 | 0032.3d57.5d3c | bvi              | 00:00:02 | 1556 | 1998 | 0    |
 |________________|__________________|__________|______|______|______|
r1#
r1#
```
...
r1#show bridge 4
 ...
 | address        | interface        | time     | tx   | rx   | drop |
 |----------------|------------------|----------|------|------|------|
 | 0011.132f.7458 | bvi              | 00:00:02 | 1346 | 1346 | 0    |
 | 0058.5764.2277 | vpls 4321::2 1:2 | 00:00:02 | 1316 | 1346 | 0    |
 |________________|__________________|__________|______|______|______|
r1#
r1#
```
