# Example: eigrp address unsuppression

## **Topology diagram**

![topology](/img/rout-eigrp25.tst.png)
...
interface loopback2
 ...
 router eigrp4 1 enable
 router eigrp4 1 passive
 router eigrp4 1 unsuppress-prefix
 router eigrp6 1 enable
 router eigrp6 1 passive
 router eigrp6 1 unsuppress-prefix
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv6 eigrp 1 sum
 ...
 | iface     | peer      | learned | adverted | uptime   |
 |-----------|-----------|---------|----------|----------|
 | ethernet1 | 1234:1::1 | 1       | 1        | 00:00:16 |
...
r2#show ipv4 eigrp 1 rou
 ...
 |------|--------------|--------|-----------|---------|----------|
 | C    | 1.1.1.0/30   | 1/0    | ethernet1 | null    | 00:00:17 |
 | null | 2.2.2.2/32   | 90/10  | ethernet1 | 1.1.1.1 | 00:00:17 |
 | C    | 2.2.2.111/32 | 1/0    | loopback1 | null    | 00:00:17 |
...
r2#show ipv6 eigrp 1 rou
 ...
 | null | 4321::2/128   | 90/10  | ethernet1 | 1234:1::1 | 00:00:02 |
 | C    | 4321::111/128 | 1/0    | loopback1 | null      | 00:00:02 |
...
r2#show ipv4 route v1
 ...
 | D   | 2.2.2.2/32   | 90/10  | ethernet1 | 1.1.1.1 | 00:00:17 |
...
r2#show ipv6 route v1
 ...
 | D   | 4321::2/128   | 90/10  | ethernet1 | 1234:1::1 | 00:00:02 |
 | C   | 4321::111/128 | 0/0    | loopback1 | null      | 00:00:18 |
