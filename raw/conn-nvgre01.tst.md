...
r2#show bridge 1
 ...
 |---------------|------|-------|----|----|------|------|------|------|-----|
 | brprt bvi     |      |       |    |    |      |      |      |      |     |
 | nvgre 1.1.1.1 | true | false | 27 | 27 | 0    | 1802 | 2126 | 0    |     |
 |_______________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~|~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                         | packet             | byte               |  |
 | addr           | iface         | static | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|---------------|--------|----------|----|----|------|------|------|------|
 | 0036.113d.6531 | nvgre 1.1.1.1 | false  | 00:00:03 | 24 | 27 | 0    | 1548 | 1802 | 0    |
 | 0058.2227.3940 | bvi           | false  | 00:00:03 | 23 | 27 | 0    | 1518 | 1802 | 0    |
...
bvi1 is up
 description:
 state changed 3 times, last at 2022-05-02 21:12:05, 00:00:03 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is bridged, hwaddr=0058.2227.3940, mtu=1500, bw=8000kbps, vrf=v1
 ipv4 address=2.2.2.2/24, mask=255.255.255.0, ifcid=269955929
 ipv6 address=4321::2/16, mask=ffff::, ifcid=688763682
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0036.113d.6531 | 2.2.2.1 | 00:00:03 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 0036.113d.6531 | 4321::1                  | 00:00:03 | false  | false  |
 | 0036.113d.6531 | fe80::236:11ff:fe3d:6531 | 00:00:04 | false  | true   |
