...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | nvgre 1.1.1.1 | true | false | 28 | 27 | 0    | 1868 | 2118 | 0    |     |
     |_______________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                           | packet         | byte               |
     | addr           | iface         | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|---------------|----------|----|----|------|------|------|------|
     | 0013.173c.4d43 | bvi           | 00:00:05 | 24 | 28 | 0    | 1584 | 1868 | 0    |
     | 0061.5b22.7831 | nvgre 1.1.1.1 | 00:00:05 | 25 | 27 | 0    | 1614 | 1794 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0013.173c.4d43, mtu=1500, bw=8000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=247787907
     ip6 address=4321::2/16, netmask=ffff::, ifcid=615246765
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 0061.5b22.7831 | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|--------------------------|----------|--------|--------|
     | 0061.5b22.7831 | 4321::1                  | 00:00:04 | false  | false  |
     | 0061.5b22.7831 | fe80::261:5bff:fe22:7831 | 00:00:05 | false  | true   |
