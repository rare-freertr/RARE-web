...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | nvgre 1.1.1.1 | true | false | 33 | 31 | 0    | 2206 | 2390 | 0    |     |
     |_______________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~|~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                         | packet             | byte               |  |
     | addr           | iface         | static | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|---------------|--------|----------|----|----|------|------|------|------|
     | 0008.7767.7605 | bvi           | false  | 00:00:05 | 30 | 33 | 0    | 1988 | 2206 | 0    |
     | 001b.5d51.0f33 | nvgre 1.1.1.1 | false  | 00:00:05 | 29 | 31 | 0    | 1878 | 2018 | 0    |
    ...
    bvi1 is up (since 00:00:06, 3 changes)
     description:
     type is bridged, hwaddr=0008.7767.7605, mtu=1500, bw=8000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=1022184208
     ip6 address=4321::2/16, netmask=ffff::, ifcid=330592187
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 001b.5d51.0f33 | 2.2.2.1 | 00:00:05 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 001b.5d51.0f33 | 4321::1 | 00:00:05 | false  | false  |
