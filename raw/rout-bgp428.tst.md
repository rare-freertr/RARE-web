# Example: unicast+linkstate over bgp with additional path

## **Topology diagram**

![topology](/img/rout-bgp428.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 additional-path-rx unicast linkstate
 neighbor 1.1.1.2 additional-path-tx unicast linkstate
...
router bgp6 1
 ...
 neighbor 1234:1::2 additional-path-rx unicast linkstate
 neighbor 1234:1::2 additional-path-tx unicast linkstate
...
router bgp4 1
 ...
 neighbor 1.1.1.1 additional-path-rx unicast linkstate
 neighbor 1.1.1.1 additional-path-tx unicast linkstate
...
router bgp6 1
 ...
 neighbor 1234:1::1 additional-path-rx unicast linkstate
 neighbor 1234:1::1 additional-path-tx unicast linkstate
