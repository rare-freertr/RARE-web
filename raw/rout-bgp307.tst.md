# Example: bgp symmetric compression

## **Topology diagram**

![topology](/img/rout-bgp307.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 compression both
...
router bgp6 1
 ...
 neighbor 1234:1::2 compression both
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 compression both
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 compression both
 redistribute connected
 exit
!
!
