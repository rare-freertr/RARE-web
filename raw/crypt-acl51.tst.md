# Example: ingress source matching hierarchical access list

## **Topology diagram**

![topology](/img/crypt-acl51.tst.png)
...
!
access-list test4a
 sequence 10 permit all 2.2.2.102 255.255.255.255 all any all
 sequence 20 permit all 2.2.2.202 255.255.255.255 all any all
 exit
!
access-list test4b
...
!
access-list test6a
 sequence 10 permit all 4321::102 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff all any all
 sequence 20 permit all 4321::202 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff all any all
 exit
!
access-list test6b
