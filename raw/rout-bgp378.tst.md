# Example: olab over srv6 over bgp additional path
...
=== "Configuration"
    ...
    **r1:**
    ...
    router bgp4 1
     ...
     neighbor 1.1.1.2 additional-path-rx olab
     neighbor 1.1.1.2 additional-path-tx olab
    ...
    router bgp6 1
     ...
     neighbor 1234::2 additional-path-rx olab
     neighbor 1234::2 additional-path-tx olab
    ...
    **r2:**
    ...
    router bgp4 1
     ...
     neighbor 1.1.1.1 additional-path-rx olab
     neighbor 1.1.1.1 additional-path-tx olab
    ...
    router bgp6 1
     ...
     neighbor 1234::1 additional-path-rx olab
     neighbor 1234::1 additional-path-tx olab
