# Example: isis default route

## **Topology diagram**

![topology](/img/rout-isis029.tst.png)
...
router isis4 1
 ...
 traffeng-id ::
 is-type level2
 level2 default-originate
 level1 default-originate
 exit
!
router isis6 1
 vrf v1
...
r2#show ipv6 isis 1 nei
 ...
 | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.12 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234::1    | ::            | up    | 00:00:02 |
 |______________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 | 4444.0000.1111.00-00 | 00000004 | apo   | 41  | 00:19:57 |
 | 4444.0000.2222.00-00 | 00000006 | apo   | 45  | 00:19:57 |
...
r2#show ipv6 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 0000.0000.0000.00-00 | 00000001 | apo   | 10  | 00:19:56 |
 | 6666.0000.1111.00-00 | 00000004 | apo   | 42  | 00:19:57 |
...
r2#show ipv4 route v1
 ...
 |-----|------------|--------|--------------|---------|----------|
 | I   | 0.0.0.0/0  | 115/10 | ethernet1.11 | 1.1.1.1 | 00:00:03 |
 | C   | 1.1.1.0/24 | 0/0    | ethernet1.11 | null    | 00:00:03 |
...
r2#show ipv6 route v1
 ...
 | typ | prefix      | metric | iface        | hop     | time     |
 |-----|-------------|--------|--------------|---------|----------|
 | I   | ::/0        | 115/10 | ethernet1.12 | 1234::1 | 00:00:03 |
 | C   | 1234::/16   | 0/0    | ethernet1.12 | null    | 00:00:03 |
 | LOC | 1234::2/128 | 0/1    | ethernet1.12 | null    | 00:00:03 |
