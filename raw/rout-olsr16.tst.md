# Example: olsr incoming metric with routepolicy

## **Topology diagram**

![topology](/img/rout-olsr16.tst.png)
...
r2#show ipv4 olsr 1 sum
 ...
 |-----------|-------|----------|----------|
 | ethernet1 | 2     | 1.1.1.1  | 00:00:36 |
 | ethernet2 | 2     | 1.1.1.6  | 00:00:41 |
...
r2#show ipv6 olsr 1 sum
 ...
 | interface | learn | neighbor  | uptime   |
 |-----------|-------|-----------|----------|
 | ethernet1 | 2     | 1234:1::1 | 00:00:36 |
 | ethernet2 | 2     | 1234:2::2 | 00:00:41 |
...
r2#show ipv4 olsr 1 dat
 ...
 |-----|--------------|---------|-----------|---------|----------|
 | N   | 1.1.1.0/30   | 1/0     | ethernet1 | null    | 00:00:42 |
 | N   | 1.1.1.4/30   | 1/0     | ethernet2 | null    | 00:00:41 |
 | N   | 2.2.2.1/32   | 140/1   | ethernet1 | 1.1.1.1 | 00:00:11 |
 | N   | 2.2.2.3/32   | 140/201 | ethernet2 | 1.1.1.6 | 00:00:41 |
 | N   | 2.2.2.111/32 | 140/1   | ethernet1 | 1.1.1.1 | 00:00:11 |
...
r2#show ipv6 olsr 1 dat
 ...
 | typ | prefix        | metric  | iface     | hop       | time     |
 |-----|---------------|---------|-----------|-----------|----------|
 | N   | 1234:1::/32   | 1/0     | ethernet1 | null      | 00:00:42 |
 | N   | 1234:2::/32   | 1/0     | ethernet2 | null      | 00:00:42 |
 | N   | 4321::1/128   | 140/1   | ethernet1 | 1234:1::1 | 00:00:11 |
 | N   | 4321::3/128   | 140/201 | ethernet2 | 1234:2::2 | 00:00:41 |
 | N   | 4321::111/128 | 140/1   | ethernet1 | 1234:1::1 | 00:00:11 |
...
r2#show ipv4 route v1
 ...
 | N   | 2.2.2.1/32   | 140/1   | ethernet1 | 1.1.1.1 | 00:00:12 |
 | C   | 2.2.2.2/32   | 0/0     | loopback0 | null    | 00:00:42 |
 | N   | 2.2.2.3/32   | 140/201 | ethernet2 | 1.1.1.6 | 00:00:42 |
 | N   | 2.2.2.111/32 | 140/1   | ethernet1 | 1.1.1.1 | 00:00:12 |
 |_____|______________|_________|___________|_________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | N   | 4321::1/128   | 140/1   | ethernet1 | 1234:1::1 | 00:00:12 |
 | C   | 4321::2/128   | 0/0     | loopback0 | null      | 00:00:42 |
 | N   | 4321::3/128   | 140/201 | ethernet2 | 1234:2::2 | 00:00:42 |
 | N   | 4321::111/128 | 140/1   | ethernet1 | 1234:1::1 | 00:00:12 |
 |_____|_______________|_________|___________|___________|__________|
r2#
r2#
```
