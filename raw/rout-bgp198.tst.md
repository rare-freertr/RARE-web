...
![topology](/img/rout-bgp198.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0046.2526.450a
...
router bgp6 1
 ...
 afi-evpn 101 bmac 002f.7a38.094a
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 006b.1339.0167
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 003d.6a7d.682b
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
