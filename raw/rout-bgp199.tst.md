# Example: unicast+evpn/vxlan over bgp with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp199.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0060.312f.4874
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0004.6d0d.0c12
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0033.3121.4e5c
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0047.5f3f.6602
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
