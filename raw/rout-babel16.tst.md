...
=== "Verification"
    ...
    r2#show ipv4 babel 1 sum
     ...
     |-----------|-------|----------|----------|
     | ethernet1 | 2     | 1.1.1.1  | 00:00:25 |
     | ethernet2 | 2     | 1.1.1.6  | 00:00:45 |
    ...
    r2#show ipv6 babel 1 sum
     ...
     | interface | learn | neighbor  | uptime   |
     |-----------|-------|-----------|----------|
     | ethernet1 | 2     | 1234:1::1 | 00:00:25 |
     | ethernet2 | 2     | 1234:2::2 | 00:00:45 |
    ...
    r2#show ipv4 babel 1 dat
     ...
     |-----|--------------|-----------|-----------|---------|----------|
     | A   | 1.1.1.0/30   | 1/0       | ethernet1 | null    | 00:00:46 |
     | A   | 1.1.1.4/30   | 1/0       | ethernet2 | null    | 00:00:45 |
     | A   | 2.2.2.1/32   | 130/100   | ethernet1 | 1.1.1.1 | 00:00:25 |
     | A   | 2.2.2.3/32   | 130/40100 | ethernet2 | 1.1.1.6 | 00:00:45 |
     | A   | 2.2.2.111/32 | 130/100   | ethernet1 | 1.1.1.1 | 00:00:25 |
    ...
    r2#show ipv6 babel 1 dat
     ...
     | typ | prefix        | metric    | iface     | hop       | time     |
     |-----|---------------|-----------|-----------|-----------|----------|
     | A   | 1234:1::/32   | 1/0       | ethernet1 | null      | 00:00:46 |
     | A   | 1234:2::/32   | 1/0       | ethernet2 | null      | 00:00:46 |
     | A   | 4321::1/128   | 130/100   | ethernet1 | 1234:1::1 | 00:00:25 |
     | A   | 4321::3/128   | 130/40100 | ethernet2 | 1234:2::2 | 00:00:45 |
     | A   | 4321::111/128 | 130/100   | ethernet1 | 1234:1::1 | 00:00:25 |
    ...
    r2#show ipv4 route v1
     ...
     | C   | 1.1.1.4/30   | 0/0       | ethernet2 | null    | 00:00:46 |
     | LOC | 1.1.1.5/32   | 0/1       | ethernet2 | null    | 00:00:46 |
     | A   | 2.2.2.1/32   | 130/100   | ethernet1 | 1.1.1.1 | 00:00:26 |
     | C   | 2.2.2.2/32   | 0/0       | loopback0 | null    | 00:00:46 |
     | A   | 2.2.2.3/32   | 130/40100 | ethernet2 | 1.1.1.6 | 00:00:45 |
     | A   | 2.2.2.111/32 | 130/100   | ethernet1 | 1.1.1.1 | 00:00:26 |
     |_____|______________|___________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | C   | 1234:2::/32   | 0/0       | ethernet2 | null      | 00:00:46 |
     | LOC | 1234:2::1/128 | 0/1       | ethernet2 | null      | 00:00:46 |
     | A   | 4321::1/128   | 130/100   | ethernet1 | 1234:1::1 | 00:00:26 |
     | C   | 4321::2/128   | 0/0       | loopback0 | null      | 00:00:46 |
     | A   | 4321::3/128   | 130/40100 | ethernet2 | 1234:2::2 | 00:00:45 |
     | A   | 4321::111/128 | 130/100   | ethernet1 | 1234:1::1 | 00:00:26 |
     |_____|_______________|___________|___________|___________|__________|
    r2#
    r2#
    ```
