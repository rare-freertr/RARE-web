# Example: olsr address unsuppression

## **Topology diagram**

![topology](/img/rout-olsr28.tst.png)
...
interface loopback1
 ...
 router olsr4 1 enable
 router olsr4 1 unsuppress-prefix
 router olsr6 1 enable
 router olsr6 1 unsuppress-prefix
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv4 olsr 1 dat
 ...
 | N   | 2.2.2.11/32 | 140/1  | ethernet1 | 1.1.1.1 | 00:00:35 |
...
r2#show ipv6 olsr 1 dat
 ...
 | N   | 4321::11/128 | 140/1  | ethernet1 | 1234:1::1 | 00:00:35 |
