...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.11 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:07 |
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 0000000f | apo   | 91  | 00:19:56 |
     | 4444.0000.2222.00-00 | 0000000f | apo   | 111 | 00:19:51 |
     | 4444.0000.3333.00-00 | 0000000e | apo   | 91  | 00:19:55 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.1111.00-00 | 0000000e | apo   | 104 | 00:19:56 |
     | 6666.0000.2222.00-00 | 0000000e | apo   | 126 | 00:19:51 |
     | 6666.0000.3333.00-00 | 0000000d | apo   | 104 | 00:19:55 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | I   | 2.2.2.3/32 | 115/20 | ethernet2.11 | 1.1.1.6 | 00:00:08 |
     | I   | 3.3.3.0/30 | 115/10 | ethernet2.11 | 1.1.1.6 | 00:00:00 |
    ...
    r2#show ipv6 route v1
     ...
     | I EX | 3333::/16     | 115/10 | ethernet1.12 | 1234:1::1 | 00:00:04 |
     | I    | 4321::1/128   | 115/20 | ethernet1.12 | 1234:1::1 | 00:00:08 |
     | C    | 4321::2/128   | 0/0    | loopback2    | null      | 00:00:09 |
     | I    | 4321::3/128   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:08 |
    ...
    r2#show ipv4 segrou v1
     ...
     |------------|-------|--------|---------|
     | 2.2.2.1/32 | 1     | 70489  | 70489   |
     | 2.2.2.3/32 | 3     | 950422 | 950422  |
    ...
    r2#show ipv6 segrou v1
     ...
     | prefix      | index | base    | oldbase |
     |-------------|-------|---------|---------|
     | 4321::1/128 | 1     | 1009034 | 1009034 |
     | 4321::3/128 | 3     | 355204  | 355204  |
