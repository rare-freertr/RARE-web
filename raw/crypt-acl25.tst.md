# Example: ingress destination matching common access list

## **Topology diagram**

![topology](/img/crypt-acl25.tst.png)
...
!
access-list test4
 sequence 10 deny all any all 2.2.2.102 255.255.255.255 all
 sequence 20 deny all any all 2.2.2.202 255.255.255.255 all
 sequence 30 permit all any all any all
 exit
!
access-list test6
 sequence 10 deny all any all 4321::102 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff all
 sequence 20 deny all any all 4321::202 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff all
 sequence 30 permit all any all any all
 exit
!
