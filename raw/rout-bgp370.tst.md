# Example: other over srv6 over bgp route server

## **Topology diagram**

![topology](/img/rout-bgp370.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.3 address-family other
...
router bgp6 1
 ...
 neighbor 1234::3 address-family other
