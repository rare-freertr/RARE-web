...
r1#show ipv4 bgp 1 sum
 ...
 |----|--------|-------|----------|----------|
 | 2  | vpnuni | true  | 2.2.2.2  | 00:00:02 |
...
r1#show ipv4 route v2
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | C   | 9.9.2.1/32 | 0/0    | loopback2 | null    | 00:00:04 |
 | B   | 9.9.2.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:04 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv6 route v2
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | C   | 9992::1/128 | 0/0    | loopback2 | null    | 00:00:09 |
 | B   | 9992::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:09 |
...
r1#show ipv4 route v3
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | C   | 9.9.3.1/32 | 0/0    | loopback3 | null    | 00:00:04 |
 | B   | 9.9.3.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:04 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv6 route v3
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | C   | 9993::1/128 | 0/0    | loopback3 | null    | 00:00:09 |
 | B   | 9993::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:09 |
 |_____|_____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv4 route v4
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | C   | 9.9.4.1/32 | 0/0    | loopback4 | null    | 00:00:03 |
 | B   | 9.9.4.2/32 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:03 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv6 route v4
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | C   | 9994::1/128 | 0/0    | loopback4 | null    | 00:00:09 |
 | B   | 9994::2/128 | 20/0   | null@v1:6 | 4321::2 | 00:00:09 |
 |_____|_____________|________|___________|_________|__________|
r1#
r1#
```
