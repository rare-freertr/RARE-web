...
r1#show ipv4 route v1
 ...
 | LOC | 1.1.1.1/32 | 0/1    | ethernet1 | null    | 00:00:31 |
 | C   | 2.2.2.1/32 | 0/0    | loopback0 | null    | 00:00:31 |
 | S   | 2.2.2.2/32 | 1/0    | ethernet1 | 1.1.1.2 | 00:00:31 |
 | C   | 3.3.3.0/30 | 0/0    | bvi1      | null    | 00:00:31 |
 | LOC | 3.3.3.1/32 | 0/1    | bvi1      | null    | 00:00:31 |
 | C   | 4.4.4.0/30 | 0/0    | bvi4      | null    | 00:00:31 |
 | LOC | 4.4.4.1/32 | 0/1    | bvi4      | null    | 00:00:31 |
...
r1#show bridge 1
 ...
 |------------------------------|---------|----------|------|------|------|
 | bvi                          | true    | true     | 0    | 0    | 0    |
 | pwe 2.2.2.2 2814754062073857 | true    | false    | 1484 | 1208 | 0    |
 |______________________________|_________|__________|______|______|______|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 | address        | interface                    | time     | tx   | rx   | drop |
 |----------------|------------------------------|----------|------|------|------|
 | 001b.243f.2b2f | bvi                          | 00:00:02 | 1064 | 1754 | 0    |
 | 0068.170c.227b | pwe 2.2.2.2 2814754062073857 | 00:00:02 | 1034 | 1064 | 0    |
...
r1#show bridge 2
 ...
 | address        | interface                    | time     | tx   | rx   | drop |
 |----------------|------------------------------|----------|------|------|------|
 | 0012.145f.6a11 | bvi                          | 00:00:01 | 1556 | 1998 | 0    |
 | 0020.0e72.3249 | pwe 4321::2 2814754062073857 | 00:00:01 | 1670 | 1630 | 0    |
 |________________|______________________________|__________|______|______|______|
r1#
r1#
```
...
r1#show bridge 3
 ...
 | address        | interface                    | time     | tx   | rx   | drop |
 |----------------|------------------------------|----------|------|------|------|
 | 0015.320d.5701 | bvi                          | 00:00:02 | 1556 | 1998 | 0    |
 | 0045.3d38.7171 | pwe 2.2.2.2 2814754062073858 | 00:00:02 | 1670 | 1630 | 0    |
 |________________|______________________________|__________|______|______|______|
r1#
r1#
```
...
r1#show bridge 4
 ...
 | address        | interface                    | time     | tx   | rx   | drop |
 |----------------|------------------------------|----------|------|------|------|
 | 0059.2c64.7513 | pwe 4321::2 2814754062073858 | 00:00:03 | 1316 | 1346 | 0    |
 | 0077.6611.5c0c | bvi                          | 00:00:03 | 1346 | 1346 | 0    |
 |________________|______________________________|__________|______|______|______|
r1#
r1#
```
