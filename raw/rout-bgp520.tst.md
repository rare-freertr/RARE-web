# Example: bgp extended nexthop

## **Topology diagram**

![topology](/img/rout-bgp520.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 extended-nexthop-current unicast
...
router bgp6 1
 ...
 neighbor 1234:1::2 extended-nexthop-current unicast
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 extended-nexthop-current unicast
 ...
 neighbor 1.1.1.6 extended-nexthop-current unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 extended-nexthop-current unicast
 ...
 neighbor 1234:2::2 extended-nexthop-current unicast
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 extended-nexthop-current unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 extended-nexthop-current unicast
 redistribute connected
 exit
!
!
