...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | geneve to 1.1.1.1 | true | false | 33 | 31 | 0    | 2206 | 2390 | 0    |     |
     |___________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                               | packet         | byte               |
     | addr           | iface             | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|-------------------|----------|----|----|------|------|------|------|
     | 001b.3f1e.7576 | geneve to 1.1.1.1 | 00:00:07 | 29 | 31 | 0    | 1878 | 2018 | 0    |
     | 0069.6332.4354 | bvi               | 00:00:07 | 30 | 33 | 0    | 1988 | 2206 | 0    |
    ...
    bvi1 is up (since 00:00:07, 3 changes)
     description:
     type is bridged, hwaddr=0069.6332.4354, mtu=1400, bw=4000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=481794966
     ip6 address=4321::2/16, netmask=ffff::, ifcid=687025645
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 001b.3f1e.7576 | 2.2.2.1 | 00:00:06 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 001b.3f1e.7576 | 4321::1 | 00:00:06 | false  | false  |
