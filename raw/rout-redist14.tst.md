# Example: redistribution filtering with hierarchical routemap

## **Topology diagram**

![topology](/img/rout-redist14.tst.png)
...
route-map h4
 ...
 sequence 10 match route-map p4
 !
 exit
!
route-map h6
 sequence 10 action permit
 sequence 10 match route-map p6
 !
 exit
!
route-map p4
...
router isis4 1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-map h4
 redistribute isis4 2 route-map h4
 exit
!
router isis4 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-map h4
 redistribute isis4 1 route-map h4
 exit
!
router isis6 1
 vrf v1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-map h6
 redistribute isis6 2 route-map h6
 exit
!
router isis6 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-map h6
 redistribute isis6 1 route-map h6
 exit
!
interface loopback1
 no description
