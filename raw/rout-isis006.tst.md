...
![topology](/img/rout-isis006.tst.png)
...
r2#show ipv4 isis 1 nei
 ...
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | serial1   | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:10 |
...
r2#show ipv4 isis 1 dat 2
 ...
 | 4444.0000.1111.00-00 | 00000007 | apo   | 45  | 00:19:48 |
 | 4444.0000.2222.00-00 | 00000007 | apo   | 45  | 00:19:49 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 6666.0000.1111.00-00 | 00000005 | apo   | 58  | 00:19:59 |
 | 6666.0000.2222.00-00 | 00000007 | apo   | 58  | 00:19:59 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv4 route v1
 ...
 |-----|------------|--------|-----------|---------|----------|
 | C   | 1.1.1.0/24 | 0/0    | serial1   | null    | 00:00:11 |
 | LOC | 1.1.1.2/32 | 0/1    | serial1   | null    | 00:00:11 |
 | I   | 2.2.2.1/32 | 115/10 | serial1   | 1.1.1.1 | 00:00:10 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix      | metric | iface     | hop     | time     |
 |------|-------------|--------|-----------|---------|----------|
 | C    | 1234::/16   | 0/0    | serial2   | null    | 00:00:11 |
 | LOC  | 1234::2/128 | 0/1    | serial2   | null    | 00:00:11 |
 | I EX | 4321::1/128 | 115/10 | serial2   | 1234::1 | 00:00:00 |
