...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | vxlan to 1.1.1.1 | true | false | 33 | 33 | 0    | 2206 | 2602 | 0    |     |
     |__________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                              | packet         | byte               |
     | addr           | iface            | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|------------------|----------|----|----|------|------|------|------|
     | 001d.7163.627d | vxlan to 1.1.1.1 | 00:00:06 | 30 | 33 | 0    | 1952 | 2206 | 0    |
     | 0027.0d3f.4958 | bvi              | 00:00:06 | 28 | 33 | 0    | 1848 | 2206 | 0    |
    ...
    r2#show inter bvi1 full
    bvi1 is up (since 00:00:07, 3 changes)
     description:
     type is bridged, hwaddr=0027.0d3f.4958, mtu=1400, bw=4000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=917408801
     ip6 address=4321::2/16, netmask=ffff::, ifcid=769835563
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 001d.7163.627d | 2.2.2.1 | 00:00:06 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|--------------------------|----------|--------|--------|
     | 001d.7163.627d | 4321::1                  | 00:00:06 | false  | false  |
     | 001d.7163.627d | fe80::21d:71ff:fe63:627d | 00:00:06 | false  | false  |
