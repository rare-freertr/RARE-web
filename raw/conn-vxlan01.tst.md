...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     |------------------|------|-------|----|----|------|------|------|------|-----|
     | brprt bvi        |      |       |    |    |      |      |      |      |     |
     | vxlan to 1.1.1.1 | true | false | 32 | 30 | 0    | 2140 | 2312 | 0    |     |
     ...
     |----------------|------------------|--------|----------|----|----|------|------|------|------|
     | 006f.3730.7248 | vxlan to 1.1.1.1 | false  | 00:00:06 | 28 | 30 | 0    | 1812 | 1952 | 0    |
     | 0074.3072.7b68 | bvi              | false  | 00:00:06 | 29 | 32 | 0    | 1922 | 2140 | 0    |
    ...
    bvi1 is up (since 00:00:06, 3 changes)
     description:
     type is bridged, hwaddr=0074.3072.7b68, mtu=1400, bw=4000kbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=666544033
     ip6 address=4321::2/16, netmask=ffff::, ifcid=175357542
     received 30 packets (1952 bytes) dropped 0 packets (0 bytes)
     transmitted 32 packets (2140 bytes) promisc=false macsec=false sgt=false
     |~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
     |       | packet         | byte             |
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 006f.3730.7248 | 2.2.2.1 | 00:00:05 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|---------|----------|--------|--------|
     | 006f.3730.7248 | 4321::1 | 00:00:05 | false  | false  |
