...
r2#show bridge 1
 ...
 |------------------|------|-------|----|----|------|------|------|------|-----|
 | brprt bvi        |      |       |    |    |      |      |      |      |     |
 | vxlan to 1.1.1.1 | true | false | 33 | 31 | 0    | 2206 | 2390 | 0    |     |
 ...
 |----------------|------------------|--------|----------|----|----|------|------|------|------|
 | 004d.097d.0c33 | vxlan to 1.1.1.1 | false  | 00:00:06 | 29 | 31 | 0    | 1878 | 2018 | 0    |
 | 005c.0367.5657 | bvi              | false  | 00:00:06 | 30 | 33 | 0    | 1988 | 2206 | 0    |
...
bvi1 is up
 description:
 state changed 3 times, last at 2022-05-02 21:13:19, 00:00:06 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is bridged, hwaddr=005c.0367.5657, mtu=1400, bw=4000kbps, vrf=v1
 ipv4 address=2.2.2.2/24, mask=255.255.255.0, ifcid=771124483
 ipv6 address=4321::2/16, mask=ffff::, ifcid=188100358
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 004d.097d.0c33 | 2.2.2.1 | 00:00:05 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|---------|----------|--------|--------|
 | 004d.097d.0c33 | 4321::1 | 00:00:05 | false  | false  |
