# Example: bgp triangle connection

## **Topology diagram**

![topology](/img/rout-bgp223.tst.png)
...
router bgp6 1
 ...
 neighbor 1234:3::1 distance 123
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.10 distance 123
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::2 distance 123
 redistribute connected
 exit
!
!
