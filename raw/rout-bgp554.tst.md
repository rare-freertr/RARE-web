# Example: ibgp rr vpns prefix movement

## **Topology diagram**

![topology](/img/rout-bgp554.tst.png)
...
router bgp4 1
 ...
 afi-vrf v3 redistribute connected
 afi-vrf v4 enable
 afi-vrf v4 advertise 9.9.4.3/32 route-map rm1
 afi-vrf v4 advertise 9.9.4.222/32 route-map rm1
 exit
!
router bgp6 1
 ...
 afi-vrf v3 redistribute connected
 afi-vrf v4 enable
 afi-vrf v4 advertise 9994::3/128 route-map rm1
 afi-vrf v4 advertise 9994::222/128 route-map rm1
 exit
!
!
