# Example: bgp interas othervpn with asbr peering

## **Topology diagram**

![topology](/img/rout-bgp333.tst.png)
...
router bgp4 1
 ...
 afi-ovrf v2 enable
 afi-ovrf v2 redistribute connected
 afi-ovrf v2 redistribute bgp4 2
 exit
!
router bgp4 2
 vrf v1
 ...
 neighbor 1.1.1.10 address-family vpnuni ovpnuni
 ...
 afi-ovrf v2 enable
 afi-ovrf v2 redistribute connected
 afi-ovrf v2 redistribute bgp4 1
 exit
!
router bgp6 1
 vrf v1
...
router bgp6 2
 ...
 neighbor 1234:3::2 address-family vpnuni ovpnuni
...
router bgp4 1
 ...
 neighbor 1.1.1.9 address-family vpnuni ovpnuni
...
router bgp6 1
 ...
 neighbor 1234:3::1 address-family vpnuni ovpnuni
...
buggy
!
logging file debug ../binTmp/zzz17r6-log.run
!
vrf definition tester
 exit
!
