...
![topology](/img/rout-redist13.tst.png)
...
router isis4 1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-map p4
 redistribute isis4 2 route-map p4
 exit
!
router isis4 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-map p4
 redistribute isis4 1 route-map p4
 exit
!
router isis6 1
 vrf v1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-map p6
 redistribute isis6 2 route-map p6
 exit
!
router isis6 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-map p6
 redistribute isis6 1 route-map p6
 exit
!
interface loopback1
 vrf forwarding v1
