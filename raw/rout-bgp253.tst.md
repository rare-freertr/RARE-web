# Example: othervpns over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp253.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 additional-path-rx ovpnuni
 neighbor 2.2.2.2 additional-path-tx ovpnuni
...
router bgp6 1
 ...
 neighbor 4321::2 additional-path-rx ovpnuni
 neighbor 4321::2 additional-path-tx ovpnuni
...
router bgp4 1
 ...
 neighbor 2.2.2.1 additional-path-rx ovpnuni
 neighbor 2.2.2.1 additional-path-tx ovpnuni
...
router bgp6 1
 ...
 neighbor 4321::1 additional-path-rx ovpnuni
 neighbor 4321::1 additional-path-tx ovpnuni
