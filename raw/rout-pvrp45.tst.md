# Example: pvrp dynamic icmp metric
...
=== "Configuration"
    ...
    **r2:**
    ...
    interface ethernet1
     ...
     router pvrp4 1 enable
     router pvrp4 1 dynamic-metric icmpecho
     router pvrp4 1 metric-in 2
     router pvrp6 1 enable
     router pvrp6 1 dynamic-metric icmpecho
...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 2        | 00:00:05 |
     | ethernet2 | 4.4.4.1 | null | null      | 1.1.2.1 | 0       | 0        | 00:00:05 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | null | 2.2.2.1/32 | 80/2   | ethernet1 | 1.1.1.1 | 00:00:01 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | null | 4321::1/128 | 80/1   | ethernet1 | 1234::1 | 00:00:01 |
    ...
    r2#show ipv4 route v1
     ...
     | P EX | 2.2.2.1/32 | 80/2   | ethernet1 | 1.1.1.1 | 00:00:01 |
    ...
    r2#show ipv6 route v1
     ...
     | P EX | 4321::1/128 | 80/1   | ethernet1 | 1234::1 | 00:00:02 |
