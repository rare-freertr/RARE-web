...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet2.11 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.5    | ::            | up    | 00:00:07 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet2.12 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234:2::1  | ::            | up    | 00:00:07 |
     |______________|________________|_______|________________|____________|_______________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | LOC | 1.1.1.6/32 | 0/1     | ethernet2.11 | null    | 00:00:18 |
    ...
    r2#show ipv6 route v1
     ...
     | LOC  | 1234:2::2/128 | 0/1     | ethernet2.12 | null      | 00:00:18 |
