...
![topology](/img/conn-dlsw01.tst.png)
...
r2#show bridge 1
 ...
 | dlsw to 1.1.1.1 | true | false | 33 | 33 | 0    | 2206 | 2602 | 0    |     |
 |_________________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                             | packet         | byte               |
 | addr           | iface           | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|-----------------|----------|----|----|------|------|------|------|
 | 0022.485a.3564 | bvi             | 00:00:05 | 28 | 33 | 0    | 1848 | 2206 | 0    |
 | 0025.7d35.331a | dlsw to 1.1.1.1 | 00:00:05 | 30 | 33 | 0    | 1952 | 2206 | 0    |
 |________________|_________________|__________|____|____|______|______|______|______|
r2#
r2#
```
...
bvi1 is up (since 00:00:05, 1 changes)
 description:
 type is bridged, hwaddr=0022.485a.3564, mtu=1400, bw=10mbps, vrf=v1
 ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=178193680
 ip6 address=4321::2/16, netmask=ffff::, ifcid=584468805
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0025.7d35.331a | 2.2.2.1 | 00:00:04 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 0025.7d35.331a | 4321::1                  | 00:00:04 | false  | false  |
 | 0025.7d35.331a | fe80::225:7dff:fe35:331a | 00:00:04 | false  | false  |
