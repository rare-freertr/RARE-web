...
r2#show bridge 1
 ...
 | etherip to 1.1.1.1 | true | false | 27 | 27 | 0    | 1802 | 2126 | 0    |     |
 |____________________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                                | packet         | byte               |
 | addr           | iface              | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|--------------------|----------|----|----|------|------|------|------|
 | 0022.4211.0056 | bvi                | 00:00:03 | 23 | 27 | 0    | 1518 | 1802 | 0    |
 | 0050.6775.4422 | etherip to 1.1.1.1 | 00:00:03 | 24 | 27 | 0    | 1548 | 1802 | 0    |
 |________________|____________________|__________|____|____|______|______|______|______|
r2#
r2#
```
...
bvi1 is up (since 00:00:03, 1 changes)
 description:
 type is bridged, hwaddr=0022.4211.0056, mtu=1400, bw=10mbps, vrf=v1
 ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=211344828
 ip6 address=4321::2/16, netmask=ffff::, ifcid=785529401
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0050.6775.4422 | 2.2.2.1 | 00:00:03 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 0050.6775.4422 | 4321::1                  | 00:00:03 | false  | false  |
 | 0050.6775.4422 | fe80::250:67ff:fe75:4422 | 00:00:03 | false  | true   |
