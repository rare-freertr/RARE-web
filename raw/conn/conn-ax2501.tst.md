...
dialer1 is up (since 00:00:01, 2 changes)
 description:
 type is dialer, hwaddr=none, mtu=1396, bw=10mbps, vrf=v1
 ip4 address=2.2.2.1/24, netmask=255.255.255.0, ifcid=110928513
 ip6 address=4321::1/16, netmask=ffff::, ifcid=773591224
 received 20 packets (1320 bytes) dropped 8 packets (560 bytes)
