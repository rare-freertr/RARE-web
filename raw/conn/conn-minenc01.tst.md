...
![topology](/img/conn-minenc01.tst.png)
...
tunnel1 is up (since 00:00:01, 1 changes)
 description:
 type is minenc, hwaddr=none, mtu=65515, bw=1000mbps, vrf=v1
 ip4 address=2.2.2.1/24, netmask=255.255.255.0, ifcid=268542822
 ip6 address=4321::1/16, netmask=ffff::, ifcid=303956844
