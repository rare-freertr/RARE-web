...
![topology](/img/conn-sreth01.tst.png)
...
r2#show bridge 1
 ...
 | sreth to 1.1.1.1 | true | false | 33 | 33 | 0    | 2206 | 2602 | 0    |     |
 |__________________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                              | packet         | byte               |
 | addr           | iface            | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|------------------|----------|----|----|------|------|------|------|
 | 0054.0131.5220 | bvi              | 00:00:05 | 28 | 33 | 0    | 1848 | 2206 | 0    |
 | 0069.2b28.565b | sreth to 1.1.1.1 | 00:00:05 | 30 | 33 | 0    | 1952 | 2206 | 0    |
...
bvi1 is up (since 00:00:05, 1 changes)
 description:
 type is bridged, hwaddr=0054.0131.5220, mtu=1400, bw=10mbps, vrf=v1
 ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=468018307
 ip6 address=4321::2/16, netmask=ffff::, ifcid=615946463
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0069.2b28.565b | 2.2.2.1 | 00:00:04 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 0069.2b28.565b | 4321::1                  | 00:00:04 | false  | false  |
 | 0069.2b28.565b | fe80::269:2bff:fe28:565b | 00:00:04 | false  | false  |
