# Example: pipe over ipv4

## **Topology diagram**

![topology](/img/conn-pipe01.tst.png)
...
r1#show inter tun1 full
tunnel1 is up (since 00:00:02, 1 changes)
 description:
 type is pipe, hwaddr=none, mtu=65507, bw=1000mbps, vrf=v1
 ip4 address=2.2.2.1/24, netmask=255.255.255.0, ifcid=658565936
 ip6 address=4321::1/16, netmask=ffff::, ifcid=953660577
