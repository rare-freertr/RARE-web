...
r2#show bridge 1
 ...
 | erspan to 1.1.1.1 | true | false | 27 | 27 | 0    | 1802 | 2126 | 0    |     |
 |___________________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                               | packet         | byte               |
 | addr           | iface             | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|-------------------|----------|----|----|------|------|------|------|
 | 0049.063d.2b1e | bvi               | 00:00:03 | 23 | 27 | 0    | 1518 | 1802 | 0    |
 | 005c.0c16.4b71 | erspan to 1.1.1.1 | 00:00:03 | 24 | 27 | 0    | 1548 | 1802 | 0    |
...
bvi1 is up (since 00:00:03, 1 changes)
 description:
 type is bridged, hwaddr=0049.063d.2b1e, mtu=1400, bw=10mbps, vrf=v1
 ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=669044867
 ip6 address=4321::2/16, netmask=ffff::, ifcid=37595293
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 005c.0c16.4b71 | 2.2.2.1 | 00:00:03 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|-------------------------|----------|--------|--------|
 | 005c.0c16.4b71 | 4321::1                 | 00:00:03 | false  | false  |
 | 005c.0c16.4b71 | fe80::25c:cff:fe16:4b71 | 00:00:03 | false  | true   |
