...
![topology](/img/conn-nvgre01.tst.png)
...
r2#show bridge 1
 ...
 | nvgre 1.1.1.1 | true | false | 33 | 33 | 0    | 2206 | 2602 | 0    |     |
 |_______________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                           | packet         | byte               |
 | addr           | iface         | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|---------------|----------|----|----|------|------|------|------|
 | 0024.1904.332e | bvi           | 00:00:05 | 28 | 33 | 0    | 1848 | 2206 | 0    |
 | 004f.5b54.6a3c | nvgre 1.1.1.1 | 00:00:05 | 30 | 33 | 0    | 1952 | 2206 | 0    |
 |________________|_______________|__________|____|____|______|______|______|______|
r2#
r2#
```
...
bvi1 is up (since 00:00:05, 1 changes)
 description:
 type is bridged, hwaddr=0024.1904.332e, mtu=1500, bw=8000kbps, vrf=v1
 ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=467447181
 ip6 address=4321::2/16, netmask=ffff::, ifcid=206199872
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 004f.5b54.6a3c | 2.2.2.1 | 00:00:04 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 004f.5b54.6a3c | 4321::1                  | 00:00:04 | false  | false  |
 | 004f.5b54.6a3c | fe80::24f:5bff:fe54:6a3c | 00:00:04 | false  | false  |
