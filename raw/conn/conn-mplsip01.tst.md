# Example: mplsip over ipv4

## **Topology diagram**

![topology](/img/conn-mplsip01.tst.png)
...
tunnel1 is up (since 00:00:07, 1 changes)
 description:
 type is mplsip, hwaddr=002d.5114.7d71, mtu=1478, bw=2000kbps, vrf=v1
 ip4 address=2.2.2.1/24, netmask=255.255.255.0, ifcid=144125162
 ip6 address=4321::1/16, netmask=ffff::, ifcid=129245372
