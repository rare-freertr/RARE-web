...
![topology](/img/conn-eth01.tst.png)
...
r1#show inter eth1 full
ethernet1 is up (since 00:00:03, 1 changes)
 description:
 type is ethernet, hwaddr=0000.0000.1111, mtu=1500, bw=100mbps, vrf=v1
 ip4 address=1.1.1.1/24, netmask=255.255.255.0, ifcid=349412103
 ip6 address=1234::1/16, netmask=ffff::, ifcid=347532102
