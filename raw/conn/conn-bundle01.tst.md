...
![topology](/img/conn-bundle01.tst.png)
...
r1#show inter bun1 full
bundle1 is up (since 00:00:02, 2 changes)
 description:
 type is bundle, hwaddr=0025.6219.6006, mtu=1500, bw=100mbps, vrf=v1
 ip4 address=1.1.1.1/24, netmask=255.255.255.0, ifcid=563546400
 ip6 address=1234::1/16, netmask=ffff::, ifcid=166937547
