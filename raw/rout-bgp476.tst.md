# Example: othervpns egress route filtering with routepolicy with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp476.tst.png)
...
route-policy p4
 ...
 sequence 20   drop
 sequence 30 enif
 sequence 40 if network 9.9.3.11/32 ge 32 le 32
 sequence 50   drop
 sequence 60 enif
 sequence 70 if network 9.9.4.11/32 ge 32 le 32
 sequence 80   drop
 sequence 90 enif
...
!
route-policy p6
 sequence 10 if network 9992::11/128 ge 128 le 128
 sequence 20   drop
 sequence 30 enif
 sequence 40 if network 9993::11/128 ge 128 le 128
 sequence 50   drop
 sequence 60 enif
 sequence 70 if network 9994::11/128 ge 128 le 128
 sequence 80   drop
 sequence 90 enif
...
router bgp4 1
 ...
 neighbor 2.2.2.2 ovpn-route-policy-out p6
 afi-ovrf v2 enable
...
router bgp6 1
 ...
 neighbor 4321::2 ovpn-route-policy-out p4
 afi-ovrf v2 enable
 afi-ovrf v2 redistribute connected
 afi-ovrf v3 enable
 afi-ovrf v3 redistribute connected
