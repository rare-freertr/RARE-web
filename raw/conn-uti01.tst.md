...
r2#show bridge 1
 ...
 |----------------|------|-------|----|----|------|------|------|------|-----|
 | brprt bvi      |      |       |    |    |      |      |      |      |     |
 | uti to 1.1.1.1 | true | false | 32 | 30 | 0    | 2140 | 2312 | 0    |     |
 |________________|______|_______|____|____|______|______|______|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~|~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 |                                          | packet             | byte               |  |
 | addr           | iface          | static | time     | tx | rx | drop | tx   | rx   | drop |
 |----------------|----------------|--------|----------|----|----|------|------|------|------|
 | 000a.1e0b.1c63 | uti to 1.1.1.1 | false  | 00:00:06 | 28 | 30 | 0    | 1812 | 1952 | 0    |
 | 007d.564d.410c | bvi            | false  | 00:00:06 | 29 | 32 | 0    | 1922 | 2140 | 0    |
...
bvi1 is up
 description:
 state changed 3 times, last at 2022-05-02 21:12:30, 00:00:06 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is bridged, hwaddr=007d.564d.410c, mtu=1400, bw=10.0mbps, vrf=v1
 ipv4 address=2.2.2.2/24, mask=255.255.255.0, ifcid=1005664064
 ipv6 address=4321::2/16, mask=ffff::, ifcid=823839172
 received 30 packets (1952 bytes) dropped 0 packets (0 bytes)
 transmitted 32 packets (2140 bytes) macsec=false sgt=false
 |~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
 |       | packet         | byte             |
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 000a.1e0b.1c63 | 2.2.2.1 | 00:00:06 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|---------|----------|--------|--------|
 | 000a.1e0b.1c63 | 4321::1 | 00:00:06 | false  | false  |
