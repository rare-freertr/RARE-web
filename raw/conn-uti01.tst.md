...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | uti to 1.1.1.1 | true | false | 28 | 27 | 0    | 1868 | 2118 | 0    |     |
     |________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                            | packet         | byte               |
     | addr           | iface          | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|----------------|----------|----|----|------|------|------|------|
     | 0021.103d.7733 | bvi            | 00:00:05 | 24 | 28 | 0    | 1584 | 1868 | 0    |
     | 0057.1041.257d | uti to 1.1.1.1 | 00:00:05 | 25 | 27 | 0    | 1614 | 1794 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0021.103d.7733, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=678599504
     ip6 address=4321::2/16, netmask=ffff::, ifcid=385227595
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 0057.1041.257d | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|--------------------------|----------|--------|--------|
     | 0057.1041.257d | 4321::1                  | 00:00:04 | false  | false  |
     | 0057.1041.257d | fe80::257:10ff:fe41:257d | 00:00:05 | false  | true   |
