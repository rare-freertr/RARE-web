...
=== "Verification"
    ...
    r1#show ipv4 rsvp v1 sum
     ...
     |---------|------|----------|----|---------|------------|-------------|
     | 9.9.9.1 | 2863 | ::       | 0  | 9.9.9.2 | 2140553854 | r1:automesh |
     | 9.9.9.2 | 5397 | ::       | 0  | 9.9.9.1 | 1958901758 | r2:automesh |
    ...
    r1#show ipv6 rsvp v1 sum
     ...
     | source  | id    | subgroup | id | target  | id        | description |
     |---------|-------|----------|----|---------|-----------|-------------|
     | 9999::1 | 18186 | ::       | 0  | 9999::2 | 167362128 | r1:automesh |
     | 9999::2 | 24896 | ::       | 0  | 9999::1 | 641062966 | r2:automesh |
    ...
    r1#show ipv6 route v1
     ...
     | B   | 4321::2/128 | 20/0   | serial1   | 9999::2 | 00:00:09 |
     | C   | 9999::/16   | 0/0    | serial1   | null    | 00:00:10 |
     | LOC | 9999::1/128 | 0/1    | serial1   | null    | 00:00:10 |
