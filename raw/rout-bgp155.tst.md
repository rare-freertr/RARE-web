...
r1#show ipv4 rsvp v1 sum
 ...
 |---------|-------|----------|----|---------|------------|-------------|
 | 9.9.9.2 | 7137  | ::       | 0  | 9.9.9.1 | 1040848877 | r2:automesh |
 | 9.9.9.1 | 17244 | ::       | 0  | 9.9.9.2 | 1313001372 | r1:automesh |
...
r1#show ipv6 rsvp v1 sum
 ...
 | source  | id    | subgroup | id | target  | id         | description |
 |---------|-------|----------|----|---------|------------|-------------|
 | 9999::1 | 7658  | ::       | 0  | 9999::2 | 625268254  | r1:automesh |
 | 9999::2 | 20064 | ::       | 0  | 9999::1 | 1499760455 | r2:automesh |
 |_________|_______|__________|____|_________|____________|_____________|
r1#
r1#
```
