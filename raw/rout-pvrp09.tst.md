# Example: pvrp outgoing routepolicy metric
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface ethernet1
     ...
     router pvrp4 1 enable
     router pvrp4 1 route-policy-out rm1
     router pvrp6 1 enable
     router pvrp6 1 route-policy-out rm1
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 4        | 00:00:12 |
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.1.6 | 2       | 3        | 00:00:12 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 2       | 4        | 00:00:13 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1234:2::2 | 2       | 3        | 00:00:13 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     |------|--------------|--------|-----------|---------|----------|
     | C    | 1.1.1.0/30   | 1/0    | ethernet1 | null    | 00:00:07 |
     | C    | 1.1.1.4/30   | 1/0    | ethernet2 | null    | 00:00:07 |
     | null | 2.2.2.1/32   | 80/110 | ethernet1 | 1.1.1.1 | 00:00:07 |
     | C    | 2.2.2.2/32   | 2/0    | loopback1 | null    | 00:00:18 |
     | null | 2.2.2.3/32   | 80/10  | ethernet2 | 1.1.1.6 | 00:00:08 |
     | null | 2.2.2.111/32 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:08 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | C    | 1234:2::/32   | 1/0    | ethernet2 | null      | 00:00:07 |
     | null | 4321::1/128   | 80/110 | ethernet1 | 1234:1::1 | 00:00:07 |
     | C    | 4321::2/128   | 2/0    | loopback1 | null      | 00:00:18 |
     | null | 4321::3/128   | 80/10  | ethernet2 | 1234:2::2 | 00:00:08 |
     | null | 4321::111/128 | 80/10  | ethernet2 | 1234:2::2 | 00:00:08 |
    ...
    r2#show ipv4 route v1
     ...
     | P   | 2.2.2.1/32   | 80/110 | ethernet1 | 1.1.1.1 | 00:00:07 |
     | C   | 2.2.2.2/32   | 0/0    | loopback1 | null    | 00:00:18 |
     | P   | 2.2.2.3/32   | 80/10  | ethernet2 | 1.1.1.6 | 00:00:09 |
     | P   | 2.2.2.111/32 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:09 |
    ...
    r2#show ipv6 route v1
     ...
     | P   | 4321::1/128   | 80/110 | ethernet1 | 1234:1::1 | 00:00:07 |
     | C   | 4321::2/128   | 0/0    | loopback1 | null      | 00:00:18 |
     | P   | 4321::3/128   | 80/10  | ethernet2 | 1234:2::2 | 00:00:09 |
     | P   | 4321::111/128 | 80/10  | ethernet2 | 1234:2::2 | 00:00:09 |
