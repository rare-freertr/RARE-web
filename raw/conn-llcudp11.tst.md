# Example: ethernet tunneling with llcudp

## **Topology diagram**

![topology](/img/conn-llcudp11.tst.png)
...
!
interface ethernet1
 xconnect v1 ethernet2 llcudp 1234::2 1234
 no shutdown
 no log-link-change
 exit
!
...
!
interface ethernet2
 xconnect v1 ethernet1 llcudp 1234::1 1234
 no shutdown
 no log-link-change
 exit
!
