# Example: p4lang: evpn/cmac with bgp

## **Topology diagram**

![topology](/img/p4lang-rout09.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0050.2401.4f68
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 001d.2520.0761
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 neighbor 2.2.2.101 send-community standard extended
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0070.0b3e.666e
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source loopback0
 exit
!
