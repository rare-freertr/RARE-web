# Example: evpn/vxlan over ibgp rr

## **Topology diagram**

![topology](/img/rout-bgp192.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 003d.690d.536a
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0072.6a15.620d
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 neighbor 1.1.1.3 send-community standard extended
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0002.6845.4670
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::3 send-community standard extended
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 005c.5b3e.2c19
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
