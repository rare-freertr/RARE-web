# Example: bgp vpn with export policy

## **Topology diagram**

![topology](/img/rout-bgp345.tst.png)
...
!
route-policy rp4
 sequence 10 if network 3.3.3.0/24 ge 32 le 32
 sequence 20   pass
 sequence 30 enif
 exit
!
route-policy rp6
 sequence 10 if network 3333::/64 ge 128 le 128
 sequence 20   pass
 sequence 30 enif
 exit
!
