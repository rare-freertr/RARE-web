# Example: evpn/cmac over ibgp

## **Topology diagram**

![topology](/img/rout-bgp204.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 002c.4306.4108
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0032.0476.672f
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0008.6217.2215
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0000.4742.787c
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source loopback0
 exit
!
