# Example: unicast+othervpns over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp262.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 address-family unicast ovpnuni
 neighbor 2.2.2.2 distance 20
 neighbor 2.2.2.2 additional-path-rx unicast ovpnuni
 neighbor 2.2.2.2 additional-path-tx unicast ovpnuni
...
router bgp6 1
 ...
 neighbor 4321::2 address-family unicast ovpnuni
 neighbor 4321::2 distance 20
 neighbor 4321::2 additional-path-rx unicast ovpnuni
 neighbor 4321::2 additional-path-tx unicast ovpnuni
...
router bgp4 1
 ...
 neighbor 2.2.2.1 address-family unicast ovpnuni
 neighbor 2.2.2.1 distance 20
 neighbor 2.2.2.1 additional-path-rx unicast ovpnuni
 neighbor 2.2.2.1 additional-path-tx unicast ovpnuni
...
router bgp6 1
 ...
 neighbor 4321::1 address-family unicast ovpnuni
 neighbor 4321::1 distance 20
 neighbor 4321::1 additional-path-rx unicast ovpnuni
 neighbor 4321::1 additional-path-tx unicast ovpnuni
