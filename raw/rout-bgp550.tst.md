# Example: ouni ibgp rr prefix movement

## **Topology diagram**

![topology](/img/rout-bgp550.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 address-family ouni
 neighbor 1.1.1.2 distance 200
 neighbor 1.1.1.2 route-reflector-client
 neighbor 1.1.1.3 remote-as 1
 neighbor 1.1.1.3 local-as 1
 neighbor 1.1.1.3 address-family ouni
 ...
 neighbor 1.1.1.4 address-family ouni
...
router bgp6 1
 ...
 neighbor 1234:1::2 address-family ouni
 ...
 neighbor 1234:1::3 address-family ouni
 ...
 neighbor 1234:1::4 address-family ouni
...
router bgp4 1
 ...
 neighbor 1.1.1.1 address-family ouni
 neighbor 1.1.1.1 distance 200
 afi-other enable
 no afi-other vpn-mode
 afi-other advertise 4321::2/128 route-map rm1
...
router bgp6 1
 ...
 neighbor 1234:1::1 address-family ouni
 neighbor 1234:1::1 distance 200
 afi-other enable
 no afi-other vpn-mode
 afi-other advertise 2.2.2.2/32 route-map rm1
 afi-other advertise 2.2.2.222/32 route-map rm1
 exit
!
!
!
...
router bgp6 1
 ...
 afi-other enable
 no afi-other vpn-mode
 afi-other advertise 2.2.2.3/32 route-map rm1
 afi-other advertise 2.2.2.222/32 route-map rm1
 exit
!
!
