# Example: unicast+vpns over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp152.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 address-family unicast vpnuni
 neighbor 2.2.2.2 distance 20
 neighbor 2.2.2.2 additional-path-rx unicast vpnuni
 neighbor 2.2.2.2 additional-path-tx unicast vpnuni
...
router bgp6 1
 ...
 neighbor 4321::2 address-family unicast vpnuni
 neighbor 4321::2 distance 20
 neighbor 4321::2 additional-path-rx unicast vpnuni
 neighbor 4321::2 additional-path-tx unicast vpnuni
...
router bgp4 1
 ...
 neighbor 2.2.2.1 address-family unicast vpnuni
 neighbor 2.2.2.1 distance 20
 neighbor 2.2.2.1 additional-path-rx unicast vpnuni
 neighbor 2.2.2.1 additional-path-tx unicast vpnuni
...
router bgp6 1
 ...
 neighbor 4321::1 address-family unicast vpnuni
 neighbor 4321::1 distance 20
 neighbor 4321::1 additional-path-rx unicast vpnuni
 neighbor 4321::1 additional-path-tx unicast vpnuni
