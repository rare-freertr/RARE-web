# Example: vpns egress route filtering with routemap with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp464.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 vpn-route-map-out p4
 afi-vrf v2 enable
...
router bgp6 1
 ...
 neighbor 4321::2 vpn-route-map-out p6
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v3 enable
 afi-vrf v3 redistribute connected
