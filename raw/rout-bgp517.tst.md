# Example: bgp extended update

## **Topology diagram**

![topology](/img/rout-bgp517.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 extended-update
...
router bgp6 1
 ...
 neighbor 1234:1::2 extended-update
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 extended-update
 ...
 neighbor 1.1.1.6 extended-update
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 extended-update
 ...
 neighbor 1234:2::2 extended-update
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 extended-update
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 extended-update
 redistribute connected
 exit
!
!
