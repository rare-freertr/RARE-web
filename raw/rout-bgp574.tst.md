# Example: vpls/ldp cw over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp574.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 additional-path-rx vpls
 neighbor 2.2.2.2 additional-path-tx vpls
...
router bgp6 1
 ...
 neighbor 4321::2 additional-path-rx vpls
 neighbor 4321::2 additional-path-tx vpls
...
router bgp4 1
 ...
 neighbor 2.2.2.1 additional-path-rx vpls
 neighbor 2.2.2.1 additional-path-tx vpls
...
router bgp6 1
 ...
 neighbor 4321::1 additional-path-rx vpls
 neighbor 4321::1 additional-path-tx vpls
