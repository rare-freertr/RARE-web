# Example: multisite vpls/bgp over ibgp rr

## **Topology diagram**

![topology](/img/rout-bgp165.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.4 address-family vpls
...
router bgp6 1
 ...
 neighbor 1234:1::4 address-family vpls
...
router bgp4 1
 ...
 neighbor 1.1.1.4 send-community standard extended
 afi-vpls 1:1 bridge-group 1
 afi-vpls 1:1 ve-id 3 10
 afi-vpls 1:1 update-source loopback0
 afi-vpls 1:2 bridge-group 3
 afi-vpls 1:2 ve-id 3 10
 afi-vpls 1:2 update-source loopback0
 exit
!
router bgp6 1
...
router bgp4 1
 ...
 neighbor 2.2.2.3 address-family vpls
...
router bgp6 1
 ...
 neighbor 4321::3 address-family vpls
