...
=== "Configuration"
    ...
    **r5:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz12r5-log.run
    !
    vrf definition tester
     exit
    !
    ...
    **r6:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz12r6-log.run
    !
    vrf definition tester
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.11 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:16 |
     | ethernet2.11 | 0000.0000.0000 | 1     | 4444.0000.3333 | 1.1.1.6    | ::            | down  | 00:00:16 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.12 | 0000.0000.0000 | 1     | 6666.0000.1111 | 1234:1::1  | ::            | up    | 00:00:16 |
     | ethernet2.12 | 0000.0000.0000 | 1     | 6666.0000.3333 | 1234:2::2  | ::            | down  | 00:00:16 |
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.2222.00-00 | 0000000a | apo   | 82  | 00:19:43 |
     | 4444.0000.3333.00-00 | 0000000c | apo   | 121 | 00:19:46 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.2222.00-00 | 0000000b | apo   | 110 | 00:19:43 |
     | 6666.0000.3333.00-00 | 0000000c | apo   | 164 | 00:19:46 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | I    | 1234:3::/32   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:17 |
     | I    | 1234:4::/32   | 115/30 | ethernet2.12 | 1234:2::2 | 00:00:14 |
     | I    | 1234:5::/32   | 115/40 | ethernet2.12 | 1234:2::2 | 00:00:11 |
     | I EX | 4321::1/128   | 115/10 | ethernet1.12 | 1234:1::1 | 00:00:17 |
     | C    | 4321::2/128   | 0/0    | loopback1    | null      | 00:00:17 |
     | I EX | 4321::3/128   | 115/10 | ethernet2.12 | 1234:2::2 | 00:00:17 |
     | I EX | 4321::4/128   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:14 |
