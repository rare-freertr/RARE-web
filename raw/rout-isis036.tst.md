...
=== "Configuration"
    ...
    **r6:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz89r6-log.run
    !
    vrf definition tester
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.11 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:15 |
     | ethernet2.11 | 0000.0000.0000 | 1     | 4444.0000.3333 | 1.1.1.6    | ::            | down  | 00:00:15 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.12 | 0000.0000.0000 | 1     | 6666.0000.1111 | 1234:1::1  | ::            | up    | 00:00:15 |
     | ethernet2.12 | 0000.0000.0000 | 1     | 6666.0000.3333 | 1234:2::2  | ::            | down  | 00:00:15 |
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.2222.00-00 | 0000000b | apo   | 82  | 00:19:44 |
     | 4444.0000.3333.00-00 | 0000000c | apo   | 121 | 00:19:44 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.2222.00-00 | 0000000b | apo   | 110 | 00:19:44 |
     | 6666.0000.3333.00-00 | 0000000c | apo   | 164 | 00:19:44 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | I   | 1.1.1.8/30  | 115/20 | ethernet2.11 | 1.1.1.6 | 00:00:16 |
     | I   | 1.1.1.12/30 | 115/30 | ethernet2.11 | 1.1.1.6 | 00:00:13 |
     | I   | 1.1.1.16/30 | 115/40 | ethernet2.11 | 1.1.1.6 | 00:00:13 |
     | I   | 2.2.2.1/32  | 115/10 | ethernet1.11 | 1.1.1.1 | 00:00:16 |
     | C   | 2.2.2.2/32  | 0/0    | loopback1    | null    | 00:00:17 |
     | I   | 2.2.2.3/32  | 115/10 | ethernet2.11 | 1.1.1.6 | 00:00:16 |
     | I   | 2.2.2.4/32  | 115/20 | ethernet2.11 | 1.1.1.6 | 00:00:13 |
     | I   | 2.2.2.5/32  | 115/30 | ethernet2.11 | 1.1.1.6 | 00:00:13 |
    ...
    r2#show ipv6 route v1
     ...
     | I    | 1234:3::/32   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:16 |
     | I    | 1234:4::/32   | 115/30 | ethernet2.12 | 1234:2::2 | 00:00:13 |
     | I    | 1234:5::/32   | 115/40 | ethernet2.12 | 1234:2::2 | 00:00:13 |
     | I EX | 4321::1/128   | 115/10 | ethernet1.12 | 1234:1::1 | 00:00:16 |
     | C    | 4321::2/128   | 0/0    | loopback1    | null      | 00:00:17 |
     | I EX | 4321::3/128   | 115/10 | ethernet2.12 | 1234:2::2 | 00:00:16 |
     | I EX | 4321::4/128   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:13 |
     | I EX | 4321::5/128   | 115/30 | ethernet2.12 | 1234:2::2 | 00:00:13 |
