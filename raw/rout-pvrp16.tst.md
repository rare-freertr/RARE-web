# Example: pvrp egress route filtering with routepolicy

## **Topology diagram**

![topology](/img/rout-pvrp16.tst.png)
...
!
route-policy p6
 sequence 10 if network 4321::11/128 ge 128 le 128
 sequence 20   drop
 sequence 30 else
 sequence 40   pass
 sequence 50 enif
...
interface ethernet1
 ...
 router pvrp4 1 route-policy-out p4
 router pvrp6 1 enable
 router pvrp6 1 route-policy-out p6
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv4 pvrp 1 sum
 ...
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 3        | 00:00:09 |
...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
 |-----------|---------|------|-----------|-----------|---------|----------|----------|
 | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 2       | 3        | 00:00:09 |
...
r2#show ipv4 pvrp 1 rou
 ...
 | C    | 2.2.2.2/32  | 2/0    | loopback0 | null    | 00:00:15 |
 | C    | 2.2.2.12/32 | 2/0    | loopback1 | null    | 00:00:15 |
 | null | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
 | C    | 2.2.2.22/32 | 2/0    | loopback2 | null    | 00:00:15 |
...
r2#show ipv6 pvrp 1 rou
 ...
 | typ  | prefix       | metric | iface     | hop       | time     |
 |------|--------------|--------|-----------|-----------|----------|
 | C    | 1234:1::/32  | 1/0    | ethernet1 | null      | 00:00:07 |
 | null | 4321::1/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:07 |
 | C    | 4321::2/128  | 2/0    | loopback0 | null      | 00:00:15 |
 | C    | 4321::12/128 | 2/0    | loopback1 | null      | 00:00:15 |
 | null | 4321::21/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:07 |
 | C    | 4321::22/128 | 2/0    | loopback2 | null      | 00:00:15 |
...
r2#show ipv4 route v1
 ...
 | C    | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:15 |
 | P EX | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
 | C    | 2.2.2.22/32 | 0/0    | loopback2 | null    | 00:00:15 |
 |______|_____________|________|___________|_________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | P EX | 4321::1/128   | 80/10  | ethernet1 | 1234:1::1 | 00:00:07 |
 | C    | 4321::2/128   | 0/0    | loopback0 | null      | 00:00:15 |
 | C    | 4321::12/128  | 0/0    | loopback1 | null      | 00:00:15 |
 | P EX | 4321::21/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:07 |
 | C    | 4321::22/128  | 0/0    | loopback2 | null      | 00:00:15 |
