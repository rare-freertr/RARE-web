# Example: unicast+evpn/vxlan over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp200.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 007d.1c1d.3305
...
router bgp6 1
 ...
 afi-evpn 101 bmac 002f.3b13.2b2a
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 003f.241b.7b22
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
...
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0036.6a19.2f5b
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 redistribute connected
 exit
