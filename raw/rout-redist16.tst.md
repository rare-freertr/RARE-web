# Example: redistribution filtering with hierarchical routepolicy

## **Topology diagram**

![topology](/img/rout-redist16.tst.png)
...
!
route-policy h4
 sequence 10 if route-policy p4
 sequence 20   pass
 sequence 30 enif
 exit
!
route-policy h6
 sequence 10 if route-policy p6
 sequence 20   pass
 sequence 30 enif
 exit
!
...
router isis4 1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-policy h4
 redistribute isis4 2 route-policy h4
 exit
!
router isis4 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-policy h4
 redistribute isis4 1 route-policy h4
 exit
!
router isis6 1
 vrf v1
 ...
 traffeng-id ::
 is-type level2
 redistribute connected route-policy h6
 redistribute isis6 2 route-policy h6
 exit
!
router isis6 2
 vrf v1
 ...
 is-type level2
 redistribute connected route-policy h6
 redistribute isis6 1 route-policy h6
 exit
!
interface loopback1
 no description
