...
r1#show inter virt1 full
virtualppp1 is up (since 00:00:01, 2 changes)
 description:
 type is virtualppp, hwaddr=none, mtu=1396, bw=4000kbps, vrf=v1
 ip4 address=3.3.3.1/24, netmask=255.255.255.0, ifcid=795152389
 received 10 packets (660 bytes) dropped 5 packets (330 bytes)
