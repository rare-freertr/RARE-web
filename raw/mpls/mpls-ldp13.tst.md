...
r3#show mpls forw
 ...
 |---------|----------|-------|------|------------|-----------------|-------|
 | 93738   | tester:4 | null  | null | unlabelled | local           | 0     |
 | 320994  | v1:6     | null  | null | unlabelled | local duplicate | 640   |
 | 556206  | v1:4     | null  | null | unlabelled | local duplicate | 640   |
 | 843482  | v1:6     | null  | null | unlabelled | local           | 0     |
 | 993273  | v1:4     | null  | null | unlabelled | local           | 0     |
 | 1007408 | tester:6 | null  | null | unlabelled | local           | 0     |
 |_________|__________|_______|______|____________|_________________|_______|
r3#
r3#
```
...
r3#show ipv4 ldp v1 mpdat
 ...
 |------|---------|----------------------|---------|-------------------------|
 | p2mp | 2.2.2.1 | 01 00 04 00 00 04 d2 | 1.1.2.1 | local 556206/1.1.2.1/-1 |
...
r3#show ipv6 ldp v1 mpdat
 ...
 | type | root    | opaque               | uplink    | peers                     |
 |------|---------|----------------------|-----------|---------------------------|
 | p2mp | 4321::1 | 01 00 04 00 00 04 d2 | 1234:2::1 | local 320994/1234:2::1/-1 |
...
tunnel1 is up (since 00:00:17, 1 changes)
 ...
 ip4 address=3.3.3.3/24, netmask=255.255.255.0, ifcid=760186718
...
tunnel2 is up (since 00:00:17, 1 changes)
 description:
 type is p2mpldp, hwaddr=none, mtu=1500, bw=8000kbps, vrf=v1
 ip6 address=3333::3/32, netmask=ffff:ffff::, ifcid=934409475
 received 0 packets (0 bytes) dropped 0 packets (0 bytes)
