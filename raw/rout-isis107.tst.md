...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:00 |
     | ethernet3 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.2.1    | ::            | up    | 00:00:00 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet2 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234::1    | ::            | up    | 00:00:00 |
     | ethernet4 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1235::1    | ::            | up    | 00:00:00 |
     |___________|________________|_______|________________|____________|_______________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 0000000b | apo   | 68  | 00:19:58 |
     | 4444.0000.2222.00-00 | 0000000c | apo   | 68  | 00:19:59 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.1111.00-00 | 0000000c | apo   | 81  | 00:19:58 |
     | 6666.0000.2222.00-00 | 0000000d | apo   | 81  | 00:19:59 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | C   | 1.1.2.0/24 | 0/0    | ethernet3 | null    | 00:00:11 |
     | LOC | 1.1.2.2/32 | 0/1    | ethernet3 | null    | 00:00:11 |
     | I   | 2.2.2.1/32 | 115/2  | ethernet1 | 1.1.1.1 | 00:00:01 |
    ...
    r2#show ipv6 route v1
     ...
     | C    | 1235::/16   | 0/0    | ethernet4 | null    | 00:00:11 |
     | LOC  | 1235::2/128 | 0/1    | ethernet4 | null    | 00:00:11 |
     | I EX | 4321::1/128 | 115/2  | ethernet2 | 1234::1 | 00:00:01 |
