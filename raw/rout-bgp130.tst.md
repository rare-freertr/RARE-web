# Example: bgp change in extended community with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp130.tst.png)
...
route-map rm1
 ...
 sequence 10 match extcomm 1:1234:5000
 !
...
route-map rm1
 ...
 sequence 10 set extcomm 1:1234:1000
 !
 exit
!
bridge 1
...
route-map rm1
 sequence 10 action deny
 sequence 10 match extcomm 1:1234:3000
 !
 sequence 20 action permit
 !
 exit
