# Example: olsr outgoing interface metric
...
=== "Configuration"
    ...
    **r3:**
    ...
    interface ethernet1
     ...
     router olsr4 1 enable
     router olsr4 1 metric-out 200
     router olsr6 1 enable
     router olsr6 1 metric-out 200
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 olsr 1 dat
     ...
     |-----|--------------|---------|-----------|---------|----------|
     | N   | 1.1.1.0/30   | 1/0     | ethernet1 | null    | 00:01:11 |
    ...
    r2#show ipv6 olsr 1 dat
     ...
     | typ | prefix        | metric  | iface     | hop       | time     |
     |-----|---------------|---------|-----------|-----------|----------|
     | N   | 1234:1::/32   | 1/0     | ethernet1 | null      | 00:01:11 |
     | N   | 1234:2::/32   | 1/0     | ethernet2 | null      | 00:01:11 |
