# Example: evpn/pbb over srv6 over bgp route server

## **Topology diagram**

![topology](/img/rout-bgp368.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0048.6721.3e69
...
router bgp6 1
 ...
 afi-evpn 102 bmac 0066.2b1d.3e5e
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 srv6 tunnel1
 afi-evpn 101 bmac 0001.0e5b.600e
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source ethernet1
 exit
!
router bgp6 1
 ...
 afi-evpn 102 bridge-group 2
 afi-evpn 102 srv6 tunnel1
 afi-evpn 102 bmac 0046.0906.3c39
 afi-evpn 102 encapsulation pbb
 afi-evpn 102 update-source ethernet1
 exit
!
