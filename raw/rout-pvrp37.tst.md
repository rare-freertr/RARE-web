...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 1       | 2        | 00:00:08 |
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.1.6 | 3       | 2        | 00:00:08 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 1       | 2        | 00:00:13 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1234:2::2 | 3       | 2        | 00:00:08 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | C    | 1.1.1.4/30 | 1/0    | ethernet2 | null    | 00:00:03 |
     | null | 1.1.1.8/30 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:03 |
     | null | 2.2.2.1/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:03 |
     | C    | 2.2.2.2/32 | 2/0    | loopback1 | null    | 00:00:14 |
     | null | 2.2.2.3/32 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:03 |
     | null | 2.2.2.4/32 | 80/20  | ethernet2 | 1.1.1.6 | 00:00:03 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | typ  | prefix      | metric | iface     | hop       | time     |
     |------|-------------|--------|-----------|-----------|----------|
     | C    | 1234:1::/32 | 1/0    | ethernet1 | null      | 00:00:05 |
     | C    | 1234:2::/32 | 1/0    | ethernet2 | null      | 00:00:05 |
     | null | 1234:3::/32 | 80/10  | ethernet2 | 1234:2::2 | 00:00:05 |
     | null | 4321::1/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:09 |
     | C    | 4321::2/128 | 2/0    | loopback1 | null      | 00:00:14 |
     | null | 4321::3/128 | 80/10  | ethernet2 | 1234:2::2 | 00:00:05 |
     | null | 4321::4/128 | 80/20  | ethernet2 | 1234:2::2 | 00:00:05 |
    ...
    r2#show ipv4 route v1
     ...
     | P    | 1.1.1.8/30 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:03 |
     | P EX | 2.2.2.1/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:03 |
     | C    | 2.2.2.2/32 | 0/0    | loopback1 | null    | 00:00:14 |
     | P EX | 2.2.2.3/32 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:03 |
     | P EX | 2.2.2.4/32 | 80/20  | ethernet2 | 1.1.1.6 | 00:00:03 |
     |______|____________|________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | P    | 1234:3::/32   | 80/10  | ethernet2 | 1234:2::2 | 00:00:05 |
     | P EX | 4321::1/128   | 80/10  | ethernet1 | 1234:1::1 | 00:00:10 |
     | C    | 4321::2/128   | 0/0    | loopback1 | null      | 00:00:14 |
     | P EX | 4321::3/128   | 80/10  | ethernet2 | 1234:2::2 | 00:00:05 |
     | P EX | 4321::4/128   | 80/20  | ethernet2 | 1234:2::2 | 00:00:05 |
