# Example: tmux over ipv4

## **Topology diagram**

![topology](/img/conn-tmux01.tst.png)
...
tunnel1 is up
 description:
 state changed 13 times, last at 2022-05-02 21:11:30, 00:00:02 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is tmux, hwaddr=none, mtu=1476, bw=100mbps, vrf=v1
 ipv4 address=2.2.2.1/24, mask=255.255.255.0, ifcid=531297530
 ipv6 address=4321::1/16, mask=ffff::, ifcid=566120402
