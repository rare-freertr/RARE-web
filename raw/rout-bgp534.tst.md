# Example: bgp routepolicy filtering with nexthop with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp534.tst.png)
...
!
route-policy rm1
 sequence 10 if nexthop 1.1.1.3
 sequence 20   drop
 sequence 30 else
 sequence 40   pass
 sequence 50 enif
...
!
route-policy rm2
 sequence 10 if nexthop 1234:1::3
 sequence 20   drop
 sequence 30 else
 sequence 40   pass
 sequence 50 enif
...
router bgp6 1
 ...
 neighbor 1234:1::3 route-policy-out rm2
 redistribute connected
 exit
!
!
