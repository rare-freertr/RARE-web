# Example: static routing with prefix tracker

## **Topology diagram**

![topology](/img/rout-static15.tst.png)
...
r2#show ipv4 route v1
 ...
 |-----|--------------|--------|-----------|---------|----------|
 | S   | 0.0.0.0/0    | 22/0   | ethernet1 | 1.1.1.1 | 00:00:06 |
...
r2#show ipv6 route v1
 ...
 | typ | prefix        | metric | iface     | hop       | time     |
 |-----|---------------|--------|-----------|-----------|----------|
 | S   | ::/0          | 22/0   | ethernet1 | 1234:1::1 | 00:00:06 |
