...
![topology](/img/rout-bgp519.tst.png)
...
router bgp4 1
 ...
 graceful-restart 10000
 neighbor 1.1.1.2 remote-as 2
 neighbor 1.1.1.2 local-as 1
 neighbor 1.1.1.2 address-family unicast
 neighbor 1.1.1.2 distance 20
 neighbor 1.1.1.2 graceful-restart unicast
...
router bgp6 1
 ...
 neighbor 1234:1::2 graceful-restart unicast
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 graceful-restart unicast
 ...
 neighbor 1.1.1.6 graceful-restart unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 graceful-restart unicast
 ...
 neighbor 1234:2::2 graceful-restart unicast
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 graceful-restart unicast
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 graceful-restart unicast
 redistribute connected
 exit
!
!
