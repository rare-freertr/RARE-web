# Example: bgp vpn with import map

## **Topology diagram**

![topology](/img/rout-bgp344.tst.png)
...
route-map rm4
 ...
 sequence 10 match network 3.3.3.0/24 ge 32 le 32
 !
 exit
!
route-map rm6
 sequence 10 action permit
 sequence 10 match network 3333::/64 ge 128 le 128
 !
 exit
!
vrf definition v1
