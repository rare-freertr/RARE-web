# Example: labels bgp ingress route filtering with routemap with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp483.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 route-map-in p4
...
router bgp6 1
 ...
 neighbor 1234:1::2 route-map-in p6
 redistribute connected
 exit
!
!
