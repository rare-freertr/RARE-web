# Example: mpls over bier

## **Topology diagram**

![topology](/img/mpls-bier16.tst.png)
...
interface loopback2
 ...
 ipv6 address 4321::2221 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
 no shutdown
 no log-link-change
 exit
!
...
interface loopback2
 ...
 ipv6 address 4321::2222 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
 no shutdown
 no log-link-change
 exit
!
