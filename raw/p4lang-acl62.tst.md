# Example: p4lang: bridge interface inspection with egress drop

## **Topology diagram**

![topology](/img/p4lang-acl62.tst.png)
...
server dhcp4 eth1
 ...
 exit
access-list test4
 seq 10 permit 1 any all any all
 exit
access-list test6
...
int bvi1
 ...
 ipv4 resend
 ipv6 resend
 ipv4 inspect drop-tx allow-list test4
 ipv6 inspect drop-tx allow-list test6
 exit
server p4lang p4
 interconnect eth2
 export-vrf v1 1
