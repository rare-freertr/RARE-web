# Example: unicast+mdt over bgp with additional path

## **Topology diagram**

![topology](/img/rout-bgp186.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 additional-path-rx unicast mdt
 neighbor 1.1.1.2 additional-path-tx unicast mdt
...
router bgp6 1
 ...
 neighbor 1234:1::2 additional-path-rx unicast mdt
 neighbor 1234:1::2 additional-path-tx unicast mdt
...
router bgp4 1
 ...
 neighbor 1.1.1.1 additional-path-rx unicast mdt
 neighbor 1.1.1.1 additional-path-tx unicast mdt
...
router bgp6 1
 ...
 neighbor 1234:1::1 additional-path-rx unicast mdt
 neighbor 1234:1::1 additional-path-tx unicast mdt
