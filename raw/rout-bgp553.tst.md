# Example: bgp vpns change in metric

## **Topology diagram**

![topology](/img/rout-bgp553.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 address-family vpnuni
 ...
 neighbor 1.1.1.4 address-family vpnuni
...
router bgp6 1
 ...
 neighbor 1234:1::2 address-family vpnuni
 ...
 neighbor 1234:1::4 address-family vpnuni
...
router bgp4 1
 ...
 afi-vrf v3 redistribute connected
 afi-vrf v4 enable
 afi-vrf v4 redistribute connected route-map rm1
 exit
!
router bgp6 1
 vrf v1
