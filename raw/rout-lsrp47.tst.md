# Example: lsrp dynamic twamp metric

## **Topology diagram**

![topology](/img/rout-lsrp47.tst.png)
...
interface ethernet1
 ...
 router lsrp4 1 enable
 router lsrp4 1 dynamic-metric twamp
 router lsrp4 1 metric 2
 router lsrp6 1 enable
 router lsrp6 1 dynamic-metric twamp
...
r2#show ipv6 lsrp 1 nei
 ...
 | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1235::1 | true  | 00:00:07 |
 |___________|_________|______|___________|_________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 lsrp 1 dat
 ...
 |---------|------|-----|-----|-----|----------|----------|
 | 4.4.4.1 | r1   | 2   | 3   | 10  | c68f402a | 00:59:59 |
 | 4.4.4.2 | r2   | 2   | 3   | 12  | c68f402a | 00:59:59 |
...
r2#show ipv6 lsrp 1 dat
 ...
 | id      | name | nei | net | seq | topo     | left     |
 |---------|------|-----|-----|-----|----------|----------|
 | 6.6.6.1 | r1   | 2   | 3   | 10  | c68f402a | 00:59:56 |
 | 6.6.6.2 | r2   | 2   | 3   | 10  | c68f402a | 00:59:56 |
 |_________|______|_____|_____|_____|__________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | L EX | 4321::1/128 | 70/1   | ethernet2 | 1235::1 | 00:00:04 |
