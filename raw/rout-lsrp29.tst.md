# Example: lsrp address unsuppression
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface loopback3
     ...
     router lsrp4 1 enable
     router lsrp4 1 passive
     router lsrp4 1 unsuppress-prefix
     router lsrp6 1 enable
     router lsrp6 1 passive
     router lsrp6 1 unsuppress-prefix
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 2   | 7   | c1f9b31f | 00:59:58 |
     | 4.4.4.2 | r2   | 1   | 1   | 3   | 68489efd | 00:59:58 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 2   | 7   | c03bd928 | 00:59:57 |
     | 6.6.6.2 | r2   | 1   | 1   | 3   | 68489efd | 00:59:57 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L    | 2.2.2.3/32 | 70/10  | ethernet1 | 1.1.1.1 | 00:00:02 |
    ...
    r2#show ipv6 route v1
     ...
     | L    | 4321::3/128   | 70/10  | ethernet1 | 1234:1::1 | 00:00:03 |
