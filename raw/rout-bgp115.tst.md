# Example: bgp change in locpref

## **Topology diagram**

![topology](/img/rout-bgp115.tst.png)
...
route-map rm1
 ...
 sequence 10 match locpref 4000-6000
 !
...
route-map rm1
 ...
 sequence 10 set locpref set 1000
 !
 exit
!
bridge 1
...
route-map rm1
 sequence 10 action deny
 sequence 10 match locpref 2000-4000
 !
 sequence 20 action permit
 !
 exit
