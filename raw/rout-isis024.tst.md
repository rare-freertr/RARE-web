# Example: isis inter level egress filtering with prefixlist
...
=== "Configuration"
    ...
    **r2:**
    ...
    router isis4 1
     ...
     traffeng-id ::
     is-type both
     level2 prefix-list-into p4
     level1 prefix-list-into p4
     redistribute connected
     exit
    !
    router isis6 1
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000009 | apo   | 57  | 00:19:48 |
     | 4444.0000.2222.00-00 | 00000008 | apo   | 68  | 00:19:49 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.1111.00-00 | 00000008 | apo   | 84  | 00:19:40 |
     | 6666.0000.2222.00-00 | 0000000c | apo   | 96  | 00:19:49 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | I   | 2.2.2.11/32 | 115/10 | ethernet1.11 | 1.1.1.1 | 00:00:10 |
     | C   | 2.2.2.12/32 | 0/0    | loopback2    | null    | 00:00:21 |
     | I   | 2.2.2.13/32 | 115/10 | ethernet2.11 | 1.1.1.6 | 00:00:10 |
    ...
    r2#show ipv6 route v1
     ...
     | I EX | 4321::3/128   | 115/10 | ethernet2.12 | 1234:2::2 | 00:00:10 |
     | I EX | 4321::11/128  | 115/10 | ethernet1.12 | 1234:1::1 | 00:00:20 |
     | C    | 4321::12/128  | 0/0    | loopback2    | null      | 00:00:21 |
     | I EX | 4321::13/128  | 115/10 | ethernet2.12 | 1234:2::2 | 00:00:10 |
