# Example: bgp leak prevention with customer provider

## **Topology diagram**

![topology](/img/rout-bgp521.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.6 role provider
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:2::2 role provider
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.5 role customer
 ...
 neighbor 1.1.1.10 role customer
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:2::1 role customer
 ...
 neighbor 1234:3::2 role customer
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 role provider
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 role provider
 redistribute connected
 exit
!
!
