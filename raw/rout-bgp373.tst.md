# Example: evpn/cmac over srv6 over bgp with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp373.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0024.353e.5138
...
router bgp6 1
 ...
 afi-evpn 102 bmac 000f.7d73.4373
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 srv6 tunnel1
 afi-evpn 101 bmac 003a.5a41.4a66
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source ethernet1
 exit
!
router bgp6 1
 ...
 afi-evpn 102 bridge-group 2
 afi-evpn 102 srv6 tunnel1
 afi-evpn 102 bmac 0022.5e55.690a
 afi-evpn 102 encapsulation cmac
 afi-evpn 102 update-source ethernet1
 exit
!
