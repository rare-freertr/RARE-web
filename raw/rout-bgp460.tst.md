# Example: othervpns with default route

## **Topology diagram**

![topology](/img/rout-bgp460.tst.png)
...
router bgp4 1
 ...
 afi-ovrf v2 enable
 afi-ovrf v2 default-originate
 afi-ovrf v3 enable
 afi-ovrf v3 default-originate
 afi-ovrf v4 enable
 afi-ovrf v4 default-originate
 exit
!
router bgp6 1
 vrf v1
