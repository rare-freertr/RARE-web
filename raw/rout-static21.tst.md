...
=== "Configuration"
    ...
    **r4:**
    ...
    interface loopback0
     vrf forwarding v1
     ipv4 address 2.2.1.104 255.255.255.255
     ipv6 address 4320::104 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
     no shutdown
     no log-link-change
     exit
    !
    interface loopback1
     vrf forwarding v1
     ipv4 address 2.2.3.104 255.255.255.255
     ipv6 address 4322::104 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
     no shutdown
     no log-link-change
     exit
    !
    ...
    **r5:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz4r5-log.run
    !
    vrf definition tester
     exit
    !
    ...
    interface loopback0
     vrf forwarding v1
     ipv4 address 2.1.2.105 255.255.255.255
     ipv6 address 4311::105 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
     no shutdown
     no log-link-change
     exit
    !
    interface loopback1
     vrf forwarding v1
     ipv4 address 2.3.2.105 255.255.255.255
     ipv6 address 4331::105 ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff
     no shutdown
     no log-link-change
     exit
    !
