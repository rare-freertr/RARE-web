# Example: redistribution filtering with prefixlist

## **Topology diagram**

![topology](/img/rout-redist12.tst.png)
...
router isis4 1
 ...
 redistribute isis4 2 prefix-list p4
 exit
!
router isis4 2
 vrf v1
 ...
 is-type level2
 redistribute connected prefix-list p4
 redistribute isis4 1 prefix-list p4
 exit
!
router isis6 1
 vrf v1
 ...
 redistribute isis6 2 prefix-list p6
 exit
!
router isis6 2
 vrf v1
 ...
 is-type level2
 redistribute connected prefix-list p6
 redistribute isis6 1 prefix-list p6
 exit
!
interface loopback1
 no description
