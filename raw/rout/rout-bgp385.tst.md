# Example: ethersite evpn/vpws over ibgp

## **Topology diagram**

![topology](/img/rout-bgp385.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0037.5a34.4506
...
router bgp6 1
 ...
 afi-evpn 101 bmac 002b.627c.772c
 afi-evpn 101 encapsulation vpws
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 000e.7210.6909
 afi-evpn 101 encapsulation vpws
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 005c.2a26.617d
 afi-evpn 101 encapsulation vpws
 afi-evpn 101 update-source loopback0
 exit
!
