# Example: evpn/pbb over ibgp

## **Topology diagram**

![topology](/img/rout-bgp134.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0000.127b.4654
...
router bgp6 1
 ...
 afi-evpn 101 bmac 005a.181e.630b
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 005d.1d5c.3274
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0071.474e.5404
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 exit
!
