# Example: integrated isis default route

## **Topology diagram**

![topology](/img/rout-isis81.tst.png)
...
router isis4 1
 ...
 level2 other-default-originate
 level1 default-originate
 level1 other-default-originate
 afi-other enable
 exit
!
interface loopback1
...
r2#show ipv6 isis 1 nei
 ...
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1234::1    | 1.1.1.1       | 0     | 00:00:03 |
 | ethernet1 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1234::1    | 1.1.1.1       | 0     | 00:00:03 |
...
r2#show ipv6 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 00000008 | apo   | 95  | 00:19:56 |
 | 6666.0000.2222.00-00 | 0000000b | apo   | 95  | 00:19:56 |
...
r2#show ipv4 route v1
 ...
 |-----|------------|--------|-----------|---------|----------|
 | I   | 0.0.0.0/0  | 115/10 | ethernet1 | 1.1.1.1 | 00:00:03 |
...
r2#show ipv6 route v1
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | I   | ::/0        | 115/10 | ethernet1 | 1234::1 | 00:00:04 |
