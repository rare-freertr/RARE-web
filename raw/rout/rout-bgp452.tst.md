# Example: ouni bgp egress route filtering with routemap with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp452.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 other-route-map-out p6
 afi-other enable
...
router bgp6 1
 ...
 neighbor 1234:1::2 other-route-map-out p4
 afi-other enable
 no afi-other vpn-mode
 afi-other redistribute connected
 exit
