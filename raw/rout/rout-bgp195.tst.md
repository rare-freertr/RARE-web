...
router bgp4 1
 ...
 afi-evpn 101 bmac 006a.4375.0678
...
router bgp6 1
 ...
 afi-evpn 101 bmac 004b.786a.4267
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 neighbor 1.1.1.4 send-community standard extended
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 005a.7c04.0712
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::4 send-community standard extended
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0013.1a24.674d
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 neighbor 1.1.1.4 send-community standard extended
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 004d.500a.312c
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::4 send-community standard extended
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0064.2b43.1067
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
