...
![topology](/img/rout-bgp335.tst.png)
...
router bgp4 1
 ...
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 redistribute bgp4 2
 exit
!
router bgp4 2
 vrf v1
 ...
 neighbor 1.1.1.10 address-family vpnuni
 neighbor 1.1.1.10 distance 20
 neighbor 1.1.1.10 send-community standard extended
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
...
router bgp6 1
 ...
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 redistribute bgp6 2
 exit
!
router bgp6 2
 vrf v1
 ...
 neighbor 1234:3::2 address-family vpnuni
 neighbor 1234:3::2 distance 20
 neighbor 1234:3::2 send-community standard extended
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
...
router bgp4 1
 ...
 neighbor 1.1.1.9 address-family vpnuni
 neighbor 1.1.1.9 distance 20
 neighbor 1.1.1.9 send-community standard extended
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 redistribute bgp4 2
 exit
...
router bgp6 1
 ...
 neighbor 1234:3::1 address-family vpnuni
 neighbor 1234:3::1 distance 20
 neighbor 1234:3::1 send-community standard extended
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 redistribute bgp6 2
 exit
...
buggy
!
logging file debug ../binTmp/zzz61r5-log.run
!
vrf definition tester
 exit
!
...
buggy
!
logging file debug ../binTmp/zzz61r6-log.run
!
vrf definition tester
 exit
!
