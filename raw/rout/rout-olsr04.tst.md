# Example: olsr egress route filtering with prefixlist

## **Topology diagram**

![topology](/img/rout-olsr04.tst.png)
...
interface ethernet1
 ...
 router olsr4 1 prefix-list-out p4
 router olsr6 1 enable
 router olsr6 1 prefix-list-out p6
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv4 olsr 1 dat
 ...
 | N   | 2.2.2.21/32 | 140/1  | ethernet1 | 1.1.1.1 | 00:00:36 |
...
r2#show ipv6 olsr 1 dat
 ...
 | N   | 4321::21/128 | 140/1  | ethernet1 | 1234:1::1 | 00:00:36 |
