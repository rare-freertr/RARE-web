# Example: bgp override as out

## **Topology diagram**

![topology](/img/rout-bgp042.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.1 override-peer-as-out
 ...
 neighbor 1.1.1.6 override-peer-as-out
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 override-peer-as-out
 ...
 neighbor 1234:2::2 override-peer-as-out
 redistribute connected
 exit
!
!
