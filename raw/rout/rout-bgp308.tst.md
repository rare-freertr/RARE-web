# Example: bgp asymmetric compression

## **Topology diagram**

![topology](/img/rout-bgp308.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 compression transmit
...
router bgp6 1
 ...
 neighbor 1234:1::2 compression transmit
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 compression receive
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 compression receive
 redistribute connected
 exit
!
!
