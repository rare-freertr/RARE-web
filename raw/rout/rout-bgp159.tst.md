...
r1#show bridge 1
 ...
 | vpls 2.2.2.2 1:1 | true | false | 13 | 12 | 0    | 786 | 900 | 0    |     |
 |__________________|______|_______|____|____|______|_____|_____|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
 |                                              | packet         | byte             |
 | addr           | iface            | time     | tx | rx | drop | tx  | rx  | drop |
 |----------------|------------------|----------|----|----|------|-----|-----|------|
 | 0002.6562.666d | vpls 2.2.2.2 1:1 | 00:00:16 | 11 | 12 | 0    | 726 | 756 | 0    |
 | 0079.205f.283e | bvi              | 00:00:16 | 12 | 15 | 0    | 756 | 846 | 0    |
...
r1#show bridge 2
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
 |----------------|------------------|----------|----|----|------|-----|------|------|
 | 0004.114b.7e36 | vpls 4321::2 1:1 | 00:00:16 | 15 | 15 | 0    | 998 | 1006 | 0    |
 | 0026.753b.5e5e | bvi              | 00:00:16 | 14 | 19 | 0    | 932 | 1326 | 0    |
...
r1#show bridge 3
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
 |----------------|------------------|----------|----|----|------|-----|------|------|
 | 003e.6704.5b46 | bvi              | 00:00:16 | 14 | 19 | 0    | 932 | 1326 | 0    |
 | 0069.3b32.463a | vpls 2.2.2.2 1:2 | 00:00:16 | 15 | 15 | 0    | 998 | 1006 | 0    |
 |________________|__________________|__________|____|____|______|_____|______|______|
r1#
r1#
```
...
r1#show bridge 4
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx  | drop |
 |----------------|------------------|----------|----|----|------|-----|-----|------|
 | 0055.1005.1021 | vpls 4321::2 1:2 | 00:00:16 | 14 | 15 | 0    | 924 | 954 | 0    |
 | 0060.382a.4273 | bvi              | 00:00:16 | 15 | 15 | 0    | 954 | 954 | 0    |
 |________________|__________________|__________|____|____|______|_____|_____|______|
r1#
r1#
```
