# Example: evpn/cmac over srv6 over bgp route server

## **Topology diagram**

![topology](/img/rout-bgp369.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0073.096a.5728
...
router bgp6 1
 ...
 afi-evpn 102 bmac 003b.781f.246d
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 srv6 tunnel1
 afi-evpn 101 bmac 0063.2411.6909
 afi-evpn 101 encapsulation cmac
 afi-evpn 101 update-source ethernet1
 exit
!
router bgp6 1
 ...
 afi-evpn 102 bridge-group 2
 afi-evpn 102 srv6 tunnel1
 afi-evpn 102 bmac 0021.3565.382b
 afi-evpn 102 encapsulation cmac
 afi-evpn 102 update-source ethernet1
 exit
!
...
router bgp6 1
 ...
 neighbor 1234::2 route-server-client
