...
r2#show ipv4 isis 1 nei
 ...
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | serial1   | 0000.0000.0000 | 1     | 4444.0000.1111 | 9.9.9.1    | ::            | 0     | 00:00:03 |
 | serial1   | 0000.0000.0000 | 2     | 4444.0000.1111 | 9.9.9.1    | ::            | 0     | 00:00:03 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | serial2   | 0000.0000.0000 | 1     | 6666.0000.1111 | 9999::1    | ::            | 0     | 00:00:03 |
 | serial2   | 0000.0000.0000 | 2     | 6666.0000.1111 | 9999::1    | ::            | 0     | 00:00:03 |
 |___________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 00000005 | apo   | 56  | 00:19:55 |
 | 4444.0000.2222.00-00 | 00000005 | apo   | 56  | 00:19:56 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | 6666.0000.2222.00-00 | 00000005 | apo   | 82  | 00:19:56 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | C    | 9999::/16   | 0/0    | serial2   | null    | 00:00:14 |
 | MSH  | 9999::1/128 | 0/3    | serial2   | 9999::1 | never    |
 | LOC  | 9999::2/128 | 0/1    | serial2   | null    | 00:00:14 |
