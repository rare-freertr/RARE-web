...
r2#show ipv4 pvrp 1 sum
 ...
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.1.5 | 2       | 1        | 00:00:08 |
...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
 |-----------|---------|------|-----------|-----------|---------|----------|----------|
 | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1234:2::1 | 2       | 1        | 00:00:08 |
...
r2#show ipv4 pvrp 1 rou
 ...
 |------|------------|--------|-----------|---------|----------|
 | null | 1.1.1.0/30 | 80/100 | ethernet2 | 1.1.1.5 | 00:00:04 |
 | C    | 1.1.1.4/30 | 1/0    | ethernet2 | null    | 00:00:00 |
 | null | 2.2.2.1/32 | 80/100 | ethernet2 | 1.1.1.5 | 00:00:04 |
 | C    | 2.2.2.2/32 | 2/0    | loopback1 | null    | 00:00:00 |
...
r2#show ipv6 pvrp 1 rou
 ...
 | typ  | prefix      | metric | iface     | hop       | time     |
 |------|-------------|--------|-----------|-----------|----------|
 | null | 1234:1::/32 | 80/100 | ethernet2 | 1234:2::1 | 00:00:05 |
 | C    | 1234:2::/32 | 1/0    | ethernet2 | null      | 00:00:00 |
 | null | 4321::1/128 | 80/100 | ethernet2 | 1234:2::1 | 00:00:05 |
 | C    | 4321::2/128 | 2/0    | loopback1 | null      | 00:00:00 |
...
r2#show ipv4 route v1
 ...
 | typ  | prefix     | metric | iface     | hop     | time     |
 |------|------------|--------|-----------|---------|----------|
 | P    | 1.1.1.0/30 | 80/100 | ethernet2 | 1.1.1.5 | 00:00:04 |
 | C    | 1.1.1.4/30 | 0/0    | ethernet2 | null    | 00:00:14 |
 | LOC  | 1.1.1.6/32 | 0/1    | ethernet2 | null    | 00:00:14 |
 | P EX | 2.2.2.1/32 | 80/100 | ethernet2 | 1.1.1.5 | 00:00:04 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix        | metric | iface     | hop       | time     |
 |------|---------------|--------|-----------|-----------|----------|
 | P    | 1234:1::/32   | 80/100 | ethernet2 | 1234:2::1 | 00:00:06 |
 | C    | 1234:2::/32   | 0/0    | ethernet2 | null      | 00:00:14 |
 | LOC  | 1234:2::2/128 | 0/1    | ethernet2 | null      | 00:00:14 |
 | P EX | 4321::1/128   | 80/100 | ethernet2 | 1234:2::1 | 00:00:06 |
