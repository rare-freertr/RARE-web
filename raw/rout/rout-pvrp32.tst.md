# Example: pvrp address unsuppression

## **Topology diagram**

![topology](/img/rout-pvrp32.tst.png)
...
interface loopback3
 ...
 router pvrp4 1 enable
 router pvrp4 1 passive
 router pvrp4 1 unsuppress-prefix
 router pvrp6 1 enable
 router pvrp6 1 passive
 router pvrp6 1 unsuppress-prefix
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv4 pvrp 1 sum
 ...
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 0        | 00:00:05 |
...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
 |-----------|---------|------|-----------|-----------|---------|----------|----------|
 | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 2       | 0        | 00:00:05 |
...
r2#show ipv6 pvrp 1 rou
 ...
 | null | 4321::3/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:01 |
...
r2#show ipv4 route v1
 ...
 | P    | 2.2.2.3/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
 |______|____________|________|___________|_________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | P    | 4321::3/128   | 80/10  | ethernet1 | 1234:1::1 | 00:00:02 |
