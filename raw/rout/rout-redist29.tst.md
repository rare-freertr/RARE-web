# Example: redistribution with ouni bgp

## **Topology diagram**

![topology](/img/rout-redist29.tst.png)
...
router bgp6 1
 ...
 neighbor 1234:2::2 address-family ouni
 neighbor 1234:2::2 distance 20
 afi-other enable
 no afi-other vpn-mode
 afi-other redistribute connected
 afi-other redistribute isis4 1
 exit
!
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.5 address-family ouni
...
router bgp6 1
 ...
 neighbor 1234:2::1 address-family ouni
