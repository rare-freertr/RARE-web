...
![topology](/img/rout-isis53.tst.png)
...
r2#show ipv4 isis 1 nei
 ...
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | serial1   | 0000.0000.0000 | 1     | 4444.0000.1111 | 9.9.9.1    | ::            | 2     | 00:00:31 |
 | serial1   | 0000.0000.0000 | 2     | 4444.0000.1111 | 9.9.9.1    | ::            | 0     | 00:00:31 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | serial2   | 0000.0000.0000 | 1     | 6666.0000.1111 | 9999::1    | ::            | 2     | 00:00:31 |
 | serial2   | 0000.0000.0000 | 2     | 6666.0000.1111 | 9999::1    | ::            | 0     | 00:00:31 |
 |___________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 0000.0000.0000.00-00 | 00000008 | apo   | 65  | 00:19:28 |
 | 4444.0000.1111.00-00 | 00000006 | apo   | 66  | 00:19:27 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 0000.0000.0000.00-00 | 00000006 | apo   | 91  | 00:19:28 |
 | 6666.0000.1111.00-00 | 0000000a | apo   | 92  | 00:19:28 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv4 route v1
 ...
 |-----|-------------|--------|-----------|---------|----------|
 | I   | 2.2.2.1/32  | 115/10 | serial1   | 9.9.9.1 | 00:00:32 |
 | C   | 2.2.2.2/32  | 0/0    | loopback0 | null    | 00:00:42 |
 | I   | 2.2.2.11/32 | 115/10 | serial3   | 9.9.8.1 | 00:00:32 |
 | C   | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:42 |
 | C   | 9.9.8.0/24  | 0/0    | serial3   | null    | 00:00:42 |
 | LOC | 9.9.8.2/32  | 0/1    | serial3   | null    | 00:00:42 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix       | metric | iface     | hop     | time     |
 |------|--------------|--------|-----------|---------|----------|
 | I EX | 4321::1/128  | 115/10 | serial2   | 9999::1 | 00:00:32 |
 | C    | 4321::2/128  | 0/0    | loopback0 | null    | 00:00:43 |
 | I EX | 4321::11/128 | 115/10 | serial4   | 9998::1 | 00:00:32 |
 | C    | 4321::12/128 | 0/0    | loopback1 | null    | 00:00:42 |
 | C    | 9998::/16    | 0/0    | serial4   | null    | 00:00:42 |
 | LOC  | 9998::2/128  | 0/1    | serial4   | null    | 00:00:42 |
 | C    | 9999::/16    | 0/0    | serial2   | null    | 00:00:42 |
 | LOC  | 9999::2/128  | 0/1    | serial2   | null    | 00:00:42 |
