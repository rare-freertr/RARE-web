# Example: evpn/vxlan over confed bgp

## **Topology diagram**

![topology](/img/rout-bgp193.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0000.666f.1f02
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0015.5422.5d45
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0020.0a47.3924
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0078.725c.6638
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
