...
![topology](/img/rout-pvrp39.tst.png)
...
r2#show ipv4 pvrp 1 sum
 ...
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.3 | 1       | 1        | 00:00:08 |
...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer    | learned | adverted | uptime   |
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::3 | 1       | 1        | 00:00:09 |
 |___________|_________|______|___________|_________|_________|__________|__________|
r2#
r2#
```
...
r2#show ipv4 pvrp 1 rou
 ...
 |------|------------|--------|-----------|---------|----------|
 | C    | 1.1.1.2/31 | 1/0    | ethernet1 | null    | 00:00:04 |
 | null | 2.2.2.1/32 | 80/10  | ethernet1 | 1.1.1.3 | 00:00:04 |
...
r2#show ipv6 pvrp 1 rou
 ...
 | typ  | prefix      | metric | iface     | hop     | time     |
 |------|-------------|--------|-----------|---------|----------|
 | C    | 1234::2/127 | 1/0    | ethernet1 | null    | 00:00:01 |
 | null | 4321::1/128 | 80/10  | ethernet1 | 1234::3 | 00:00:01 |
...
r2#show ipv4 route v1
 ...
 | typ  | prefix     | metric | iface     | hop     | time     |
 |------|------------|--------|-----------|---------|----------|
 | C    | 1.1.1.2/31 | 0/0    | ethernet1 | null    | 00:00:14 |
 | LOC  | 1.1.1.2/32 | 0/1    | ethernet1 | null    | 00:00:14 |
 | P EX | 2.2.2.1/32 | 80/10  | ethernet1 | 1.1.1.3 | 00:00:04 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix      | metric | iface     | hop     | time     |
 |------|-------------|--------|-----------|---------|----------|
 | C    | 1234::2/127 | 0/0    | ethernet1 | null    | 00:00:14 |
 | LOC  | 1234::2/128 | 0/1    | ethernet1 | null    | 00:00:14 |
 | P EX | 4321::1/128 | 80/10  | ethernet1 | 1234::3 | 00:00:01 |
