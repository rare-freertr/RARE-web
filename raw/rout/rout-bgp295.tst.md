# Example: bgp csc othervpn

## **Topology diagram**

![topology](/img/rout-bgp295.tst.png)
...
router bgp4 2
 ...
 neighbor 3.3.3.102 address-family vpnuni ovpnuni
 ...
 afi-ovrf v2 redistribute bgp6 1
 exit
!
router bgp6 1
 vrf v2
...
router bgp6 2
 ...
 neighbor 3333::102 address-family vpnuni ovpnuni
...
router bgp4 2
 ...
 neighbor 3.3.3.101 address-family vpnuni ovpnuni
...
router bgp6 2
 ...
 neighbor 3333::101 address-family vpnuni ovpnuni
...
buggy
!
logging file debug ../binTmp/zzz48r5-log.run
!
vrf definition tester
 exit
!
