# Example: evpn/vxlan over ibgp

## **Topology diagram**

![topology](/img/rout-bgp190.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0017.5532.234e
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0064.6979.6427
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0000.0931.1a4a
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0028.653f.146a
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
