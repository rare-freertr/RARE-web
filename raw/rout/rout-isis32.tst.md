...
r2#show ipv4 isis 1 nei
 ...
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:03 |
 | ethernet1 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:03 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |-----------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet2 | 0000.0000.0000 | 1     | 6666.0000.1111 | 1234::1    | ::            | 0     | 00:00:03 |
 | ethernet2 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234::1    | ::            | 0     | 00:00:03 |
 |___________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 00000009 | apo   | 66  | 00:19:56 |
 | 4444.0000.2222.00-00 | 00000008 | apo   | 66  | 00:19:56 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 6666.0000.1111.00-00 | 00000009 | apo   | 92  | 00:19:56 |
 | 6666.0000.2222.00-00 | 00000008 | apo   | 92  | 00:19:56 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | C    | 9999::/16   | 0/0    | template2 | null    | 00:00:04 |
 | LOC  | 9999::9/128 | 0/1    | template2 | null    | 00:00:04 |
