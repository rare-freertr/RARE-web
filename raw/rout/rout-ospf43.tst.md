...
r2#show ipv4 ospf 1 nei
 ...
 |-----------|------|---------|----------|-------|----------|
 | ethernet1 | 0    | 1.1.1.3 | 4.4.4.1  | 4     | 00:00:03 |
...
r2#show ipv6 ospf 1 nei
 ...
 | interface | area | address | routerid | state | uptime   |
 |-----------|------|---------|----------|-------|----------|
 | ethernet1 | 0    | 1234::3 | 6.6.6.1  | 4     | 00:00:03 |
 |___________|______|_________|__________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 ospf 1 dat 0
 ...
 |----------|---------|----------|------------|-----|----------|
 | 4.4.4.1  | 4.4.4.1 | 80000004 | router     | 28  | 00:00:00 |
 ...
 | 4.4.4.1  | 1.1.1.2 | 80000001 | asExternal | 16  | 00:00:03 |
 | 4.4.4.2  | 1.1.1.2 | 80000001 | asExternal | 16  | 00:00:04 |
...
r2#show ipv6 ospf 1 dat 0
 ...
 | routerid | lsaid     | sequence | type       | len | time     |
 |----------|-----------|----------|------------|-----|----------|
 | 6.6.6.1  | 710514085 | 80000001 | link       | 24  | 00:00:04 |
 | 6.6.6.2  | 824302170 | 80000001 | link       | 24  | 00:00:04 |
 | 6.6.6.1  | 0         | 80000003 | router     | 20  | 00:00:01 |
 | 6.6.6.2  | 0         | 80000003 | router     | 20  | 00:00:01 |
 | 6.6.6.1  | 710514085 | 80000001 | prefix     | 32  | 00:00:04 |
 | 6.6.6.2  | 824302170 | 80000001 | prefix     | 32  | 00:00:04 |
 | 6.6.6.1  | 0         | 80000003 | asExternal | 28  | 00:00:04 |
 | 6.6.6.2  | 0         | 80000004 | asExternal | 28  | 00:00:04 |
...
r2#show ipv4 route v1
 ...
 |------|------------|--------|-----------|---------|----------|
 | C    | 1.1.1.2/31 | 0/0    | ethernet1 | null    | 00:00:04 |
 | LOC  | 1.1.1.2/32 | 0/1    | ethernet1 | null    | 00:00:04 |
 | O E2 | 2.2.2.1/32 | 110/0  | ethernet1 | 1.1.1.3 | 00:00:01 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix      | metric | iface     | hop     | time     |
 |------|-------------|--------|-----------|---------|----------|
 | C    | 1234::2/127 | 0/0    | ethernet1 | null    | 00:00:04 |
 | LOC  | 1234::2/128 | 0/1    | ethernet1 | null    | 00:00:04 |
 | O E2 | 4321::1/128 | 110/0  | ethernet1 | 1234::3 | 00:00:01 |
