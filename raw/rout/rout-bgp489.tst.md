# Example: labels bgp egress route filtering with routepolicy with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp489.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 route-policy-out p4
...
router bgp6 1
 ...
 neighbor 1234:1::2 route-policy-out p6
 redistribute connected
 exit
!
!
