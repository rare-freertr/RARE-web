...
![topology](/img/rout-isis52.tst.png)
...
r2#show ipv4 isis 1 nei
 ...
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.11 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:13 |
 | ethernet1.11 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:13 |
 | ethernet2.11 | 0000.0000.0000 | 1     | 4444.0000.3333 | 1.1.1.6    | ::            | 0     | 00:00:13 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.12 | 0000.0000.0000 | 1     | 6666.0000.1111 | 1234:1::1  | ::            | 0     | 00:00:13 |
 | ethernet1.12 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234:1::1  | ::            | 0     | 00:00:13 |
 | ethernet2.12 | 0000.0000.0000 | 1     | 6666.0000.3333 | 1234:2::2  | ::            | 0     | 00:00:13 |
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 0000000c | apo   | 150 | 00:19:49 |
 | 4444.0000.2222.00-00 | 0000000f | apo   | 165 | 00:19:46 |
 | 4444.0000.3333.00-00 | 0000000b | apo   | 123 | 00:19:46 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 6666.0000.1111.00-00 | 0000000c | apo   | 204 | 00:19:49 |
 | 6666.0000.2222.00-00 | 0000000f | apo   | 219 | 00:19:46 |
 | 6666.0000.3333.00-00 | 0000000b | apo   | 164 | 00:19:45 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | I    | 4321::1/128    | 115/20 | ethernet1.12 | 1234:1::1 | 00:00:14 |
...
r2#show ipv4 bier v1
 ...
 |------------|-------|--------|---------|-------|
 | 2.2.2.1/32 | 1     | 645694 | 645694  | 3-256 |
 | 2.2.2.3/32 | 3     | 28893  | 28893   | 3-256 |
...
r2#show ipv6 bier v1
 ...
 | prefix      | index | base  | oldbase | size  |
 |-------------|-------|-------|---------|-------|
 | 4321::1/128 | 1     | 397   | 397     | 3-256 |
 | 4321::3/128 | 3     | 65207 | 65207   | 3-256 |
