...
![topology](/img/rout-bgp408.tst.png)
...
route-map rm1
 ...
 sequence 10 match privateas
 sequence 10 clear privateas
 !
 exit
!
vrf definition tester
...
router bgp4 1
 ...
 neighbor 1.1.1.1 route-map-out rm1
 ...
 neighbor 1.1.1.6 route-map-out rm1
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 route-map-out rm1
 ...
 neighbor 1234:2::2 route-map-out rm1
 redistribute connected
 exit
!
!
