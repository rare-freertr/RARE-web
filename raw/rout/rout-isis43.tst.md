...
![topology](/img/rout-isis43.tst.png)
...
r2#show ipv4 isis 1 nei
 ...
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.11 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:06 |
 | ethernet2.11 | 0000.0000.0000 | 2     | 4444.0000.3333 | 1.1.1.6    | ::            | 0     | 00:00:06 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.12 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234:1::1  | ::            | 0     | 00:00:06 |
 | ethernet2.12 | 0000.0000.0000 | 2     | 6666.0000.3333 | 1234:2::2  | ::            | 0     | 00:00:06 |
 |______________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 0000000c | apo   | 90  | 00:19:52 |
 | 4444.0000.2222.00-00 | 0000000f | apo   | 125 | 00:19:53 |
 | 4444.0000.3333.00-00 | 0000000a | apo   | 90  | 00:19:53 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 6666.0000.1111.00-00 | 0000000a | apo   | 104 | 00:19:53 |
 | 6666.0000.2222.00-00 | 0000000e | apo   | 140 | 00:19:53 |
 | 6666.0000.3333.00-00 | 0000000b | apo   | 104 | 00:19:52 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv4 route v1
 ...
 | I   | 2.2.2.3/32 | 115/20 | ethernet2.11 | 1.1.1.6 | 00:00:06 |
...
r2#show ipv6 route v1
 ...
 | C   | 4321::2/128   | 0/0    | loopback2    | null      | 00:00:07 |
 | I   | 4321::3/128   | 115/20 | ethernet2.12 | 1234:2::2 | 00:00:06 |
...
r2#show ipv4 segrou v1
 ...
 |------------|-------|--------|---------|
 | 2.2.2.1/32 | 1     | 356997 | 356997  |
 | 2.2.2.3/32 | 3     | 71298  | 71298   |
...
r2#show ipv6 segrou v1
 ...
 | prefix      | index | base   | oldbase |
 |-------------|-------|--------|---------|
 | 4321::1/128 | 1     | 470521 | 470521  |
 | 4321::3/128 | 3     | 25852  | 25852   |
