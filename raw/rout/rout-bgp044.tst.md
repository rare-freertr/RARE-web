# Example: bgp nexthop peer

## **Topology diagram**

![topology](/img/rout-bgp044.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 next-hop-peer
...
router bgp6 1
 ...
 neighbor 1234:1::2 next-hop-peer
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.5 next-hop-peer
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:2::1 next-hop-peer
 redistribute connected
 exit
!
!
