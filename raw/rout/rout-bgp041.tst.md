# Example: bgp remove private as out

## **Topology diagram**

![topology](/img/rout-bgp041.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.1 remove-private-as-out
 ...
 neighbor 1.1.1.6 remove-private-as-out
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 remove-private-as-out
 ...
 neighbor 1234:2::2 remove-private-as-out
 redistribute connected
 exit
!
!
