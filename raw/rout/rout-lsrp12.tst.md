...
![topology](/img/rout-lsrp12.tst.png)
...
r2#show ipv4 lsrp 1 dat
 ...
 |---------|------|-----|-----|-----|----------|----------|
 | 4.4.4.1 | r1   | 1   | 2   | 6   | 722ed93c | 00:59:58 |
 | 4.4.4.2 | r2   | 1   | 2   | 6   | efc4fb78 | 00:59:58 |
...
r2#show ipv6 lsrp 1 dat
 ...
 | id      | name | nei | net | seq | topo     | left     |
 |---------|------|-----|-----|-----|----------|----------|
 | 6.6.6.1 | r1   | 1   | 2   | 7   | 55c2a7bf | 00:59:55 |
 | 6.6.6.2 | r2   | 1   | 2   | 7   | efc4fb78 | 00:59:55 |
 |_________|______|_____|_____|_____|__________|__________|
r2#
r2#
```
