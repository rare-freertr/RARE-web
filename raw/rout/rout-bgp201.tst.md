# Example: evpn/vxlan over bgp auto mesh tunnel

## **Topology diagram**

![topology](/img/rout-bgp201.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 002a.6729.711c
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0058.7870.2325
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 automesh all
 exit
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0032.5315.1d2f
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 automesh all
 exit
...
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0040.522f.452d
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 automesh all
 exit
