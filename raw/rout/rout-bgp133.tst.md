...
router bgp4 1
 ...
 afi-evpn 101 bmac 0035.061a.0c16
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 afi-evpn 102 bridge-group 3
 afi-evpn 102 bmac 003d.3c46.4030
...
router bgp6 1
 ...
 afi-evpn 101 bmac 005e.2576.1b1f
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 afi-evpn 102 bridge-group 4
 afi-evpn 102 bmac 0077.2d03.0016
 afi-evpn 102 encapsulation pbb
 afi-evpn 102 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0005.282c.273d
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 afi-evpn 102 bridge-group 3
 afi-evpn 102 bmac 0054.5355.0469
 afi-evpn 102 encapsulation pbb
 afi-evpn 102 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0030.4b0f.5e67
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source loopback0
 afi-evpn 102 bridge-group 4
 afi-evpn 102 bmac 001b.240c.6f4f
 afi-evpn 102 encapsulation pbb
 afi-evpn 102 update-source loopback0
 exit
!
...
r1#show ipv4 bgp 1 evpn dat
 ...
 |--------------------------|---------|------------|--------|
 | 200::5:282c:273d#:: 1:1  | 2.2.2.2 | 20/100/0/0 | 2      |
 | 200::35:61a:c16#:: 1:1   | 2.2.2.1 | 0/0/0/0    |        |
 | 300:0:65::#2.2.2.2 1:1   | 2.2.2.2 | 20/100/0/0 | 2      |
 | 300:0:65::#2.2.2.1 1:1   | 2.2.2.1 | 0/0/0/0    |        |
 | 200::3d:3c46:4030#:: 1:3 | 2.2.2.1 | 0/0/0/0    |        |
 | 200::54:5355:469#:: 1:3  | 2.2.2.2 | 20/100/0/0 | 2      |
...
r1#show ipv6 bgp 1 evpn dat
 ...
 | prefix                   | hop     | metric     | aspath |
 |--------------------------|---------|------------|--------|
 | 200::30:4b0f:5e67#:: 1:2 | 4321::2 | 20/100/0/0 | 2      |
 | 200::5e:2576:1b1f#:: 1:2 | 4321::1 | 0/0/0/0    |        |
 | 300:0:65::#4321::2 1:2   | 4321::2 | 20/100/0/0 | 2      |
 | 300:0:65::#4321::1 1:2   | 4321::1 | 0/0/0/0    |        |
 | 200::1b:240c:6f4f#:: 1:4 | 4321::2 | 20/100/0/0 | 2      |
 | 200::77:2d03:16#:: 1:4   | 4321::1 | 0/0/0/0    |        |
...
r1#show bridge 1
 ...
 | evpn 2.2.2.2 101 | true | false | 13 | 12 | 0    | 786 | 756 | 0    |     |
 |__________________|______|_______|____|____|______|_____|_____|______|_____|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~|~~~~~|~~~~~~|
 |                                              | packet         | byte             |
 | addr           | iface            | time     | tx | rx | drop | tx  | rx  | drop |
 |----------------|------------------|----------|----|----|------|-----|-----|------|
 | 0000.4d67.785d | bvi              | 00:00:16 | 12 | 15 | 0    | 756 | 846 | 0    |
 | 0057.612b.024c | evpn 2.2.2.2 101 | 00:00:16 | 11 | 12 | 0    | 726 | 756 | 0    |
...
r1#show bridge 2
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
 |----------------|------------------|----------|----|----|------|-----|------|------|
 | 0044.404f.7308 | evpn 4321::2 101 | 00:00:16 | 15 | 15 | 0    | 998 | 1006 | 0    |
 | 004c.0452.3755 | bvi              | 00:00:16 | 14 | 19 | 0    | 932 | 1326 | 0    |
...
r1#show bridge 3
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx   | drop |
 |----------------|------------------|----------|----|----|------|-----|------|------|
 | 0028.1822.2e72 | bvi              | 00:00:16 | 14 | 19 | 0    | 932 | 1326 | 0    |
 | 0055.471e.1c0d | evpn 2.2.2.2 102 | 00:00:16 | 15 | 15 | 0    | 998 | 1006 | 0    |
 |________________|__________________|__________|____|____|______|_____|______|______|
r1#
r1#
```
...
r1#show bridge 4
 ...
 | addr           | iface            | time     | tx | rx | drop | tx  | rx  | drop |
 |----------------|------------------|----------|----|----|------|-----|-----|------|
 | 001b.475f.5c0e | evpn 4321::2 102 | 00:00:16 | 14 | 15 | 0    | 924 | 954 | 0    |
 | 006c.7567.0c31 | bvi              | 00:00:16 | 15 | 15 | 0    | 954 | 954 | 0    |
 |________________|__________________|__________|____|____|______|_____|_____|______|
r1#
r1#
```
