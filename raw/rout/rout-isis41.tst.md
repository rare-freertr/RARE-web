...
r2#show ipv4 isis 1 nei
 ...
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.11 | 0000.0000.0000 | 2     | 4444.0000.1111 | 1.1.1.1    | ::            | 0     | 00:00:18 |
 | ethernet2.11 | 0000.0000.0000 | 2     | 4444.0000.3333 | 1.1.1.6    | ::            | 0     | 00:00:18 |
...
r2#show ipv6 isis 1 nei
 ...
 | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
 |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
 | ethernet1.12 | 0000.0000.0000 | 2     | 6666.0000.1111 | 1234:1::1  | ::            | 0     | 00:00:18 |
 | ethernet2.12 | 0000.0000.0000 | 2     | 6666.0000.3333 | 1234:2::2  | ::            | 0     | 00:00:18 |
 |______________|________________|_______|________________|____________|_______________|_______|__________|
r2#
r2#
```
...
r2#show ipv4 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 0000000a | apo   | 80  | 00:19:50 |
 | 4444.0000.2222.00-00 | 0000000f | apo   | 111 | 00:19:50 |
...
r2#show ipv6 isis 1 dat 2
 ...
 | lspid                | sequence | flags | len | time     |
 |----------------------|----------|-------|-----|----------|
 | 6666.0000.1111.00-00 | 0000000b | apo   | 94  | 00:19:49 |
 | 6666.0000.2222.00-00 | 0000000d | apo   | 126 | 00:19:50 |
 | 6666.0000.3333.00-00 | 0000000b | apo   | 94  | 00:19:50 |
 |______________________|__________|_______|_____|__________|
r2#
r2#
```
...
r2#show ipv4 segrou v1
 ...
 |------------|-------|--------|---------|
 | 2.2.2.1/32 | 1     | 800750 | 800750  |
 | 2.2.2.3/32 | 3     | 757674 | 757674  |
...
r2#show ipv6 segrou v1
 ...
 | prefix      | index | base   | oldbase |
 |-------------|-------|--------|---------|
 | 4321::1/128 | 1     | 45895  | 45895   |
 | 4321::3/128 | 3     | 833796 | 833796  |
