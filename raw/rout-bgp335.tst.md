...
=== "Configuration"
    ...
    **r5:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz16r5-log.run
    !
    vrf definition tester
     exit
    !
    ...
    **r6:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz16r6-log.run
    !
    vrf definition tester
     exit
    !
