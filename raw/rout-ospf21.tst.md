# Example: ospf inter area egress filtering with prefixlist
...
=== "Configuration"
    ...
    **r2:**
    ...
    router ospf6 1
     ...
     traffeng-id ::
     area 0 enable
     area 0 prefix-list-into p6
     area 1 enable
     area 1 prefix-list-into p6
     redistribute connected
     exit
    !
    interface loopback1
...
=== "Verification"
    ...
    r2#show ipv6 ospf 1 dat 0
     ...
     | routerid | lsaid     | sequence | type       | len | time     |
     |----------|-----------|----------|------------|-----|----------|
     | 6.6.6.2  | 580162608 | 80000001 | link       | 24  | 00:00:07 |
     | 6.6.6.2  | 580162609 | 80000002 | link       | 24  | 01:00:07 |
     | 6.6.6.1  | 884593716 | 80000001 | link       | 24  | 00:00:07 |
     ...
     | 6.6.6.2  | 580162608 | 80000001 | prefix     | 20  | 00:00:07 |
     | 6.6.6.2  | 580162609 | 80000002 | prefix     | 20  | 01:00:07 |
     | 6.6.6.1  | 884593716 | 80000001 | prefix     | 20  | 00:00:07 |
    ...
    r2#show ipv4 route v1
     ...
     | O E2 | 2.2.2.11/32 | 110/0  | ethernet1 | 1.1.1.1 | 00:00:04 |
