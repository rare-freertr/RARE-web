...
![topology](/img/rout-bgp191.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 007c.4e68.175e
...
router bgp6 1
 ...
 afi-evpn 101 bmac 0049.3f22.7b64
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 bmac 0043.0a28.7a77
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
router bgp6 1
 ...
 afi-evpn 101 bridge-group 2
 afi-evpn 101 bmac 0012.136e.5755
 afi-evpn 101 encapsulation vxlan
 afi-evpn 101 update-source loopback0
 exit
!
