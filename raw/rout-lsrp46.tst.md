# Example: lsrp dynamic udp metric
...
=== "Configuration"
    ...
    **r2:**
    ...
    interface ethernet1
     ...
     router lsrp4 1 enable
     router lsrp4 1 dynamic-metric udpecho
     router lsrp4 1 metric 2
     router lsrp6 1 enable
     router lsrp6 1 dynamic-metric udpecho
...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     | 4.4.4.2 | r2   | 2   | 3   | 13  | d5b4940a | 00:59:59 |
    ...
    r2#show ipv6 route v1
     ...
     | L EX | 4321::1/128 | 70/2   | ethernet1 | 1234::1 | 00:00:01 |
