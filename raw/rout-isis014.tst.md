...
=== "Configuration"
    ...
    **r5:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz51r5-log.run
    !
    vrf definition tester
     exit
    !
    ...
    **r6:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz51r6-log.run
    !
    vrf definition tester
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 nei
     ...
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.11 | 0000.0000.0000 | 1     | 4444.0000.1111 | 1.1.1.1    | ::            | up    | 00:00:23 |
    ...
    r2#show ipv6 isis 1 nei
     ...
     | interface    | mac address    | level | routerid       | ip address | other address | state | uptime   |
     |--------------|----------------|-------|----------------|------------|---------------|-------|----------|
     | ethernet1.12 | 0000.0000.0000 | 1     | 6666.0000.1111 | 1234:1::1  | ::            | up    | 00:00:24 |
     | ethernet2.12 | 0000.0000.0000 | 1     | 6666.0000.3333 | 1234:2::2  | ::            | down  | 00:00:23 |
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     | 4444.0000.3333.00-00 | 0000000b | apo   | 101 | 00:19:34 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.2222.00-00 | 0000000a | apo   | 96  | 00:19:35 |
     | 6666.0000.3333.00-00 | 0000000a | apo   | 144 | 00:19:34 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | I   | 1.1.1.16/30 | 115/40 | ethernet2.11 | 1.1.1.6 | 00:00:25 |
     | I   | 2.2.2.1/32  | 115/10 | ethernet1.11 | 1.1.1.1 | 00:00:25 |
     ...
     | I   | 2.2.2.5/32  | 115/30 | ethernet2.11 | 1.1.1.6 | 00:00:25 |
    ...
    r2#show ipv6 route v1
     ...
     | C    | 1234:2::/32   | 0/0    | ethernet2.12 | null      | 00:00:35 |
     | LOC  | 1234:2::1/128 | 0/1    | ethernet2.12 | null      | 00:00:35 |
     ...
     | I EX | 4321::1/128   | 115/10 | ethernet1.12 | 1234:1::1 | 00:00:25 |
