# Example: evpn/vpws over srv6 over bgp route server

## **Topology diagram**

![topology](/img/rout-bgp395.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 006d.370d.0979
...
router bgp6 1
 ...
 afi-evpn 102 bmac 007e.0604.3028
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 srv6 tunnel1
 afi-evpn 101 bmac 005a.370d.224c
 afi-evpn 101 encapsulation vpws
 afi-evpn 101 update-source ethernet1
 exit
!
router bgp6 1
 ...
 afi-evpn 102 bridge-group 2
 afi-evpn 102 srv6 tunnel1
 afi-evpn 102 bmac 0021.3b34.157b
 afi-evpn 102 encapsulation vpws
 afi-evpn 102 update-source ethernet1
 exit
!
