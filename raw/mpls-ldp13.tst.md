...
r3#show mpls forw
 ...
 |--------|------|-------|------|------------|---------|-------|
 | 184469 | v1:6 | null  | null | unlabelled | local   | 1120  |
 | 501815 | v1:6 | null  | null | unlabelled | local   | 0     |
 | 566323 | v1:4 | null  | null | unlabelled | local   | 1104  |
 | 715882 | v1:4 | null  | null | unlabelled | local   | 0     |
...
r3#show ipv4 ldp v1 mpdat
 ...
 |------|---------|----------------------|---------|-------------------------|
 | p2mp | 2.2.2.1 | 01 00 04 00 00 04 d2 | 1.1.2.1 | local 566323/1.1.2.1/-1 |
...
r3#show ipv6 ldp v1 mpdat
 ...
 | type | root    | opaque               | uplink    | peers                     |
 |------|---------|----------------------|-----------|---------------------------|
 | p2mp | 4321::1 | 01 00 04 00 00 04 d2 | 1234:2::1 | local 184469/1234:2::1/-1 |
...
r3#show inter tun2 full
tunnel2 is up (since 00:00:18, 1 changes)
 description:
 type is p2mpldp, hwaddr=none, mtu=1500, bw=8000kbps, vrf=v1
