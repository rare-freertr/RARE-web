...
r1#show ipv4 bgp 1 sum
 ...
 |----|---------|-------|----------|----------|
 | 2  | ovpnuni | true  | 2.2.2.2  | 00:00:03 |
...
r1#show ipv6 bgp 1 sum
 ...
 | as | afis    | ready | neighbor | uptime   |
 |----|---------|-------|----------|----------|
 | 2  | ovpnuni | true  | 4321::2  | 00:00:06 |
 |____|_________|_______|__________|__________|
r1#
r1#
```
...
r1#show ipv4 route v1
 ...
 | LOC | 1.1.1.1/32 | 0/1    | ethernet1 | null    | 00:00:06 |
...
r1#show ipv6 route v1
 ...
 | S   | 4321::2/128   | 1/0    | ethernet1 | 1234:1::2 | 00:00:13 |
...
r1#show ipv4 route v2
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | C   | 9.9.2.1/32 | 0/0    | loopback2 | null    | 00:00:07 |
 | B   | 9.9.2.2/32 | 20/0   | null@v1:6 | 0.0.0.2 | 00:00:07 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv6 route v2
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | C   | 9992::1/128 | 0/0    | loopback2 | null    | 00:00:03 |
 | B   | 9992::2/128 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:03 |
...
r1#show ipv4 route v3
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | C   | 9.9.3.1/32 | 0/0    | loopback3 | null    | 00:00:06 |
 | B   | 9.9.3.2/32 | 20/0   | null@v1:6 | 0.0.0.2 | 00:00:06 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv4 route v4
 ...
 | B   | 9.9.4.2/32 | 20/0   | null@v1:6 | 0.0.0.2 | 00:00:07 |
 |_____|____________|________|___________|_________|__________|
r1#
r1#
```
...
r1#show ipv6 route v4
 ...
 | typ | prefix      | metric | iface     | hop     | time     |
 |-----|-------------|--------|-----------|---------|----------|
 | C   | 9994::1/128 | 0/0    | loopback4 | null    | 00:00:04 |
 | B   | 9994::2/128 | 20/0   | null@v1:4 | 2.2.2.2 | 00:00:04 |
 |_____|_____________|________|___________|_________|__________|
r1#
r1#
```
