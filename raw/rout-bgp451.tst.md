# Example: ouni bgp ingress route filtering with routemap with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp451.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 other-route-map-in p6
 afi-other enable
...
router bgp6 1
 ...
 neighbor 1234:1::2 other-route-map-in p4
 afi-other enable
 no afi-other vpn-mode
 afi-other redistribute connected
 exit
