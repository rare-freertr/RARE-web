...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer    | learned | adverted | uptime   |
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::1 | 1       | 3        | 00:00:21 |
 |___________|_________|______|___________|_________|_________|__________|__________|
r2#
r2#
```
...
r2#show ipv6 pvrp 1 rou
 ...
 | typ  | prefix      | metric | iface     | hop     | time     |
 |------|-------------|--------|-----------|---------|----------|
 | C    | 1234::/16   | 1/0    | ethernet1 | null    | 00:00:17 |
 | null | 4321::1/128 | 80/10  | ethernet1 | 1234::1 | 00:00:17 |
...
r2#show ipv4 route v1
 ...
 | C    | 2.2.2.3/32 | 0/0    | loopback1 | null    | 00:00:22 |
 | C    | 2.2.2.4/32 | 0/0    | loopback2 | null    | 00:00:22 |
 |______|____________|________|___________|_________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | C    | 4321::3/128 | 0/0    | loopback1 | null    | 00:00:22 |
 | C    | 4321::4/128 | 0/0    | loopback2 | null    | 00:00:22 |
 |______|_____________|________|___________|_________|__________|
r2#
r2#
```
