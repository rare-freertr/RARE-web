# Example: unicast+flowspec over bgp with additional path

## **Topology diagram**

![topology](/img/rout-bgp187.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 address-family unicast flowspec
 neighbor 1.1.1.2 distance 20
 neighbor 1.1.1.2 additional-path-rx unicast flowspec
 neighbor 1.1.1.2 additional-path-tx unicast flowspec
...
router bgp6 1
 ...
 neighbor 1234:1::2 additional-path-rx unicast flowspec
 neighbor 1234:1::2 additional-path-tx unicast flowspec
...
router bgp4 1
 ...
 neighbor 1.1.1.1 address-family unicast flowspec
 neighbor 1.1.1.1 distance 20
 neighbor 1.1.1.1 additional-path-rx unicast flowspec
 neighbor 1.1.1.1 additional-path-tx unicast flowspec
...
router bgp6 1
 ...
 neighbor 1234:1::1 address-family unicast flowspec
 neighbor 1234:1::1 distance 20
 neighbor 1234:1::1 additional-path-rx unicast flowspec
 neighbor 1234:1::1 additional-path-tx unicast flowspec
