# Example: integrated isis inter level ingress filtering with routepolicy
...
=== "Configuration"
    ...
    **r2:**
    ...
    router isis6 1
     ...
     level2 other-route-policy-from p4
     level1 route-policy-from p6
     level1 other-route-policy-from p4
     afi-other enable
     afi-other redistribute connected
     redistribute connected
     exit
...
=== "Verification"
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000011 | apo   | 118 | 00:19:40 |
     | 6666.0000.2222.00-00 | 00000015 | apo   | 176 | 00:19:53 |
