...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 4        | 00:00:08 |
     | ethernet2 | 4.4.4.3 | r3   | ethernet1 | 1.1.1.6 | 2       | 3        | 00:00:08 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 2       | 4        | 00:00:08 |
     | ethernet2 | 6.6.6.3 | r3   | ethernet1 | 1234:2::2 | 2       | 3        | 00:00:08 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | null | 1.1.1.8/30 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:01 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | null | 1234:3::/32 | 80/10  | ethernet1 | 1234:1::1 | 00:00:06 |
    ...
    r2#show ipv4 route v1
     ...
     | P    | 1.1.1.8/30 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:05 |
     | P EX | 2.2.2.1/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:02 |
     | C    | 2.2.2.2/32 | 0/0    | loopback1 | null    | 00:00:14 |
     | P EX | 2.2.2.3/32 | 80/10  | ethernet2 | 1.1.1.6 | 00:00:05 |
     |______|____________|________|___________|_________|__________|
    r2#
    r2#
    ```
