# Example: bgp vpns aggregation

## **Topology diagram**

![topology](/img/rout-bgp505.tst.png)
...
router bgp4 1
 ...
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 aggregate 9.9.2.0/24
 afi-vrf v3 enable
 afi-vrf v3 redistribute connected
 afi-vrf v3 aggregate 9.9.3.0/24
 afi-vrf v4 enable
 afi-vrf v4 redistribute connected
 afi-vrf v4 aggregate 9.9.4.0/24
 exit
!
router bgp6 1
 vrf v1
 ...
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v2 aggregate 9992::/32
 afi-vrf v3 enable
 afi-vrf v3 redistribute connected
 afi-vrf v3 aggregate 9993::/32
 afi-vrf v4 enable
 afi-vrf v4 redistribute connected
 afi-vrf v4 aggregate 9994::/32
 exit
!
!
!
