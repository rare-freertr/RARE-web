...
![topology](/img/rout-lsrp11.tst.png)
...
r2#show ipv4 lsrp 1 nei
 ...
 |-----------|---------|------|-----------|---------|-------|----------|
 | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.1.5 | true  | 00:00:10 |
...
r2#show ipv6 lsrp 1 nei
 ...
 | iface     | router  | name | peerif    | peer      | ready | uptime   |
 |-----------|---------|------|-----------|-----------|-------|----------|
 | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1234:2::1 | true  | 00:00:10 |
...
r2#show ipv4 lsrp 1 dat
 ...
 |---------|------|-----|-----|-----|----------|----------|
 | 4.4.4.1 | r1   | 1   | 3   | 11  | a0f51ac5 | 00:59:59 |
 | 4.4.4.2 | r2   | 1   | 2   | 12  | d7f22a53 | 00:59:59 |
...
r2#show ipv6 lsrp 1 dat
 ...
 | id      | name | nei | net | seq | topo     | left     |
 |---------|------|-----|-----|-----|----------|----------|
 | 6.6.6.1 | r1   | 1   | 3   | 11  | a0f51ac5 | 00:59:59 |
 | 6.6.6.2 | r2   | 1   | 2   | 13  | d7f22a53 | 00:59:58 |
 |_________|______|_____|_____|_____|__________|__________|
r2#
r2#
```
...
r2#show ipv4 route v1
 ...
 |------|------------|--------|-----------|---------|----------|
 | L    | 1.1.1.0/30 | 70/100 | ethernet2 | 1.1.1.5 | 00:00:01 |
 | C    | 1.1.1.4/30 | 0/0    | ethernet2 | null    | 00:00:16 |
 | LOC  | 1.1.1.6/32 | 0/1    | ethernet2 | null    | 00:00:16 |
 | L EX | 2.2.2.1/32 | 70/100 | ethernet2 | 1.1.1.5 | 00:00:01 |
...
r2#show ipv6 route v1
 ...
 | typ  | prefix        | metric | iface     | hop       | time     |
 |------|---------------|--------|-----------|-----------|----------|
 | L    | 1234:1::/32   | 70/100 | ethernet2 | 1234:2::1 | 00:00:01 |
 | C    | 1234:2::/32   | 0/0    | ethernet2 | null      | 00:00:16 |
 | LOC  | 1234:2::2/128 | 0/1    | ethernet2 | null      | 00:00:16 |
 | L EX | 4321::1/128   | 70/100 | ethernet2 | 1234:2::1 | 00:00:01 |
