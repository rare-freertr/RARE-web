# Example: lsrp point2point connection

## **Topology diagram**

![topology](/img/rout-lsrp01.tst.png)
...
r2#show ipv4 lsrp 1 dat
 ...
 |---------|------|-----|-----|-----|----------|----------|
 | 4.4.4.1 | r1   | 1   | 2   | 7   | bf1864f4 | 00:59:59 |
...
r2#show ipv6 lsrp 1 dat
 ...
 | id      | name | nei | net | seq | topo     | left     |
 |---------|------|-----|-----|-----|----------|----------|
 | 6.6.6.1 | r1   | 1   | 2   | 7   | 58f0e2a5 | 00:59:52 |
 | 6.6.6.2 | r2   | 1   | 2   | 7   | f141cf47 | 00:59:52 |
 |_________|______|_____|_____|_____|__________|__________|
r2#
r2#
```
