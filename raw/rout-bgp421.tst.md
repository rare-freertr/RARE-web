# Example: bgp routepolicy filtering with peer standard community with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp421.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.3 route-policy-out rm1
...
router bgp6 1
 ...
 neighbor 1234:1::2 route-policy-out rm1
 ...
 neighbor 1234:1::3 route-policy-out rm1
 redistribute connected
 exit
!
!
