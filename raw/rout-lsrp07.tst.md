# Example: lsrp route filtering with routemap
...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 1   | 4   | 11  | 49510c26 | 00:59:56 |
     | 4.4.4.2 | r2   | 1   | 4   | 8   | b8c7b5af | 00:59:56 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 1   | 4   | 11  | 567bc1c1 | 00:59:58 |
     | 6.6.6.2 | r2   | 1   | 4   | 9   | b8c7b5af | 00:59:58 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L EX | 2.2.2.11/32 | 70/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
     | C    | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:12 |
     | L EX | 2.2.2.21/32 | 70/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
