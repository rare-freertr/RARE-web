# Example: bgp extended open

## **Topology diagram**

![topology](/img/rout-bgp516.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 extended-open
...
router bgp6 1
 ...
 neighbor 1234:1::2 extended-open
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 extended-open
 ...
 neighbor 1.1.1.6 extended-open
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 extended-open
 ...
 neighbor 1234:2::2 extended-open
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 extended-open
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 extended-open
 redistribute connected
 exit
!
!
