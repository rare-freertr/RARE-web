# Example: unicast+vpls/ldp cw over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp581.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.2 additional-path-rx unicast vpls
 neighbor 2.2.2.2 additional-path-tx unicast vpls
...
router bgp6 1
 ...
 neighbor 4321::2 additional-path-rx unicast vpls
 neighbor 4321::2 additional-path-tx unicast vpls
...
router bgp4 1
 ...
 neighbor 2.2.2.1 additional-path-rx unicast vpls
 neighbor 2.2.2.1 additional-path-tx unicast vpls
...
router bgp6 1
 ...
 neighbor 4321::1 additional-path-rx unicast vpls
 neighbor 4321::1 additional-path-tx unicast vpls
