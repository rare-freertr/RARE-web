# Example: rip address unsuppression
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface loopback1
     ...
     router rip4 1 enable
     router rip4 1 unsuppress-prefix
     router rip6 1 enable
     router rip6 1 unsuppress-prefix
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 rip 1 dat
     ...
     | R   | 2.2.2.11/32 | 120/1  | ethernet1 | 1.1.1.1 | 00:00:08 |
    ...
    r2#show ipv6 rip 1 dat
     ...
     | R   | 4321::11/128 | 120/1  | ethernet1 | 1234:1::1 | 00:00:08 |
    ...
    r2#show ipv6 route v1
     ...
     | R   | 4321::11/128  | 120/1  | ethernet1 | 1234:1::1 | 00:00:09 |
     | C   | 4321::12/128  | 0/0    | loopback1 | null      | 00:00:38 |
     | C   | 4321::22/128  | 0/0    | loopback2 | null      | 00:00:38 |
