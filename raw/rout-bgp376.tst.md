# Example: evpn/pbb over srv6 over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp376.tst.png)
...
router bgp4 1
 ...
 afi-evpn 101 bmac 0027.0159.4758
...
router bgp6 1
 ...
 afi-evpn 102 bmac 0062.135a.4a0d
...
router bgp4 1
 ...
 afi-evpn 101 bridge-group 1
 afi-evpn 101 srv6 tunnel1
 afi-evpn 101 bmac 0055.007d.4151
 afi-evpn 101 encapsulation pbb
 afi-evpn 101 update-source ethernet1
 exit
!
router bgp6 1
 ...
 afi-evpn 102 bridge-group 2
 afi-evpn 102 srv6 tunnel1
 afi-evpn 102 bmac 0033.0f5c.284a
 afi-evpn 102 encapsulation pbb
 afi-evpn 102 update-source ethernet1
 exit
!
