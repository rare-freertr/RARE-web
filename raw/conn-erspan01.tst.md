...
=== "Verification"
    ...
    r2#show bridge 1
     ...
     | erspan to 1.1.1.1 | true | false | 28 | 27 | 0    | 1868 | 2118 | 0    |     |
     |___________________|______|_______|____|____|______|______|______|______|_____|
     |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~|~~~~|~~~~~~|~~~~~~|~~~~~~|~~~~~~|
     |                                               | packet         | byte               |
     | addr           | iface             | time     | tx | rx | drop | tx   | rx   | drop |
     |----------------|-------------------|----------|----|----|------|------|------|------|
     | 004e.2d64.5067 | erspan to 1.1.1.1 | 00:00:05 | 25 | 27 | 0    | 1614 | 1794 | 0    |
     | 0078.4d21.286b | bvi               | 00:00:05 | 24 | 28 | 0    | 1584 | 1868 | 0    |
    ...
    bvi1 is up (since 00:00:05, 3 changes)
     description:
     type is bridged, hwaddr=0078.4d21.286b, mtu=1400, bw=10mbps, vrf=v1
     ip4 address=2.2.2.2/24, netmask=255.255.255.0, ifcid=546499060
     ip6 address=4321::2/16, netmask=ffff::, ifcid=164114116
    ...
    r2#show ipv4 arp bvi1
     ...
     |----------------|---------|----------|--------|
     | 004e.2d64.5067 | 2.2.2.1 | 00:00:04 | false  |
    ...
    r2#show ipv6 neigh bvi1
     ...
     |----------------|--------------------------|----------|--------|--------|
     | 004e.2d64.5067 | 4321::1                  | 00:00:04 | false  | false  |
     | 004e.2d64.5067 | fe80::24e:2dff:fe64:5067 | 00:00:05 | false  | true   |
