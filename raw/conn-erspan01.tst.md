...
r2#show bridge 1
 ...
 |-------------------|---------|----------|------|------|------|
 | bvi               | true    | true     | 0    | 0    | 0    |
 | erspan to 1.1.1.1 | true    | false    | 2646 | 2970 | 0    |
 |___________________|_________|__________|______|______|______|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~~~~~~~~~|~~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 | address        | interface         | time     | tx   | rx   | drop |
 |----------------|-------------------|----------|------|------|------|
 | 000e.6632.5b60 | bvi               | 00:00:00 | 2362 | 2646 | 0    |
 | 006c.6a0f.462e | erspan to 1.1.1.1 | 00:00:00 | 2392 | 2646 | 0    |
 |________________|___________________|__________|______|______|______|
r2#
r2#
```
...
bvi1 is up (since 00:00:04, 1 changes)
 description:
 type is bridged, hwaddr=000e.6632.5b60, mtu=1400, bw=10mbps, vrf=v1
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 006c.6a0f.462e | 2.2.2.1 | 00:00:04 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|--------------------------|----------|--------|--------|
 | 006c.6a0f.462e | 4321::1                  | 00:00:04 | false  | false  |
 | 006c.6a0f.462e | fe80::26c:6aff:fe0f:462e | 00:00:04 | false  | true   |
