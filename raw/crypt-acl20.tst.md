# Example: egress destination matching hibryd access list

## **Topology diagram**

![topology](/img/crypt-acl20.tst.png)
...
!
access-list test4
 sequence 10 deny all any all obj test4 all
 sequence 20 permit all any all any all
 exit
!
access-list test6
 sequence 10 deny all any all obj test6 all
 sequence 20 permit all any all any all
 exit
!
vrf definition v1
