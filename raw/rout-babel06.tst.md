# Example: babel egress route filtering with routemap

## **Topology diagram**

![topology](/img/rout-babel06.tst.png)
...
interface ethernet1
 ...
 router babel4 1 route-map-out p4
 router babel6 1 enable
 router babel6 1 route-map-out p6
 no shutdown
 no log-link-change
 exit
!
