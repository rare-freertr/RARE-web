# Example: pvrp dynamic udp metric

## **Topology diagram**

![topology](/img/rout-pvrp46.tst.png)
...
interface ethernet1
 ...
 router pvrp4 1 enable
 router pvrp4 1 dynamic-metric udpecho
 router pvrp4 1 metric-in 2
 router pvrp6 1 enable
 router pvrp6 1 dynamic-metric udpecho
...
r2#show ipv4 pvrp 1 sum
 ...
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 2       | 2        | 00:00:08 |
 | ethernet2 | 4.4.4.1 | r1   | ethernet2 | 1.1.2.1 | 2       | 3        | 00:00:08 |
...
r2#show ipv6 pvrp 1 sum
 ...
 | iface     | router  | name | peerif    | peer    | learned | adverted | uptime   |
 |-----------|---------|------|-----------|---------|---------|----------|----------|
 | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234::1 | 2       | 2        | 00:00:08 |
 | ethernet2 | 6.6.6.1 | r1   | ethernet2 | 1235::1 | 2       | 3        | 00:00:08 |
 |___________|_________|______|___________|_________|_________|__________|__________|
r2#
r2#
```
...
r2#show ipv6 pvrp 1 rou
 ...
 | null | 4321::1/128 | 80/2   | ethernet1 | 1234::1 | 00:00:04 |
...
r2#show ipv6 route v1
 ...
 | P EX | 4321::1/128 | 80/2   | ethernet1 | 1234::1 | 00:00:05 |
