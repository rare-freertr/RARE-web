...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |-----------|---------|------|-----------|---------|---------|----------|----------|
     | ethernet1 | 4.4.4.1 | r1   | ethernet1 | 1.1.1.1 | 3       | 3        | 00:00:07 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface     | router  | name | peerif    | peer      | learned | adverted | uptime   |
     |-----------|---------|------|-----------|-----------|---------|----------|----------|
     | ethernet1 | 6.6.6.1 | r1   | ethernet1 | 1234:1::1 | 3       | 3        | 00:00:07 |
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | C    | 2.2.2.2/32  | 2/0    | loopback0 | null    | 00:00:13 |
     | null | 2.2.2.11/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
     | C    | 2.2.2.12/32 | 2/0    | loopback1 | null    | 00:00:13 |
     | null | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
     | C    | 2.2.2.22/32 | 2/0    | loopback2 | null    | 00:00:13 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | C    | 4321::2/128  | 2/0    | loopback0 | null      | 00:00:13 |
     | null | 4321::11/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:06 |
     | C    | 4321::12/128 | 2/0    | loopback1 | null      | 00:00:13 |
     | null | 4321::21/128 | 80/10  | ethernet1 | 1234:1::1 | 00:00:06 |
     | C    | 4321::22/128 | 2/0    | loopback2 | null      | 00:00:13 |
    ...
    r2#show ipv4 route v1
     ...
     | P EX | 2.2.2.11/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
     | C    | 2.2.2.12/32 | 0/0    | loopback1 | null    | 00:00:13 |
     | P EX | 2.2.2.21/32 | 80/10  | ethernet1 | 1.1.1.1 | 00:00:04 |
    ...
    r2#show ipv6 route v1
     ...
     | P EX | 4321::11/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:06 |
     | C    | 4321::12/128  | 0/0    | loopback1 | null      | 00:00:13 |
     | P EX | 4321::21/128  | 80/10  | ethernet1 | 1234:1::1 | 00:00:06 |
