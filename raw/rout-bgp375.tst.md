# Example: vpns over srv6 over bgp additional path

## **Topology diagram**

![topology](/img/rout-bgp375.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 additional-path-rx vpnuni ovpnuni
 neighbor 1.1.1.2 additional-path-tx vpnuni ovpnuni
...
router bgp6 1
 ...
 neighbor 1234::2 additional-path-rx vpnuni ovpnuni
 neighbor 1234::2 additional-path-tx vpnuni ovpnuni
...
router bgp4 1
 ...
 neighbor 1.1.1.1 additional-path-rx vpnuni ovpnuni
 neighbor 1.1.1.1 additional-path-tx vpnuni ovpnuni
...
router bgp6 1
 ...
 neighbor 1234::1 additional-path-rx vpnuni ovpnuni
 neighbor 1234::1 additional-path-tx vpnuni ovpnuni
