# Example: bgp routemap filtering with rd with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp316.tst.png)
...
router bgp4 1
 ...
 neighbor 2.2.2.3 route-map-vin rm1
 afi-vrf v2 enable
...
router bgp6 1
 ...
 neighbor 4321::3 route-map-vin rm1
 afi-vrf v2 enable
 afi-vrf v2 redistribute connected
 afi-vrf v3 enable
 afi-vrf v3 redistribute connected
