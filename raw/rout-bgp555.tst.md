# Example: bgp othervpns change in metric

## **Topology diagram**

![topology](/img/rout-bgp555.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.1 ovpn-route-map-in rm1
 afi-ovrf v2 enable
 afi-ovrf v2 redistribute connected
 afi-ovrf v3 enable
 afi-ovrf v3 redistribute connected
...
router bgp6 1
 ...
 neighbor 1234:1::1 ovpn-route-map-in rm1
 afi-ovrf v2 enable
 afi-ovrf v2 redistribute connected
 afi-ovrf v3 enable
 afi-ovrf v3 redistribute connected
...
router bgp4 1
 ...
 afi-ovrf v3 redistribute connected
 afi-ovrf v4 enable
 afi-ovrf v4 redistribute connected route-map rm1
 exit
!
router bgp6 1
 vrf v1
