# Example: ouni bgp ingress route filtering with routepolicy with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp455.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 other-route-policy-in p6
 afi-other enable
...
router bgp6 1
 ...
 neighbor 1234:1::2 other-route-policy-in p4
 afi-other enable
 no afi-other vpn-mode
 afi-other redistribute connected
 exit
