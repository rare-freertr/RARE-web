...
r1#show ipv4 bgp 1 sum
 ...
 |----|---------|-------|----------|----------|
 | 1  | unicast | true  | 1.1.1.2  | 00:00:34 |
 | 1  | unicast | true  | 1.1.1.3  | 00:00:32 |
 | 1  | unicast | true  | 1.1.1.4  | 00:00:12 |
...
r1#show ipv6 bgp 1 sum
 ...
 | as | afis    | ready | neighbor  | uptime   |
 |----|---------|-------|-----------|----------|
 | 1  | unicast | true  | 1234:1::2 | 00:00:19 |
 | 1  | unicast | true  | 1234:1::3 | 00:00:17 |
 | 1  | unicast | true  | 1234:1::4 | 00:00:32 |
...
r1#show ipv4 bgp 1 group
 ...
 |----|-------|----------|----------|
 | 1  | 0     | 1.1.1.2  | 00:00:35 |
 | 1  | 0     | 1.1.1.3  | 00:00:33 |
 | 1  | 0     | 1.1.1.4  | 00:00:13 |
...
r1#show ipv6 bgp 1 group
 ...
 | as | group | neighbor  | uptime   |
 |----|-------|-----------|----------|
 | 1  | 0     | 1234:1::2 | 00:00:20 |
 | 1  | 0     | 1234:1::3 | 00:00:18 |
 | 1  | 0     | 1234:1::4 | 00:00:33 |
...
r1#show ipv4 bgp 1 best
 ...
 | version         | 10                                 |
 | full run        | 6 times                            |
 | full last       | 2020-01-15 09:06:43 (00:00:13 ago) |
 | full time       | 0 ms                               |
 | incr run        | 3 times                            |
 | incr last       | 2020-01-15 09:06:44 (00:00:12 ago) |
 | incr time       | 0 ms                               |
 | changes         | 2, total=6                         |
 | rpki table      | 0                                  |
...
r1#show ipv6 bgp 1 best
 ...
 | version         | 10                                 |
 | full run        | 6 times                            |
 | full last       | 2020-01-15 09:06:38 (00:00:19 ago) |
 | full time       | 1 ms                               |
 | incr run        | 3 times                            |
 | incr last       | 2020-01-15 09:06:38 (00:00:19 ago) |
 | incr time       | 0 ms                               |
 | changes         | 2, total=6                         |
 | rpki table      | 0                                  |
 | unicast table   | 3, list=0                          |
...
r1#show ipv4 route v1
 ...
 | B   | 2.2.2.2/32 | 200/0  | ethernet1 | 1.1.1.2 | 00:00:35 |
 | B   | 2.2.2.3/32 | 200/0  | ethernet1 | 1.1.1.3 | 00:00:33 |
 | B   | 2.2.2.4/32 | 200/0  | ethernet1 | 1.1.1.4 | 00:00:14 |
...
r1#show ipv6 route v1
 ...
 | B   | 4321::2/128   | 200/0  | ethernet1 | 1234:1::2 | 00:00:21 |
 | B   | 4321::3/128   | 200/0  | ethernet1 | 1234:1::3 | 00:00:19 |
 | B   | 4321::4/128   | 200/0  | ethernet1 | 1234:1::4 | 00:00:34 |
