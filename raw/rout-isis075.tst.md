# Example: integrated isis inter level ingress filtering with prefixlist

## **Topology diagram**

![topology](/img/rout-isis075.tst.png)
...
router isis6 1
 ...
 traffeng-id ::
 is-type both
 level2 prefix-list-from p6
 level2 other-prefix-list-from p4
 level1 prefix-list-from p6
 level1 other-prefix-list-from p4
 afi-other enable
 afi-other redistribute connected
 redistribute connected
 exit
...
r2#show ipv6 isis 1 nei
 ...
 | ethernet2 | 0000.0000.0000 | 1     | 4444.0000.3333 | 1234:2::2  | 1.1.1.6       | up    | 00:00:20 |
...
r2#show ipv6 isis 1 dat 2
 ...
 |----------------------|----------|-------|-----|----------|
 | 4444.0000.1111.00-00 | 00000011 | apo   | 118 | 00:19:48 |
 | 6666.0000.2222.00-00 | 00000015 | apo   | 176 | 00:19:48 |
