# Example: babel egress route filtering with routepolicy
...
=== "Configuration"
    ...
    **r1:**
    ...
    interface ethernet1
     ...
     router babel6 1 route-policy-out p6
     no shutdown
     no log-link-change
     exit
    !
...
=== "Verification"
    ...
    r2#show ipv4 babel 1 dat
     ...
     | A   | 2.2.2.1/32  | 130/100 | ethernet1 | 1.1.1.1 | 00:00:06 |
     | A   | 2.2.2.21/32 | 130/100 | ethernet1 | 1.1.1.1 | 00:00:06 |
    ...
    r2#show ipv6 babel 1 dat
     ...
     | A   | 4321::1/128  | 130/100 | ethernet1 | 1234:1::1 | 00:00:07 |
     | A   | 4321::21/128 | 130/100 | ethernet1 | 1234:1::1 | 00:00:07 |
    ...
    r2#show ipv4 route v1
     ...
     | A   | 2.2.2.1/32  | 130/100 | ethernet1 | 1.1.1.1 | 00:00:07 |
     | C   | 2.2.2.2/32  | 0/0     | loopback0 | null    | 00:00:28 |
     | C   | 2.2.2.12/32 | 0/0     | loopback1 | null    | 00:00:28 |
     | A   | 2.2.2.21/32 | 130/100 | ethernet1 | 1.1.1.1 | 00:00:07 |
     | C   | 2.2.2.22/32 | 0/0     | loopback2 | null    | 00:00:27 |
     |_____|_____________|_________|___________|_________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv6 route v1
     ...
     | typ | prefix        | metric  | iface     | hop       | time     |
     |-----|---------------|---------|-----------|-----------|----------|
     | C   | 1234:1::/32   | 0/0     | ethernet1 | null      | 00:00:28 |
     ...
     | A   | 4321::21/128  | 130/100 | ethernet1 | 1234:1::1 | 00:00:07 |
     | C   | 4321::22/128  | 0/0     | loopback2 | null      | 00:00:28 |
