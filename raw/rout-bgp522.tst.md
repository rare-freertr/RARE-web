# Example: bgp leak prevention with route server

## **Topology diagram**

![topology](/img/rout-bgp522.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 role provider
...
router bgp6 1
 ...
 neighbor 1234:1::2 role provider
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.1 role customer
 ...
 neighbor 1.1.1.6 role ix-server
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:1::1 role customer
 ...
 neighbor 1234:2::2 role ix-server
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.5 role ix-client
 ...
 neighbor 1.1.1.10 role ix-client
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:2::1 role ix-client
 ...
 neighbor 1234:3::2 role ix-client
 redistribute connected
 exit
!
!
...
router bgp4 1
 ...
 neighbor 1.1.1.9 role ix-server
 redistribute connected
 exit
!
router bgp6 1
 ...
 neighbor 1234:3::1 role ix-server
 redistribute connected
 exit
!
!
