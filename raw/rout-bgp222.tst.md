# Example: bgp change in large community with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp222.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.4 send-community all
...
router bgp6 1
 ...
 neighbor 1234:1::4 send-community all
 redistribute connected
 exit
!
!
...
route-map rm1
 ...
 sequence 10 match lrgcomm 1:1234:5000
 !
...
route-map rm1
 ...
 sequence 10 set lrgcomm 1:1234:1000
 !
 exit
!
bridge 1
...
route-map rm1
 sequence 10 action deny
 sequence 10 match lrgcomm 1:1234:3000
 !
 sequence 20 action permit
 !
 exit
