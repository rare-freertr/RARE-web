# Example: llcudp over ipv4

## **Topology diagram**

![topology](/img/conn-llcudp01.tst.png)
...
r2#show bridge 1
 ...
 |-------------------|------|-------|----|----|------|------|------|------|-----|
 | brprt bvi         |      |       |    |    |      |      |      |      |     |
 | llcudp to 1.1.1.1 | true | false | 33 | 31 | 0    | 2206 | 2390 | 0    |     |
 ...
 |----------------|-------------------|--------|----------|----|----|------|------|------|------|
 | 0015.0926.7c70 | llcudp to 1.1.1.1 | false  | 00:00:05 | 29 | 31 | 0    | 1878 | 2018 | 0    |
 | 006c.463a.6e4d | bvi               | false  | 00:00:05 | 30 | 33 | 0    | 1988 | 2206 | 0    |
...
bvi1 is up
 description:
 state changed 3 times, last at 2022-05-02 21:08:25, 00:00:05 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is bridged, hwaddr=006c.463a.6e4d, mtu=1400, bw=4000kbps, vrf=v1
 ipv4 address=2.2.2.2/24, mask=255.255.255.0, ifcid=198542670
 ipv6 address=4321::2/16, mask=ffff::, ifcid=251415910
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0015.0926.7c70 | 2.2.2.1 | 00:00:05 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|---------|----------|--------|--------|
 | 0015.0926.7c70 | 4321::1 | 00:00:05 | false  | false  |
