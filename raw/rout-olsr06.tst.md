# Example: olsr egress route filtering with routemap

## **Topology diagram**

![topology](/img/rout-olsr06.tst.png)
...
interface ethernet1
 ...
 router olsr4 1 route-map-out p4
 router olsr6 1 enable
 router olsr6 1 route-map-out p6
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv4 route v1
 ...
 | C   | 2.2.2.22/32 | 0/0    | loopback2 | null    | 00:00:30 |
 |_____|_____________|________|___________|_________|__________|
r2#
r2#
```
...
r2#show ipv6 route v1
 ...
 | C   | 4321::22/128  | 0/0    | loopback2 | null      | 00:00:30 |
