# Example: ouni bgp egress route filtering with prefixlist with soft-reconfig

## **Topology diagram**

![topology](/img/rout-bgp450.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 other-prefix-list-out p6
 afi-other enable
...
router bgp6 1
 ...
 neighbor 1234:1::2 other-prefix-list-out p4
 afi-other enable
 no afi-other vpn-mode
 afi-other redistribute connected
 exit
