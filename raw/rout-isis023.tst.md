# Example: isis inter level ingress filtering with prefixlist
...
=== "Configuration"
    ...
    **r2:**
    ...
    router isis4 1
     ...
     traffeng-id ::
     is-type both
     level2 prefix-list-from p4
     level1 prefix-list-from p4
     redistribute connected
     exit
    !
    router isis6 1
...
=== "Verification"
    ...
    r2#show ipv4 isis 1 dat 2
     ...
     |----------------------|----------|-------|-----|----------|
     | 4444.0000.1111.00-00 | 00000008 | apo   | 57  | 00:19:48 |
     | 4444.0000.2222.00-00 | 00000009 | apo   | 79  | 00:19:48 |
    ...
    r2#show ipv6 isis 1 dat 2
     ...
     | lspid                | sequence | flags | len | time     |
     |----------------------|----------|-------|-----|----------|
     | 6666.0000.1111.00-00 | 00000007 | apo   | 84  | 00:19:38 |
     | 6666.0000.2222.00-00 | 0000000d | apo   | 120 | 00:19:48 |
     |______________________|__________|_______|_____|__________|
    r2#
    r2#
    ```
