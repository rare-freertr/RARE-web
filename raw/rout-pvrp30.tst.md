...
=== "Verification"
    ...
    r2#show ipv4 pvrp 1 sum
     ...
     |---------|---------|------|---------|---------|---------|----------|----------|
     | serial1 | 4.4.4.1 | r1   | serial1 | 9.9.9.1 | 3       | 3        | 00:00:28 |
    ...
    r2#show ipv6 pvrp 1 sum
     ...
     | iface   | router  | name | peerif  | peer    | learned | adverted | uptime   |
     |---------|---------|------|---------|---------|---------|----------|----------|
     | serial1 | 6.6.6.1 | r1   | serial1 | 9999::1 | 3       | 3        | 00:00:28 |
     |_________|_________|______|_________|_________|_________|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 pvrp 1 rou
     ...
     | C    | 2.2.2.2/32  | 2/0    | loopback0 | null    | 00:00:29 |
     | null | 2.2.2.11/32 | 80/10  | serial1   | 9.9.9.1 | 00:00:21 |
     | C    | 2.2.2.12/32 | 2/0    | loopback1 | null    | 00:00:29 |
     | C    | 9.9.8.0/24  | 2/0    | serial2   | null    | 00:00:29 |
    ...
    r2#show ipv6 pvrp 1 rou
     ...
     | typ  | prefix       | metric | iface     | hop     | time     |
     |------|--------------|--------|-----------|---------|----------|
     | null | 4321::1/128  | 80/10  | serial1   | 9999::1 | 00:00:22 |
     | C    | 4321::2/128  | 2/0    | loopback0 | null    | 00:00:29 |
     | null | 4321::11/128 | 80/10  | serial1   | 9999::1 | 00:00:22 |
     | C    | 4321::12/128 | 2/0    | loopback1 | null    | 00:00:29 |
     | C    | 9998::/16    | 2/0    | serial2   | null    | 00:00:29 |
     | C    | 9999::/16    | 1/0    | serial1   | null    | 00:00:22 |
    ...
    r2#show ipv4 route v1
     ...
     | C    | 9.9.8.0/24  | 0/0    | serial2   | null    | 00:00:29 |
     | LOC  | 9.9.8.2/32  | 0/1    | serial2   | null    | 00:00:29 |
    ...
    r2#show ipv6 route v1
     ...
     | typ  | prefix       | metric | iface     | hop     | time     |
     |------|--------------|--------|-----------|---------|----------|
     | P EX | 4321::1/128  | 80/10  | serial2   | 9998::1 | 00:00:22 |
     | C    | 4321::2/128  | 0/0    | loopback0 | null    | 00:00:34 |
     | P EX | 4321::11/128 | 80/10  | serial2   | 9998::1 | 00:00:22 |
     | C    | 4321::12/128 | 0/0    | loopback1 | null    | 00:00:34 |
     | C    | 9998::/16    | 0/0    | serial2   | null    | 00:00:29 |
     | LOC  | 9998::2/128  | 0/1    | serial2   | null    | 00:00:29 |
