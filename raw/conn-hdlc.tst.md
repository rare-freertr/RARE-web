...
![topology](/img/conn-hdlc.tst.png)
...
serial1 is up
 description:
 state changed 3 times, last at 2022-05-02 21:12:15, 00:00:00 ago
 last packet input 00:00:00 ago, output 00:00:00 ago, drop never ago
 type is serial, hwaddr=none, mtu=1498, bw=2000kbps, vrf=v1
 ipv4 address=1.1.1.1/24, mask=255.255.255.0, ifcid=20326333
 ipv6 address=1234::1/16, mask=ffff::, ifcid=449598374
 received 23 packets (1550 bytes) dropped 0 packets (0 bytes)
 transmitted 20 packets (1320 bytes) macsec=false sgt=false
 |~~~~~~~|~~~~|~~~~|~~~~~~|~~~~|~~~~|~~~~~~|
 |       | packet         | byte           |
 ...
 | ethtyp | 86dd  | ip6     | 10 | 13 | 0    | 660 | 890 | 0    |
