...
=== "Verification"
    ...
    r2#show ipv4 lsrp 1 nei
     ...
     |-------|---------|------|--------|---------|-------|----------|
     | bvi1  | 4.4.4.1 | r1   | bvi1   | 1.1.1.1 | true  | 00:00:10 |
     | bvi1  | 4.4.4.3 | r3   | bvi1   | 1.1.1.3 | true  | 00:00:10 |
     | bvi1  | 4.4.4.4 | r4   | bvi1   | 1.1.1.4 | true  | 00:00:10 |
    ...
    r2#show ipv6 lsrp 1 nei
     ...
     | iface | router  | name | peerif | peer    | ready | uptime   |
     |-------|---------|------|--------|---------|-------|----------|
     | bvi1  | 6.6.6.1 | r1   | bvi1   | 1234::1 | true  | 00:00:15 |
     | bvi1  | 6.6.6.3 | r3   | bvi1   | 1234::3 | true  | 00:00:15 |
     | bvi1  | 6.6.6.4 | r4   | bvi1   | 1234::4 | true  | 00:00:15 |
     |_______|_________|______|________|_________|_______|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 lsrp 1 dat
     ...
     |---------|------|-----|-----|-----|----------|----------|
     | 4.4.4.1 | r1   | 3   | 2   | 9   | 795dadbe | 00:59:56 |
     | 4.4.4.2 | r2   | 3   | 2   | 9   | c44aaa04 | 00:59:54 |
     | 4.4.4.3 | r3   | 3   | 2   | 9   | 795dadbe | 00:59:56 |
     | 4.4.4.4 | r4   | 3   | 2   | 9   | 24b19e67 | 00:59:53 |
    ...
    r2#show ipv6 lsrp 1 dat
     ...
     | id      | name | nei | net | seq | topo     | left     |
     |---------|------|-----|-----|-----|----------|----------|
     | 6.6.6.1 | r1   | 3   | 2   | 9   | 1c7c2ae3 | 00:59:51 |
     | 6.6.6.2 | r2   | 3   | 2   | 9   | afe80720 | 00:59:51 |
     | 6.6.6.3 | r3   | 3   | 2   | 9   | 01f03b66 | 00:59:48 |
     | 6.6.6.4 | r4   | 3   | 2   | 8   | 1c7c2ae3 | 00:59:51 |
     |_________|______|_____|_____|_____|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 route v1
     ...
     | L EX | 2.2.2.1/32 | 70/10  | bvi1      | 1.1.1.1 | 00:00:06 |
     | C    | 2.2.2.2/32 | 0/0    | loopback1 | null    | 00:00:16 |
     | L EX | 2.2.2.3/32 | 70/10  | bvi1      | 1.1.1.3 | 00:00:06 |
     | L EX | 2.2.2.4/32 | 70/10  | bvi1      | 1.1.1.4 | 00:00:07 |
    ...
    r2#show ipv6 route v1
     ...
     | L EX | 4321::3/128 | 70/10  | bvi1      | 1234::3 | 00:00:11 |
