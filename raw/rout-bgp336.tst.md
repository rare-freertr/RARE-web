# Example: bgp interas csc vpn with rr peering
...
=== "Configuration"
    ...
    **r4:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz93r4-log.run
    !
    vrf definition tester
     exit
    !
    ...
    **r5:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz93r5-log.run
    !
    vrf definition tester
     exit
    !
    ...
    **r6:**
    ...
    buggy
    !
    logging file debug ../binTmp/zzz93r6-log.run
    !
    vrf definition tester
     exit
    !
