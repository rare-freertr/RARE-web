...
![topology](/img/rout-eigrp13.tst.png)
...
interface ethernet1
 ...
 router eigrp4 1 default-originate
 router eigrp6 1 enable
 router eigrp6 1 default-originate
 no shutdown
 no log-link-change
 exit
!
...
r2#show ipv6 eigrp 1 sum
 ...
 | iface     | peer      | learned | adverted | uptime   |
 |-----------|-----------|---------|----------|----------|
 | ethernet1 | 1234:1::1 | 1       | 1        | 00:00:15 |
...
r2#show ipv4 eigrp 1 rou
 ...
 |------|------------|--------|-----------|---------|----------|
 | null | 0.0.0.0/0  | 90/10  | ethernet1 | 1.1.1.1 | 00:00:15 |
...
r2#show ipv6 eigrp 1 rou
 ...
 | typ  | prefix      | metric | iface     | hop       | time     |
 |------|-------------|--------|-----------|-----------|----------|
 | null | ::/0        | 90/10  | ethernet1 | 1234:1::1 | 00:00:00 |
...
r2#show ipv4 route v1
 ...
 | typ | prefix     | metric | iface     | hop     | time     |
 |-----|------------|--------|-----------|---------|----------|
 | D   | 0.0.0.0/0  | 90/10  | ethernet1 | 1.1.1.1 | 00:00:16 |
 | C   | 1.1.1.0/30 | 0/0    | ethernet1 | null    | 00:00:16 |
...
r2#show ipv6 route v1
 ...
 | typ | prefix        | metric | iface     | hop       | time     |
 |-----|---------------|--------|-----------|-----------|----------|
 | D   | ::/0          | 90/10  | ethernet1 | 1234:1::1 | 00:00:01 |
 | C   | 1234:1::/32   | 0/0    | ethernet1 | null      | 00:00:16 |
