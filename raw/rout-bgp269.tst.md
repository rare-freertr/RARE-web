# Example: unicast+othermvpn over bgp with additional path

## **Topology diagram**

![topology](/img/rout-bgp269.tst.png)
...
router bgp4 1
 ...
 neighbor 1.1.1.2 additional-path-rx unicast omvpn
 neighbor 1.1.1.2 additional-path-tx unicast omvpn
...
router bgp6 1
 ...
 neighbor 1234:1::2 additional-path-rx unicast omvpn
 neighbor 1234:1::2 additional-path-tx unicast omvpn
...
router bgp4 1
 ...
 neighbor 1.1.1.1 additional-path-rx unicast omvpn
 neighbor 1.1.1.1 additional-path-tx unicast omvpn
...
router bgp6 1
 ...
 neighbor 1234:1::1 additional-path-rx unicast omvpn
 neighbor 1234:1::1 additional-path-tx unicast omvpn
