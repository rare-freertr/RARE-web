# Example: bgp routemap clearing with extended community

## **Topology diagram**

![topology](/img/rout-bgp508.tst.png)
...
route-map rm1
 ...
 sequence 10 clear extcomm 1:1234:4321
 !
 exit
!
bridge 1
...
router bgp4 1
 ...
 neighbor 1.1.1.3 route-map-in rm1
...
router bgp6 1
 ...
 neighbor 1234:1::3 route-map-in rm1
 redistribute connected
 exit
!
!
...
route-map rm1
 sequence 10 action permit
 sequence 10 set extcomm 1:1234:4321
 !
 exit
!
vrf definition tester
...
route-map rm1
 ...
 sequence 10 match extcomm 1:1234:4321
 !
