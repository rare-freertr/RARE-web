...
r2#show bridge 1
 ...
 |-----------|---------|----------|------|------|------|
 | bvi       | true    | true     | 0    | 0    | 0    |
 | ethernet1 | false   | true     | 160  | 344  | 0    |
 | ethernet2 | true    | true     | 2948 | 3068 | 0    |
 |___________|_________|__________|______|______|______|
 |~~~~~~~~~~~~~~~~|~~~~~~~~~~~|~~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~|
 | address        | interface | time     | tx   | rx   | drop |
 |----------------|-----------|----------|------|------|------|
 | 0038.057e.2e28 | ethernet2 | 00:00:00 | 2714 | 2908 | 0    |
 | 0042.5910.3d73 | bvi       | 00:00:00 | 2798 | 2788 | 0    |
...
r2#show inter bvi1 full
bvi1 is up (since 00:00:08, 1 changes)
 description:
 type is bridged, hwaddr=0042.5910.3d73, mtu=1500, bw=100mbps, vrf=v1
 ip4 address=1.1.1.2/24, netmask=255.255.255.0, ifcid=10011
 ip6 address=1234::2/16, netmask=ffff::, ifcid=10011
 received 29 packets (2908 bytes) dropped 0 packets (0 bytes)
 transmitted 31 packets (3042 bytes) promisc=false macsec=false
 |~~~~~~~|~~~~~~|~~~~~~~~~|~~~~~~|~~~~~~|~~~~~~~~~|~~~~~~|
 ...
 |--------|-------|---------|----|----|------|------|------|------|
 | ethtyp | 0800  | ip4     | 12 | 12 | 0    | 1128 | 1128 | 0    |
...
r2#show ipv4 arp bvi1
 ...
 |----------------|---------|----------|--------|
 | 0038.057e.2e28 | 1.1.1.1 | 00:00:08 | false  |
...
r2#show ipv6 neigh bvi1
 ...
 |----------------|-------------------------|----------|--------|--------|
 | 0038.057e.2e28 | 1234::1                 | 00:00:08 | false  | false  |
 | 0038.057e.2e28 | fe80::238:5ff:fe7e:2e28 | 00:00:08 | false  | false  |
