# Example: olsr default address suppression
...
=== "Verification"
    ...
    r2#show ipv4 olsr 1 dat
     ...
     |-----|------------|--------|-----------|------|----------|
     | N   | 1.1.1.0/30 | 1/0    | ethernet1 | null | 00:00:06 |
    ...
    r2#show ipv6 olsr 1 dat
     ...
     | typ | prefix      | metric | iface     | hop  | time     |
     |-----|-------------|--------|-----------|------|----------|
     | N   | 1234:1::/32 | 1/0    | ethernet1 | null | 00:00:06 |
    ...
    r2#show ipv4 route v1
     ...
     | C   | 2.2.2.12/32 | 0/0    | loopback1 | null | 00:00:06 |
    ...
    r2#show ipv6 route v1
     ...
     | C   | 4321::12/128  | 0/0    | loopback1 | null | 00:00:06 |
