...
=== "Verification"
    ...
    r2#show ipv4 olsr 1 sum
     ...
     |-----------|-------|----------|----------|
     | bvi1      | 2     | 1.1.1.1  | 00:00:33 |
     | bvi1      | 2     | 1.1.1.3  | 00:00:37 |
     | bvi1      | 2     | 1.1.1.4  | 00:00:37 |
    ...
    r2#show ipv6 olsr 1 sum
     ...
     | interface | learn | neighbor | uptime   |
     |-----------|-------|----------|----------|
     | bvi1      | 2     | 1234::1  | 00:00:33 |
     | bvi1      | 2     | 1234::3  | 00:00:37 |
     | bvi1      | 2     | 1234::4  | 00:00:37 |
     |___________|_______|__________|__________|
    r2#
    r2#
    ```
    ...
    r2#show ipv4 olsr 1 dat
     ...
     |-----|------------|--------|-------|---------|----------|
     | N   | 1.1.1.0/24 | 1/0    | bvi1  | null    | 00:00:38 |
     | N   | 2.2.2.1/32 | 140/1  | bvi1  | 1.1.1.1 | 00:00:08 |
     | N   | 2.2.2.3/32 | 140/1  | bvi1  | 1.1.1.3 | 00:00:37 |
     | N   | 2.2.2.4/32 | 140/1  | bvi1  | 1.1.1.4 | 00:00:37 |
    ...
    r2#show ipv6 olsr 1 dat
     ...
     | typ | prefix      | metric | iface | hop     | time     |
     |-----|-------------|--------|-------|---------|----------|
     | N   | 1234::/16   | 1/0    | bvi1  | null    | 00:00:38 |
     | N   | 4321::1/128 | 140/1  | bvi1  | 1234::1 | 00:00:08 |
     | N   | 4321::3/128 | 140/1  | bvi1  | 1234::3 | 00:00:38 |
     | N   | 4321::4/128 | 140/1  | bvi1  | 1234::4 | 00:00:38 |
    ...
    r2#show ipv4 route v1
     ...
     | N   | 2.2.2.3/32 | 140/1  | bvi1      | 1.1.1.3 | 00:00:38 |
     | N   | 2.2.2.4/32 | 140/1  | bvi1      | 1.1.1.4 | 00:00:38 |
    ...
    r2#show ipv6 route v1
     ...
     | typ | prefix      | metric | iface     | hop     | time     |
     |-----|-------------|--------|-----------|---------|----------|
     | C   | 1234::/16   | 0/0    | bvi1      | null    | 00:00:38 |
     | LOC | 1234::2/128 | 0/1    | bvi1      | null    | 00:00:38 |
     | N   | 4321::1/128 | 140/1  | bvi1      | 1234::1 | 00:00:08 |
